...
public abstract class MaxRewardLoadApi extends MaxSwitchLoadStrategy {
    public MaxRewardLoadApi(String str) {
        super(str);
    }
    ...
    public void onRewardedVideoCompleted(String str, String str2, Bundle bundle) {
        super.onRewardedVideoCompleted(str, str2, bundle);
        IADListener iADListener = this.f103452d;
        if (iADListener != null) {
    ...
    /* renamed from: q */
    protected abstract AdUnit mo2676q(Adapter adapter, AdUnit adUnit);
    ...
    public AdUnit show() {
        ...
        try {
            return mo2676q(AdapterRepository.m24274d().m24273e(m12941i.m1996j()), m12941i);
        } catch (Throwable th) {
            th.printStackTrace();
