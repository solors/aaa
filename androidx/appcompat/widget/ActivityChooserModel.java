...
public class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            return C21114v8.C21123i.f54137d + "resolveInfo:" + this.resolveInfo.toString() + "; weight:" + new BigDecimal(this.weight) + C21114v8.C21123i.f54139e;
        }
    ...
    public static final class HistoricalRecord {
        ...
        public String toString() {
            return C21114v8.C21123i.f54137d + "; activity:" + this.activity + "; time:" + this.time + "; weight:" + new BigDecimal(this.weight) + C21114v8.C21123i.f54139e;
        }
