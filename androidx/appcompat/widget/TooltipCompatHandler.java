...
public class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.u
        @Override // java.lang.Runnable
        public final void run() {
            TooltipCompatHandler.m105506a(TooltipCompatHandler.this);
        }
    };
    private final Runnable mHideRunnable = new Runnable() { // from class: androidx.appcompat.widget.v
        @Override // java.lang.Runnable
        public final void run() {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m105506a(TooltipCompatHandler tooltipCompatHandler) {
