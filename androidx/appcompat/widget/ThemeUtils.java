...
public class ThemeUtils {
    ...
    public static void checkAppCompatTheme(@NonNull View view, @NonNull Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(C0154R.styleable.AppCompatTheme);
        try {
            if (!obtainStyledAttributes.hasValue(C0154R.styleable.AppCompatTheme_windowActionBar)) {
