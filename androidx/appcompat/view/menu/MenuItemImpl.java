...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    private static void appendModifier(StringBuilder sb2, int i, int i2, String str) {
        if ((i & i2) == i2) {
            sb2.append(str);
        }
    }
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb2.append(resources.getString(C0154R.C0160string.abc_prepend_shortcut_label));
        }
        if (this.mMenu.isQwertyMode()) {
        ...
        appendModifier(sb2, i, 65536, resources.getString(C0154R.C0160string.abc_menu_meta_shortcut_label));
        appendModifier(sb2, i, 4096, resources.getString(C0154R.C0160string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb2, i, 2, resources.getString(C0154R.C0160string.abc_menu_alt_shortcut_label));
        appendModifier(sb2, i, 1, resources.getString(C0154R.C0160string.abc_menu_shift_shortcut_label));
        appendModifier(sb2, i, 4, resources.getString(C0154R.C0160string.abc_menu_sym_shortcut_label));
        appendModifier(sb2, i, 8, resources.getString(C0154R.C0160string.abc_menu_function_shortcut_label));
        if (shortcut != '\b') {
            if (shortcut != '\n') {
                if (shortcut != ' ') {
                    sb2.append(shortcut);
                } else {
                    sb2.append(resources.getString(C0154R.C0160string.abc_menu_space_shortcut_label));
                }
            } else {
                sb2.append(resources.getString(C0154R.C0160string.abc_menu_enter_shortcut_label));
            }
        } else {
            sb2.append(resources.getString(C0154R.C0160string.abc_menu_delete_shortcut_label));
        }
        return sb2.toString();
    }
