...
public interface Player {
    ...
    public static final class Commands implements Bundleable {
        ...
        @UnstableApi
        public static final Bundleable.Creator<Commands> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.z
    ...
    public static final class PositionInfo implements Bundleable {
        ...
        @UnstableApi
        public static final Bundleable.Creator<PositionInfo> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.a0
            @Override // androidx.media3.common.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public PositionInfo filterByAvailableCommands(boolean z, boolean z2) {
            ...
            if (z) {
                i5 = this.adIndexInAdGroup;
            }
            return new PositionInfo(obj, i, mediaItem, obj2, i4, j, j3, i2, i5);
        }
