...
public abstract class Timeline implements Bundleable {
    ...
    @UnstableApi
    public static final Bundleable.Creator<Timeline> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.t2
        @Override // androidx.media3.common.Bundleable.Creator
        public final Bundleable fromBundle(Bundle bundle) {
            return Timeline.m104585a(bundle);
        }
    };
    ...
    public static final class Period implements Bundleable {
        ...
        @UnstableApi
        public static final Bundleable.Creator<Period> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.u2
            @Override // androidx.media3.common.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
                return Timeline.Period.m104584a(bundle);
            }
        };

        /* renamed from: a */
        public static /* synthetic */ Period m104584a(Bundle bundle) {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (Util.areEqual(this.f730id, period.f730id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState)) {
                return true;
            }
            return false;
        }
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f730id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
    ...
    public static final class Window implements Bundleable {
        ...
        @UnstableApi
        public static final Bundleable.Creator<Window> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.v2
            @Override // androidx.media3.common.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
                return Timeline.Window.m104583a(bundle);
            }
        };
        ...
        /* renamed from: a */
        public static /* synthetic */ Window m104583a(Bundle bundle) {
            return fromBundle(bundle);
        }
    ...
    /* renamed from: a */
    public static /* synthetic */ Timeline m104585a(Bundle bundle) {
        return fromBundle(bundle);
    }
    ...
    public final Timeline copyWithSingleWindow(int i) {
        ...
        while (true) {
            ...
            if (i2 <= i3) {
                ...
                return new RemotableTimeline(ImmutableList.m69423of(window), builder.build(), new int[]{0});
            }
        }
    }
