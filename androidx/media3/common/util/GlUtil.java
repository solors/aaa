...
public final class GlUtil {
    ...
    public static boolean isBt2020PqExtensionSupported() {
        if (Util.SDK_INT >= 17 && Api17.isExtensionSupported(EXTENSION_COLORSPACE_BT2020_PQ)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isSurfacelessContextExtensionSupported() {
        if (Util.SDK_INT >= 17 && Api17.isExtensionSupported(EXTENSION_SURFACELESS_CONTEXT)) {
            return true;
        }
        return false;
    }
