...
public final class NetworkTypeObserver {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m104558a(NetworkTypeObserver networkTypeObserver, Listener listener) {
    ...
    public void register(final Listener listener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.common.util.d
            ...
            public final void run() {
                NetworkTypeObserver.m104558a(NetworkTypeObserver.this, listener);
            }
        });
    }
}
