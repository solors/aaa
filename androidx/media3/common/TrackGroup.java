...
public final class TrackGroup implements Bundleable {
    ...
    @UnstableApi
    public static final Bundleable.Creator<TrackGroup> CREATOR = new Bundleable.Creator() { // from class: androidx.media3.common.w2
        @Override // androidx.media3.common.Bundleable.Creator
        public final Bundleable fromBundle(Bundle bundle) {
            return TrackGroup.m104582a(bundle);
        }
    };
    ...
    /* renamed from: a */
    public static /* synthetic */ TrackGroup m104582a(Bundle bundle) {
    ...
    private static void logErrorMessage(String str, @Nullable String str2, @Nullable String str3, int i) {
        Log.m104567e(TAG, "", new IllegalStateException("Different " + str + " combined in one TrackGroup: '" + str2 + "' (track 0) and '" + str3 + "' (track " + i + ")"));
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.f731id.equals(trackGroup.f731id) && Arrays.equals(this.formats, trackGroup.formats)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f731id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(FIELD_ID, this.f731id);
        return bundle;
    }
