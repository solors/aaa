...
public interface HttpDataSource extends DataSource {
    @UnstableApi
    public static final Predicate<String> REJECT_PAYWALL_TYPES = new Predicate() { // from class: androidx.media3.datasource.f
        @Override // com.google.common.base.Predicate
        public final boolean apply(Object obj) {
            return HttpDataSource.m104542a((String) obj);
        }
    };
    ...
    /* renamed from: a */
    static /* synthetic */ boolean m104542a(String str) {
