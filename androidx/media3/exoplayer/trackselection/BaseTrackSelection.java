...
public abstract class BaseTrackSelection implements ExoTrackSelection {
    ...
    /* renamed from: a */
    public static /* synthetic */ int m104192a(Format format, Format format2) {
        return lambda$new$0(format, format2);
    }
    ...
    public BaseTrackSelection(TrackGroup trackGroup, int[] iArr, int i) {
        ...
        Arrays.sort(this.formats, new Comparator() { // from class: androidx.media3.exoplayer.trackselection.a
            ...
            public final int compare(Object obj, Object obj2) {
                return BaseTrackSelection.m104192a((Format) obj, (Format) obj2);
            }
        });
