...
public final class MediaCodecInfo {
    ...
    public static final class Api29 {
        ...
        private static int evaluatePerformancePointCoverage(List<MediaCodecInfo.VideoCapabilities.PerformancePoint> list, MediaCodecInfo.VideoCapabilities.PerformancePoint performancePoint) {
            ...
            for (int i = 0; i < list.size(); i++) {
                covers = list.get(i).covers(performancePoint);
                if (covers) {
                    return 2;
                }
            }
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i) {
        ...
        if (i <= 1 && ((Util.SDK_INT < 26 || i <= 0) && !"audio/mpeg".equals(str2) && !"audio/3gpp".equals(str2) && !"audio/amr-wb".equals(str2) && !"audio/mp4a-latm".equals(str2) && !"audio/vorbis".equals(str2) && !"audio/opus".equals(str2) && !"audio/raw".equals(str2) && !"audio/flac".equals(str2) && !"audio/g711-alaw".equals(str2) && !"audio/g711-mlaw".equals(str2) && !"audio/gsm".equals(str2))) {
            ...
            Log.m104564w("MediaCodecInfo", "AssumedMaxChannelAdjustment: " + str + ", [" + i + " to " + i2 + C21114v8.C21123i.f54139e);
            return i2;
        }
        return i;
    }
    ...
    private void logAssumedSupport(String str) {
        Log.m104570d("MediaCodecInfo", "AssumedSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + C21114v8.C21123i.f54139e);
    }

    private void logNoSupport(String str) {
        Log.m104570d("MediaCodecInfo", "NoSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + C21114v8.C21123i.f54139e);
    }
