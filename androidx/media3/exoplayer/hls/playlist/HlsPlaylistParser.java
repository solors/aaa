...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
    ...
    private static Pattern compileBooleanAttrPattern(String str) {
        return Pattern.compile(str + "=(" + BOOLEAN_FALSE + SignedToken.f2767c + BOOLEAN_TRUE + ")");
    }
    ...
    private static DrmInitData.SchemeData parseDrmSchemeData(String str, String str2, Map<String, String> map) throws ParserException {
        ...
        if (KEYFORMAT_WIDEVINE_PSSH_BINARY.equals(str2)) {
            ...
            return new DrmInitData.SchemeData(C2100C.WIDEVINE_UUID, "video/mp4", Base64.decode(parseStringAttr.substring(parseStringAttr.indexOf(44)), 0));
        } else if (KEYFORMAT_WIDEVINE_PSSH_JSON.equals(str2)) {
            return new DrmInitData.SchemeData(C2100C.WIDEVINE_UUID, "hls", Util.getUtf8Bytes(str));
        } else {
            if (KEYFORMAT_PLAYREADY.equals(str2) && "1".equals(parseOptionalStringAttr)) {
                ...
                UUID uuid = C2100C.PLAYREADY_UUID;
    ...
    private static HlsMediaPlaylist parseMediaPlaylist(HlsMultivariantPlaylist hlsMultivariantPlaylist, @Nullable HlsMediaPlaylist hlsMediaPlaylist, LineIterator lineIterator, String str) throws IOException {
        ...
        while (lineIterator.hasNext()) {
            ...
            if (next.startsWith(TAG_PLAYLIST_TYPE)) {
                ...
                segment = new HlsMediaPlaylist.Segment(parseStringAttr2, j11, j13, str5, str8);
                if (i7 != 0) {
                    j11 += j13;
                }
                str6 = str8;
                        ...
                        if (next.startsWith(TAG_DEFINE)) {
                            ...
                            if (next.startsWith(TAG_SKIP)) {
                                ...
                                while (i8 < i9) {
                                    ...
                                    Object obj3 = segment2.drmInitData;
                                        ...
                                        if (next.startsWith(TAG_PROGRAM_DATE_TIME)) {
                                            ...
                                            if (next.startsWith(TAG_PRELOAD_HINT)) {
                                                if (part2 == null && TYPE_PART.equals(parseStringAttr(next, REGEX_PRELOAD_HINT_TYPE, hashMap))) {
                                                    ...
                                                    long j20 = j15;
                                                    String segmentEncryptionIV = getSegmentEncryptionIV(j20, str5, str9);
                                                    ...
                                                    if (i11 == 0 || parseOptionalLongAttr2 != -1) {
                                                        part2 = new HlsMediaPlaylist.Part(parseStringAttr4, segment, 0L, i5, j12, obj2, str5, segmentEncryptionIV, i11 != 0 ? parseOptionalLongAttr : 0L, parseOptionalLongAttr2, false, false, true);
                                                    }
                                                    hlsMultivariantPlaylist2 = hlsMultivariantPlaylist;
                                                    hlsMediaPlaylist2 = hlsMediaPlaylist;
                                                    j15 = j20;
                                                ...
                                                if (next.startsWith(TAG_PART)) {
                                                    ...
                                                    arrayList10.add(new HlsMediaPlaylist.Part(parseStringAttr5, segment, parseDoubleAttr, i5, j12, obj2, str5, segmentEncryptionIV2, j17, j3, parseOptionalBooleanAttribute2, parseOptionalBooleanAttribute, false));
                                                    j12 += parseDoubleAttr;
                                                    if (i12 != 0) {
                                                        j17 += j3;
                                                    }
                                                    ...
                                                    if (next.startsWith("#")) {
                                                        ...
                                                        arrayList3.add(new HlsMediaPlaylist.Segment(replaceVariableReferences, segment != null ? segment : segment4, str4, j16, i5, j14, obj, str5, segmentEncryptionIV3, j4, j13, z9, arrayList));
                                                        j12 = j14 + j16;
        ...
        for (int i15 = z4 ? 1 : 0; i15 < arrayList5.size(); i15++) {
            ...
            if (i16 == -1 && j10 != -9223372036854775807L) {
            ...
            hashMap3.put(uri, new HlsMediaPlaylist.RenditionReport(uri, j22, i16));
        }
        if (part4 != null) {
            ...
            if (lineIterator.hasNext()) {
                ...
                if (next.startsWith(TAG_DEFINE)) {
                    ...
                    if (next.equals(TAG_INDEPENDENT_SEGMENTS)) {
                        ...
                        boolean contains = z4 | next.contains(ATTR_CLOSED_CAPTIONS_NONE);
                        if (startsWith) {
                            i = 16384;
                            z2 = contains;
                        } else {
                        ...
                        if (startsWith) {
                            resolveToUri2 = UriUtil.resolveToUri(str5, parseStringAttr(next, REGEX_URI, hashMap3));
                        } else if (lineIterator.hasNext()) {
                            resolveToUri2 = UriUtil.resolveToUri(str5, replaceVariableReferences(lineIterator.next(), hashMap3));
                        } else {
                            throw ParserException.createForMalformedManifest("#EXT-X-STREAM-INF must be followed by another line", null);
                        }
                        arrayList12.add(new HlsMultivariantPlaylist.Variant(resolveToUri2, new Format.Builder().setId(arrayList12.size()).setContainerMimeType("application/x-mpegURL").setCodecs(parseOptionalStringAttr).setAverageBitrate(parseOptionalIntAttr).setPeakBitrate(parseIntAttr).setWidth(i2).setHeight(i3).setFrameRate(f).setRoleFlags(i).build(), parseOptionalStringAttr4, parseOptionalStringAttr5, parseOptionalStringAttr6, parseOptionalStringAttr7));
                        hashMap = hashMap4;
                        ArrayList arrayList20 = (ArrayList) hashMap.get(resolveToUri2);
                        if (arrayList20 == null) {
                            arrayList20 = new ArrayList();
                            hashMap.put(resolveToUri2, arrayList20);
                        }
                ...
                for (int i5 = 0; i5 < arrayList12.size(); i5++) {
                    HlsMultivariantPlaylist.Variant variant = (HlsMultivariantPlaylist.Variant) arrayList12.get(i5);
                    if (hashSet.add(variant.url)) {
                        ...
                        arrayList28.add(variant.copyWithFormat(variant.format.buildUpon().setMetadata(new Metadata(new HlsTrackMetadataEntry(null, null, (List) Assertions.checkNotNull((ArrayList) hashMap5.get(variant.url))))).build()));
                    }
                }
                Uri uri = null;
                ...
                while (i6 < arrayList21.size()) {
                    ...
                    if (parseOptionalStringAttr8 == null) {
                        ...
                        resolveToUri = UriUtil.resolveToUri(str, parseOptionalStringAttr8);
                    }
                    ...
                    switch (c) {
                        case 0:
                            ...
                            if (resolveToUri != null) {
                                ...
                                arrayList4 = arrayList24;
                                Log.m104564w(LOG_TAG, "EXT-X-MEDIA tag with missing mandatory URI attribute: skipping");
                                break;
                            }
                        case 1:
                            format = format2;
                        ...
                        case 3:
                            ...
                            if (resolveToUri != null) {
                                language.setMetadata(metadata);
                                arrayList3 = arrayList22;
                                arrayList3.add(new HlsMultivariantPlaylist.Rendition(resolveToUri, language.build(), parseStringAttr, parseStringAttr2));
                                format = format2;
                                arrayList4 = arrayList24;
                                arrayList2 = arrayList23;
                                break;
                ...
                return new HlsMultivariantPlaylist(str, arrayList26, arrayList28, arrayList33, arrayList32, arrayList31, arrayList25, format4, arrayList, z6, hashMap3, arrayList27);
            }
        }
    }
