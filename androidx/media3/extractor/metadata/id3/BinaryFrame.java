...
public final class BinaryFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.f1377id.equals(binaryFrame.f1377id) && Arrays.equals(this.data, binaryFrame.data)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return ((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f1377id.hashCode()) * 31) + Arrays.hashCode(this.data);
    }
