...
public final class Ac3Util {
    ...
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, 121, 139, 174, 208, 243, 278, 348, TTAdConstant.DOWNLOAD_URL_AND_PACKAGE_NAME, 487, 557, 696, 835, 975, 1114, 1253, 1393};
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            if (readBits3 == 3) {
                ...
                int i15 = BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD[readBits4];
                i8 = readBits4;
                i9 = SAMPLE_RATE_BY_FSCOD[readBits3];
                i10 = i15;
            }
            int i16 = i10 * 256;
            int calculateEac3Bitrate = calculateEac3Bitrate(readBits2, i9, i10);
            int readBits5 = parsableBitArray.readBits(3);
            boolean readBit = parsableBitArray.readBit();
            i2 = CHANNEL_COUNT_BY_ACMOD[readBits5] + (readBit ? 1 : 0);
            ...
            i2 = CHANNEL_COUNT_BY_ACMOD[readBits10] + (parsableBitArray.readBit() ? 1 : 0);
            i3 = -1;
            str2 = str;
