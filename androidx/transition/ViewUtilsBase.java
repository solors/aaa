...
class ViewUtilsBase {
    ...
    public void clearNonTransitionAlpha(@NonNull View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C3084R.C3087id.save_non_transition_alpha, null);
        }
    }

    public float getTransitionAlpha(@NonNull View view) {
        Float f = (Float) view.getTag(C3084R.C3087id.save_non_transition_alpha);
        if (f != null) {
    ...
    public void saveNonTransitionAlpha(@NonNull View view) {
        int i = C3084R.C3087id.save_non_transition_alpha;
    ...
    public void setTransitionAlpha(@NonNull View view, float f) {
        Float f2 = (Float) view.getTag(C3084R.C3087id.save_non_transition_alpha);
        if (f2 != null) {
