...
public class TransitionSet extends Transition {
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            ...
            sb2.append("\n");
            sb2.append(this.mTransitions.get(i).toString(str + "  "));
    ...
    @Override // androidx.transition.Transition
    /* renamed from: clone */
    public Transition mo109994clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo109994clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo109994clone());
        }
