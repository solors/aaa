...
import androidx.recyclerview.C2891R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static /* synthetic */ class C29347 {
        ...
        static {
            ...
            try {
                f1422x3d106619[Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY.ordinal()] = 2;
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public boolean canRestoreState() {
            int i = C29347.f1422x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i == 1) {
                return false;
            }
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2891R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C2891R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C2891R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C2891R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C2891R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void offsetChildrenHorizontal(@InterfaceC0152Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@InterfaceC0152Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
    ...
    public static class RecycledViewPool {
        ...
        void detachForPoolingContainer(@NonNull Adapter<?> adapter, boolean z) {
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:241:0x027d A[ADDED_TO_REGION] */
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@InterfaceC0152Px int i, @InterfaceC0152Px int i2) {
            ...
            public void setDx(@InterfaceC0152Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }

            public void setDy(@InterfaceC0152Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@InterfaceC0152Px int i, @InterfaceC0152Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
            ...
            public Action(@InterfaceC0152Px int i, @InterfaceC0152Px int i2, int i3) {
                this(i, i2, i3, null);
            }

            public Action(@InterfaceC0152Px int i, @InterfaceC0152Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mJumpToPosition = -1;
                this.mChanged = false;
                this.mConsecutiveUpdates = 0;
                this.mDx = i;
        ...
        protected abstract void onSeekTargetStep(@InterfaceC0152Px int i, @InterfaceC0152Px int i2, @NonNull State state, @NonNull Action action);
    ...
    */
    ...
    private boolean shouldAbsorb(@NonNull EdgeEffect edgeEffect, int i, int i2) {
        ...
        if (getSplineFlingDistance(-i) < EdgeEffectCompat.getDistance(edgeEffect) * i2) {
            return true;
        }
        return false;
    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:146:0x00c0 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:150:0x00e0 A[ADDED_TO_REGION] */
    ...
    */
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable != null && drawable != null && stateListDrawable2 != null && drawable2 != null) {
            ...
            new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C2891R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C2891R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C2891R.dimen.fastscroll_margin));
            return;
        }
    ...
    */
    ...
    public void smoothScrollBy(@InterfaceC0152Px int i, @InterfaceC0152Px int i2) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C2891R.attr.recyclerViewStyle);
    }
    ...
    */
    ...
    public void smoothScrollBy(@InterfaceC0152Px int i, @InterfaceC0152Px int i2, @Nullable Interpolator interpolator) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C2891R.styleable.RecyclerView;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attributeSet, obtainStyledAttributes, i, 0);
        String string = obtainStyledAttributes.getString(C2891R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C2891R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C2891R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = obtainStyledAttributes.getBoolean(C2891R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C2891R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C2891R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C2891R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C2891R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        obtainStyledAttributes.recycle();
    ...
    public void smoothScrollBy(@InterfaceC0152Px int i, @InterfaceC0152Px int i2, @Nullable Interpolator interpolator, int i3) {
    ...
    void smoothScrollBy(@InterfaceC0152Px int i, @InterfaceC0152Px int i2, @Nullable Interpolator interpolator, int i3, boolean z) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (this.mLayoutSuppressed) {
    ...
    public void onScrolled(@InterfaceC0152Px int i, @InterfaceC0152Px int i2) {
    }
}
