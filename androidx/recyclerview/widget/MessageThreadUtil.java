...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    /* loaded from: classes2.dex */
    class C29201 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C29201.this.mQueue.next();
                while (next != null) {
                    int i = next.what;
                    if (i != 1) {
                        if (i != 2) {
                            if (i != 3) {
                                ...
                                C29201.this.val$callback.removeTile(next.arg1, next.arg2);
                            }
                        } else {
                            C29201.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                        }
                    } else {
                        C29201.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    }
                    next = C29201.this.mQueue.next();
                }
            }
        };

        C29201(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    /* loaded from: classes2.dex */
    class C29222 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C29222.this.mQueue.next();
                    if (next == null) {
                        C29222.this.mBackgroundRunning.set(false);
                        return;
                    }
                    int i = next.what;
                    if (i != 1) {
                        if (i != 2) {
                            if (i != 3) {
                                if (i != 4) {
                                    ...
                                    C29222.this.val$callback.recycleTile((TileList.Tile) next.data);
                                }
                            } else {
                                C29222.this.val$callback.loadTile(next.arg1, next.arg2);
                            }
                        } else {
                            C29222.this.mQueue.removeMessages(2);
                            C29222.this.mQueue.removeMessages(3);
                            C29222.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                        }
                    } else {
                        C29222.this.mQueue.removeMessages(1);
                        C29222.this.val$callback.refresh(next.arg1);
                    }
                }
            }
        };

        C29222(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C29222(backgroundCallback);
    }

    @Override // androidx.recyclerview.widget.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C29201(mainThreadCallback);
    }
