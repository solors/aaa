...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        public BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            ...
            if (bundle != null && bundle.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) != 0) {
                ...
                if (token != null) {
                    IMediaSession m105590d = token.m105590d();
                    if (m105590d == null) {
                        asBinder = null;
                    } else {
                        asBinder = m105590d.asBinder();
                    }
            ...
            if (!this.mRootExtrasList.isEmpty()) {
                ...
                if (m105590d != null) {
                    for (Bundle bundle : this.mRootExtrasList) {
                        BundleCompat.putBinder(bundle, MediaBrowserProtocol.EXTRA_SESSION_BINDER, m105590d.asBinder());
                    }
                }
                this.mRootExtrasList.clear();
            }
            this.mServiceFwk.setSessionToken((MediaSession.Token) token.m105589f());
        }
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 8:
                    ...
                    MediaSessionCompat.m105604a(bundle4);
                ...
                case 9:
                    ...
                    MediaSessionCompat.m105604a(bundle5);
    ...
    void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result<Bundle> result = new Result<Bundle>(str) { // from class: androidx.media.MediaBrowserServiceCompat.4
            @Override // androidx.media.MediaBrowserServiceCompat.Result
            void onErrorSent(@Nullable Bundle bundle2) {
                resultReceiver.m105534c(-1, bundle2);
            }

            @Override // androidx.media.MediaBrowserServiceCompat.Result
            void onProgressUpdateSent(@Nullable Bundle bundle2) {
                resultReceiver.m105534c(1, bundle2);
            }
            ...
            public void onResultSent(@Nullable Bundle bundle2) {
                resultReceiver.m105534c(0, bundle2);
            }
        };
        this.mCurConnection = connectionRecord;
    ...
    void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result<MediaBrowserCompat.MediaItem> result = new Result<MediaBrowserCompat.MediaItem>(str) { // from class: androidx.media.MediaBrowserServiceCompat.2
            ...
            public void onResultSent(@Nullable MediaBrowserCompat.MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
                    resultReceiver.m105534c(-1, null);
                    return;
                }
                Bundle bundle = new Bundle();
                bundle.putParcelable(MediaBrowserServiceCompat.KEY_MEDIA_ITEM, mediaItem);
                resultReceiver.m105534c(0, bundle);
            }
        };
        this.mCurConnection = connectionRecord;
    ...
    public static class Result<T> {
        ...
        void onResultSent(@Nullable T t) {
        }
    }
