...
public class MediaButtonReceiver extends BroadcastReceiver {
    ...
    /* loaded from: classes.dex */
    private static class MediaButtonConnectionCallback extends MediaBrowserCompat.C0068c {
        ...
        private void finish() {
            this.mMediaBrowser.m105681b();
            this.mPendingResult.finish();
        }

        @Override // android.support.p013v4.media.MediaBrowserCompat.C0068c
        public void onConnected() {
            new MediaControllerCompat(this.mContext, this.mMediaBrowser.m105680c()).m105618a((KeyEvent) this.mIntent.getParcelableExtra("android.intent.extra.KEY_EVENT"));
            finish();
        }
    ...
    public static KeyEvent handleIntent(MediaSessionCompat mediaSessionCompat, Intent intent) {
        if (mediaSessionCompat != null && intent != null && "android.intent.action.MEDIA_BUTTON".equals(intent.getAction()) && intent.hasExtra("android.intent.extra.KEY_EVENT")) {
            ...
            mediaSessionCompat.m105603b().m105618a(keyEvent);
            return keyEvent;
        }
        return null;
    }
    ...
    public static PendingIntent buildMediaButtonPendingIntent(Context context, ComponentName componentName, long j) {
        ...
        int m105581c = PlaybackStateCompat.m105581c(j);
        if (m105581c == 0) {
        ...
        intent.putExtra("android.intent.extra.KEY_EVENT", new KeyEvent(0, m105581c));
        int i = Build.VERSION.SDK_INT;
        intent.addFlags(268435456);
        return PendingIntent.getBroadcast(context, m105581c, intent, i >= 31 ? 33554432 : 0);
    }
}
