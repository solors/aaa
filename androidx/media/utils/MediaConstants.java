...
public final class MediaConstants {
    ...
    /* renamed from: BROWSER_SERVICE_EXTRAS_KEY_APPLICATION_PREFERENCES_USING_CAR_APP_LIBRARY_INTENT */
    public static final String f722x83542815 = "androidx.media.BrowserRoot.Extras.APPLICATION_PREFERENCES_USING_CAR_APP_LIBRARY_INTENT";
    @SuppressLint({"IntentName"})
    ...
    /* renamed from: PLAYBACK_STATE_EXTRAS_KEY_ERROR_RESOLUTION_USING_CAR_APP_LIBRARY_INTENT */
    public static final String f723xeb069e96 = "androidx.media.PlaybackStateCompat.Extras.ERROR_RESOLUTION_USING_CAR_APP_LIBRARY_INTENT";
    @SuppressLint({"IntentName"})
