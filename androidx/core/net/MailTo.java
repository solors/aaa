...
public final class MailTo {
    ...
    /* renamed from: CC */
    private static final String f620CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* renamed from: TO */
    private static final String f621TO = "to";
    ...
    public static MailTo parse(@NonNull String str) throws ParseException {
        ...
        if (isMailTo(str)) {
            ...
            if (substring != null) {
                for (String str2 : substring.split(C21114v8.C21123i.f54135c)) {
    ...
    @Nullable
    public String getCc() {
        return this.mHeaders.get(f620CC);
    }
