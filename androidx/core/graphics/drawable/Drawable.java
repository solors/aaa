...
public final class Drawable {
    @NotNull
    public static final Bitmap toBitmap(@NotNull android.graphics.drawable.Drawable drawable, @InterfaceC0152Px int i, @InterfaceC0152Px int i2, @Nullable Bitmap.Config config) {
    ...
    @Nullable
    public static final Bitmap toBitmapOrNull(@NotNull android.graphics.drawable.Drawable drawable, @InterfaceC0152Px int i, @InterfaceC0152Px int i2, @Nullable Bitmap.Config config) {
        Intrinsics.checkNotNullParameter(drawable, "<this>");
    ...
    public static /* synthetic */ Bitmap toBitmapOrNull$default(android.graphics.drawable.Drawable drawable, int i, int i2, Bitmap.Config config, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = drawable.getIntrinsicWidth();
        }
        if ((i3 & 2) != 0) {
    ...
    public static final void updateBounds(@NotNull android.graphics.drawable.Drawable drawable, @InterfaceC0152Px int i, @InterfaceC0152Px int i2, @InterfaceC0152Px int i3, @InterfaceC0152Px int i4) {
        Intrinsics.checkNotNullParameter(drawable, "<this>");
