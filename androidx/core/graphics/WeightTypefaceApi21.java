...
final class WeightTypefaceApi21 {
    ...
    private static long nativeCreateFromTypefaceWithExactStyle(long j, int i, boolean z) {
        ...
        try {
            return ((Long) sNativeCreateWeightAlias.invoke(null, Long.valueOf(((Long) sNativeCreateFromTypeface.invoke(null, Long.valueOf(j), Integer.valueOf(i2))).longValue()), Integer.valueOf(i))).longValue();
        } catch (IllegalAccessException e) {
            throw new RuntimeException(e);
