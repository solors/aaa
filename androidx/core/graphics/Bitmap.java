...
public final class Bitmap {
    @NotNull
    public static final android.graphics.Bitmap applyCanvas(@NotNull android.graphics.Bitmap bitmap, @NotNull Function1<? super Canvas, Unit> block) {
    ...
    public static final boolean contains(@NotNull android.graphics.Bitmap bitmap, @NotNull Point p) {
        int i;
        Intrinsics.checkNotNullParameter(bitmap, "<this>");
    ...
    public static final int get(@NotNull android.graphics.Bitmap bitmap, int i, int i2) {
        Intrinsics.checkNotNullParameter(bitmap, "<this>");
        return bitmap.getPixel(i, i2);
    }

    @NotNull
    public static final android.graphics.Bitmap scale(@NotNull android.graphics.Bitmap bitmap, int i, int i2, boolean z) {
        Intrinsics.checkNotNullParameter(bitmap, "<this>");
    ...
    public static /* synthetic */ android.graphics.Bitmap scale$default(android.graphics.Bitmap bitmap, int i, int i2, boolean z, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            z = true;
        }
        Intrinsics.checkNotNullParameter(bitmap, "<this>");
    ...
    public static final void set(@NotNull android.graphics.Bitmap bitmap, int i, int i2, @ColorInt int i3) {
        Intrinsics.checkNotNullParameter(bitmap, "<this>");
        bitmap.setPixel(i, i2, i3);
    }

    public static final boolean contains(@NotNull android.graphics.Bitmap bitmap, @NotNull PointF p) {
        Intrinsics.checkNotNullParameter(bitmap, "<this>");
        Intrinsics.checkNotNullParameter(p, "p");
        float f = p.x;
