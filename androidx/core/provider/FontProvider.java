...
public class FontProvider {
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator() { // from class: androidx.core.provider.a
        ...
        public final int compare(Object obj, Object obj2) {
            return FontProvider.m104945a((byte[]) obj, (byte[]) obj2);
        }
    };
    ...
    /* renamed from: a */
    public static /* synthetic */ int m104945a(byte[] bArr, byte[] bArr2) {
        return lambda$static$0(bArr, bArr2);
    }
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    arrayList2.add(FontsContractCompat.FontInfo.create(withAppendedId, i2, i4, z, i5));
                    i6 = 0;
                }
