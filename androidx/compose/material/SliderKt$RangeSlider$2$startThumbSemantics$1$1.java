...
final class SliderKt$RangeSlider$2$startThumbSemantics$1$1 extends Lambda implements Function1<Float, Unit> {
    ...
    public SliderKt$RangeSlider$2$startThumbSemantics$1$1(State<? extends Function1<? super Ranges<Float>, Unit>> state, float f) {
        super(1);
    ...
    public final void invoke(float f) {
        ...
        m16920b = C37636h.m16920b(f, this.$coercedEnd);
