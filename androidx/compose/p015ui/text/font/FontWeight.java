...
public final class FontWeight implements Comparable<FontWeight> {
    ...
    static {
        ...
        Black = fontWeight9;
        values = C37561t.m17197p(fontWeight, fontWeight2, fontWeight3, fontWeight4, fontWeight5, fontWeight6, fontWeight7, fontWeight8, fontWeight9);
    }
    ...
    public int compareTo(@NotNull FontWeight other) {
        ...
        return Intrinsics.m17071j(this.weight, other.weight);
    }
