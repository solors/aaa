...
final class MovableContentKt$movableContentWithReceiverOf$4<P1, P2, P3, R> extends Lambda implements InterfaceC45271q<R, P1, P2, P3, Composer, Integer, Unit> {
    final /* synthetic */ MovableContent<Tuples<Tuples<R, P1>, Tuples<P2, P3>>> $movableContent;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MovableContentKt$movableContentWithReceiverOf$4(MovableContent<Tuples<Tuples<R, P1>, Tuples<P2, P3>>> movableContent) {
        super(6);
    ...
    public final void invoke(R r, P1 p1, P2 p2, P3 p3, @Nullable Composer composer, int i) {
        ...
        if ((46811 & i2) == 9362 && composer.getSkipping()) {
            ...
            composer.insertMovableContent(this.$movableContent, C38513v.m14532a(C38513v.m14532a(r, p1), C38513v.m14532a(p2, p3)));
        }
    }
}
