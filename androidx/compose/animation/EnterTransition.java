...
public abstract class EnterTransition {
    ...
    public boolean equals(@Nullable Object obj) {
        if ((obj instanceof EnterTransition) && Intrinsics.m17075f(((EnterTransition) obj).getData$animation_release(), getData$animation_release())) {
            return true;
        }
        return false;
    }
    ...
    public final EnterTransition plus(@NotNull EnterTransition enter) {
        ...
        EnterExitTransition changeSize = getData$animation_release().getChangeSize();
        if (changeSize == null) {
