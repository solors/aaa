...
public final class ColorVectorConverter {
    @NotNull
    private static final Function1<ColorSpace, VectorConverters<Color, AnimationVector4D>> ColorToVector = ColorVectorConverterKt$ColorToVector$1.INSTANCE;
    @NotNull

    /* renamed from: M1 */
    private static final float[] f355M1 = {0.80405736f, 0.026893456f, 0.04586542f, 0.3188387f, 0.9319606f, 0.26299807f, -0.11419419f, 0.05105356f, 0.83999807f};
    @NotNull
    ...
    @NotNull
    public static final Function1<ColorSpace, VectorConverters<Color, AnimationVector4D>> getVectorConverter(@NotNull Color.Companion companion) {
