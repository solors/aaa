...
final class EnterExitTransitionKt$slideOutVertically$2 extends Lambda implements Function1<IntSize, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize) {
        return IntOffset.m109843boximpl(m105978invokemHKZG7I(intSize.m109898unboximpl()));
    }

    /* renamed from: invoke-mHKZG7I  reason: not valid java name */
    public final long m105978invokemHKZG7I(long j) {
        return IntOffsetKt.IntOffset(0, this.$targetOffsetY.invoke(Integer.valueOf(IntSize.m109893getHeightimpl(j))).intValue());
    }
}
