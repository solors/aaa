...
final class EnterExitTransitionKt$slideInHorizontally$2 extends Lambda implements Function1<IntSize, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ IntOffset invoke(IntSize intSize) {
        return IntOffset.m109843boximpl(m105973invokemHKZG7I(intSize.m109898unboximpl()));
    }

    /* renamed from: invoke-mHKZG7I  reason: not valid java name */
    public final long m105973invokemHKZG7I(long j) {
        return IntOffsetKt.IntOffset(this.$initialOffsetX.invoke(Integer.valueOf(IntSize.m109894getWidthimpl(j))).intValue(), 0);
    }
}
