...
@Metadata
/* renamed from: androidx.compose.animation.core.EasingFunctionsKt */
...
public final class EasingFunctions {
    ...
    private static final Easing EaseInBounce = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseInBounce$1
        @Override // androidx.compose.animation.core.Easing
        public final float transform(float f) {
            return 1 - EasingFunctions.getEaseOutBounce().transform(1.0f - f);
        }
    };
    @NotNull
    private static final Easing EaseInOutBounce = new Easing() { // from class: androidx.compose.animation.core.EasingFunctionsKt$EaseInOutBounce$1
        ...
        public final float transform(float f) {
            float transform;
            if (f < 0.5d) {
                transform = 1 - EasingFunctions.getEaseOutBounce().transform(1.0f - (f * 2.0f));
            } else {
                transform = 1 + EasingFunctions.getEaseOutBounce().transform((f * 2.0f) - 1.0f);
            }
