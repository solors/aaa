...
public final class ClickableKt$clickableO2vRcR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public ClickableKt$clickableO2vRcR0$$inlined$debugInspectorInfo$1(boolean z, String str, Role role, Functions functions, Indication indication, MutableInteractionSource mutableInteractionSource) {
        super(1);
