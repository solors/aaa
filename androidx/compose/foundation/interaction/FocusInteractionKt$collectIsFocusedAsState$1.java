...
@DebugMetadata(m17095c = "androidx.compose.foundation.interaction.FocusInteractionKt$collectIsFocusedAsState$1", m17094f = "FocusInteraction.kt", m17093l = {69}, m17092m = "invokeSuspend")
@Metadata
/* loaded from: classes.dex */
public final class FocusInteractionKt$collectIsFocusedAsState$1 extends AbstractC37596l implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public FocusInteractionKt$collectIsFocusedAsState$1(InteractionSource interactionSource, SnapshotState<Boolean> snapshotState, Continuation<? super FocusInteractionKt$collectIsFocusedAsState$1> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            InterfaceC33327h<Interaction> interactions = this.$this_collectIsFocusedAsState.getInteractions();
            final SnapshotState<Boolean> snapshotState = this.$isFocused;
            FlowCollector<Interaction> flowCollector = new FlowCollector<Interaction>() { // from class: androidx.compose.foundation.interaction.FocusInteractionKt$collectIsFocusedAsState$1.1
    ...
    public final Object mo105910invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((FocusInteractionKt$collectIsFocusedAsState$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f99208a);
    }
}
