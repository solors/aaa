...
public final class SizeKt$sizeVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", C1059Dp.m109732boximpl(this.$width$inlined));
        inspectorInfo.getProperties().set("height", C1059Dp.m109732boximpl(this.$height$inlined));
    }
}
