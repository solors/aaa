...
public final class SizeKt$heightInVpY3zN4$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("min", C1059Dp.m109732boximpl(this.$min$inlined));
        inspectorInfo.getProperties().set("max", C1059Dp.m109732boximpl(this.$max$inlined));
    }
}
