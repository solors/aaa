...
public final class LazyDslKt$itemsIndexed$4 extends Lambda implements InterfaceC45269o<LazyItemScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ InterfaceC45270p<LazyItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
    final /* synthetic */ List<T> $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyDslKt$itemsIndexed$4(InterfaceC45270p<? super LazyItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> interfaceC45270p, List<? extends T> list) {
        super(4);
