...
public final class LazyGridDslKt$itemsIndexed$5 extends Lambda implements InterfaceC45269o<LazyGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public LazyGridDslKt$itemsIndexed$5(InterfaceC45270p<? super LazyGridItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> interfaceC45270p, List<? extends T> list) {
        super(4);
