...
public final class LazyGridDslKt$items$10 extends Lambda implements InterfaceC45269o<LazyGridItemScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ InterfaceC45269o<LazyGridItemScope, T, Composer, Integer, Unit> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyGridDslKt$items$10(InterfaceC45269o<? super LazyGridItemScope, ? super T, ? super Composer, ? super Integer, Unit> interfaceC45269o, T[] tArr) {
        super(4);
