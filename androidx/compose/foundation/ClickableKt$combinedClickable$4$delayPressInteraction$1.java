...
final class ClickableKt$combinedClickable$4$delayPressInteraction$1 extends Lambda implements Functions<Boolean> {
    ...
    public ClickableKt$combinedClickable$4$delayPressInteraction$1(SnapshotState<Boolean> snapshotState, Functions<Boolean> functions) {
        super(0);
