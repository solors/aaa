...
import androidx.viewpager2.C3152R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        int[] iArr = C3152R.styleable.ViewPager2;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr);
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attributeSet, obtainStyledAttributes, 0, 0);
        try {
            setOrientation(obtainStyledAttributes.getInt(C3152R.styleable.ViewPager2_android_orientation, 0));
        } finally {
    ...
    public boolean fakeDragBy(@InterfaceC0152Px @SuppressLint({"SupportAnnotationUsage"}) float f) {
    ...
    public static abstract class OnPageChangeCallback {
        ...
        public void onPageScrolled(int i, float f, @InterfaceC0152Px int i2) {
        }
    }
