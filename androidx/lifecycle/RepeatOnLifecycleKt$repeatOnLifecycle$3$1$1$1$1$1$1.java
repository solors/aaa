...
@DebugMetadata(m17095c = "androidx.lifecycle.RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1", m17094f = "RepeatOnLifecycle.kt", m17093l = {111}, m17092m = "invokeSuspend")
@Metadata
/* loaded from: classes.dex */
final class RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1 extends AbstractC37596l implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            if (function2.mo105910invoke((CoroutineScope) this.L$0, this) == m6959e) {
                return m6959e;
            }
        }
        return Unit.f99208a;
    ...
    public final Object mo105910invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f99208a);
    }
}
