...
public class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
        ...
        for (String str : hashMap.keySet()) {
            ...
            switch (c) {
                ...
                case '\r':
                    ...
                    break;
                default:
                    if (str.startsWith(C20410l.f51634f)) {
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f528x, this.f529y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 18) {
                dArr[i] = fArr[i2];
    ...
    void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f528x, motionConstrainedPoint.f528x);
        zArr[2] = zArr[2] | diff(this.f529y, motionConstrainedPoint.f529y);
