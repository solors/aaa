...
public class ConstraintWidget {
    ...
    /* renamed from: mX */
    protected int f538mX;

    /* renamed from: mY */
    protected int f539mY;
    ...
    public static /* synthetic */ class C10901 {
        ...
        static {
            ...
            try {
                f541xdde91696[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f541xdde91696[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f541xdde91696[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f540x4c44d048[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f540x4c44d048[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f540x4c44d048[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f540x4c44d048[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f540x4c44d048[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f540x4c44d048[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f540x4c44d048[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f540x4c44d048[ConstraintAnchor.Type.NONE.ordinal()] = 9;
    ...
    */
    ...
    public void copy(ConstraintWidget constraintWidget, HashMap<ConstraintWidget, ConstraintWidget> hashMap) {
        ...
        this.f538mX = constraintWidget.f538mX;
        this.f539mY = constraintWidget.f539mY;
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C10901.f540x4c44d048[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    public int getRootX() {
        return this.f538mX + this.mOffsetX;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public int getRootY() {
        return this.f539mY + this.mOffsetY;
    }
    ...
    public int getX() {
        ...
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f538mX;
        }
        return this.f538mX;
    }
    ...
    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f539mY;
        }
        return this.f539mY;
    }
        ...
        if (str != null && str.length() != 0) {
            ...
            if (indexOf > 0 && indexOf < length - 1) {
                ...
                if (!substring.equalsIgnoreCase(ExifInterface.LONGITUDE_WEST)) {
                    i2 = substring.equalsIgnoreCase(C26485b.f69245b) ? 1 : -1;
                }
                i3 = i2;
                i2 = indexOf + 1;
            }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C10901.f540x4c44d048[type.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 == 4) {
    ...
    public String toString() {
        ...
        sb2.append(str2);
        sb2.append("(");
        sb2.append(this.f538mX);
        sb2.append(", ");
        sb2.append(this.f539mY);
        sb2.append(") - (");
