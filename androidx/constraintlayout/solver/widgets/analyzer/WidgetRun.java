...
public abstract class WidgetRun implements Dependency {
    ...
    public static /* synthetic */ class C10941 {
        ...
        static final /* synthetic */ int[] f547x4c44d048;
        ...
        static {
            ...
            try {
                f547x4c44d048[ConstraintAnchor.Type.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f547x4c44d048[ConstraintAnchor.Type.TOP.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f547x4c44d048[ConstraintAnchor.Type.BASELINE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f547x4c44d048[ConstraintAnchor.Type.BOTTOM.ordinal()] = 5;
            ...
            if (i4 != 1) {
                ...
                if (parent != null) {
                    ...
                    if (dimensionDependency.resolved) {
                        ...
                        this.dimension.resolve(getLimitedDimension((int) ((dimensionDependency.value * f) + 0.5f), i));
                        return;
                    }
                    return;
                }
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor) {
        ...
        int i = C10941.f547x4c44d048[constraintAnchor2.mType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor, int i) {
        ...
        int i2 = C10941.f547x4c44d048[constraintAnchor2.mType.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 != 5) {
