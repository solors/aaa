...
public class VerticalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C10931 {
        ...
        static final /* synthetic */ int[] f546xbf6f0c8e;
        ...
        static {
            ...
            try {
                f546xbf6f0c8e[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f546xbf6f0c8e[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        int i2 = C10931.f546xbf6f0c8e[this.mRunType.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 == 3) {
                    ConstraintWidget constraintWidget2 = this.widget;
