...
public class LinearSystem {
    ...
    private SolverVariable createVariable(String str, SolverVariable.Type type) {
        ...
        this.mVariablesID = i;
        this.mNumColumns++;
        acquireSolverVariable.f534id = i;
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f534id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                boolean[] zArr = this.mAlreadyTestedCandidates;
                int i3 = pivotCandidate.f534id;
                if (zArr[i3]) {
                    return i2;
                }
                zArr[i3] = true;
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        acquireSolverVariable.f534id = i2;
    ...
    void displaySystemInformations() {
        ...
        sb2.append(getDisplaySize(i5 * i5));
        sb2.append(") -- row sizes: ");
        sb2.append(getDisplaySize(i));
        sb2.append(", actual size: ");
        sb2.append(getDisplaySize(i3));
        sb2.append(" rows: ");
