...
import androidx.core.p017os.CancellationSignal;
import androidx.core.view.ViewCompat;
import androidx.fragment.C1876R;
...
public abstract class SpecialEffectsController {
    ...
    public static /* synthetic */ class C19543 {
        ...
        static {
            ...
            try {
                f701xb9e640f0[Operation.LifecycleImpact.REMOVING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f701xb9e640f0[Operation.LifecycleImpact.NONE.ordinal()] = 3;
            ...
            try {
                f702xe493b431[Operation.State.VISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f702xe493b431[Operation.State.GONE.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f702xe493b431[Operation.State.INVISIBLE.ordinal()] = 4;
    ...
    public static class Operation {
        ...
        Operation(@NonNull State state, @NonNull LifecycleImpact lifecycleImpact, @NonNull Fragment fragment, @NonNull CancellationSignal cancellationSignal) {
            ...
            cancellationSignal.setOnCancelListener(new CancellationSignal.OnCancelListener() { // from class: androidx.fragment.app.SpecialEffectsController.Operation.1
                @Override // androidx.core.p017os.CancellationSignal.OnCancelListener
        ...
        final void mergeWith(@NonNull State state, @NonNull LifecycleImpact lifecycleImpact) {
            int i = C19543.f701xb9e640f0[lifecycleImpact.ordinal()];
            if (i != 1) {
                if (i != 2) {
        ...
        public enum State {
            ...
            public void applyState(@NonNull View view) {
                int i = C19543.f702xe493b431[ordinal()];
                if (i != 1) {
                    if (i != 2) {
                        if (i != 3) {
                            if (i == 4) {
    ...
    public static SpecialEffectsController getOrCreateController(@NonNull ViewGroup viewGroup, @NonNull SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        int i = C1876R.C1879id.special_effects_controller_view_tag;
