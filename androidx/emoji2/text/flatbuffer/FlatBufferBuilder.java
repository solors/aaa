...
public class FlatBufferBuilder {
    ...
    public void clear() {
        this.space = this.f693bb.capacity();
        this.f693bb.clear();
        this.minalign = 1;
        while (true) {
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.space = i;
        byteBuffer.position(i);
        this.utf8.encodeUtf8(charSequence, this.f693bb);
        return endVector();
    }
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f693bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
        ...
        if (this.vtable != null && this.nested) {
            ...
            loop2: while (true) {
                if (i6 < this.num_vtables) {
                    int capacity = this.f693bb.capacity() - this.vtables[i6];
                    int i7 = this.space;
                    short s = this.f693bb.getShort(capacity);
                    if (s == this.f693bb.getShort(i7)) {
                        for (int i8 = 2; i8 < s; i8 += 2) {
                            if (this.f693bb.getShort(capacity + i8) != this.f693bb.getShort(i7 + i8)) {
                                break;
                            }
                        }
                        i = this.vtables[i6];
            ...
            if (i != 0) {
                int capacity2 = this.f693bb.capacity() - offset;
                this.space = capacity2;
                this.f693bb.putInt(capacity2, i - offset);
            } else {
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f693bb.capacity() - this.space);
        }
        this.f693bb.position(this.space);
        this.finished = true;
    }
    ...
    public FlatBufferBuilder init(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        ...
        this.f693bb = byteBuffer;
        byteBuffer.clear();
        this.f693bb.order(ByteOrder.LITTLE_ENDIAN);
        this.minalign = 1;
        this.space = this.f693bb.capacity();
        this.vtable_in_use = 0;
        this.nested = false;
    ...
    public int offset() {
        return this.f693bb.capacity() - this.space;
    }
    ...
    public void required(int i, int i2) {
        boolean z;
        int capacity = this.f693bb.capacity() - i;
        if (this.f693bb.getShort((capacity - this.f693bb.getInt(capacity)) + i2) != 0) {
            z = true;
        } else {
            z = false;
        }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f693bb.position(i);
        this.f693bb.get(bArr);
        return bArr;
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f693bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f693bb.capacity());
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            ...
            this.f693bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
        this.space = this.f693bb.capacity();
    }
    ...
    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f693bb.capacity() - this.space);
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f693bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f693bb.put(byteBuffer);
        return endVector();
    }
