...
public class FlexBuffers {
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer wrap = ByteBuffer.wrap(this.f694bb.data());
        ...
        public byte get(int i) {
            return this.f694bb.get(this.end + i);
        }
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                bArr[i] = this.f694bb.get(this.end + i);
            }
            return bArr;
        }
        ...
        public String toString() {
            return this.f694bb.getString(this.end, size());
        }

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public StringBuilder toString(StringBuilder sb2) {
            sb2.append('\"');
            sb2.append(this.f694bb.getString(this.end, size()));
            sb2.append('\"');
            return sb2;
        }
    }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i = this.end;
            while (this.f694bb.get(i) != 0) {
                i++;
            }
            int i2 = this.end;
            return this.f694bb.getString(i2, i - i2);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            ReadBuf readBuf = typedVector2.f694bb;
    ...
    public static class Map extends Vector {
        ...
        public Vector values() {
            return new Vector(this.f694bb, this.end, this.byteWidth);
        }
    ...
    public static class Reference {
        ...
        public double asFloat() {
            int i = this.type;
            if (i == 3) {
                return FlexBuffers.readDouble(this.f695bb, this.end, this.parentWidth);
            }
            if (i != 1) {
                if (i != 2) {
                    if (i != 5) {
                ...
                return FlexBuffers.readUInt(this.f695bb, this.end, this.parentWidth);
            }
            return FlexBuffers.readInt(this.f695bb, this.end, this.parentWidth);
        }
        ...
        public int asInt() {
            ...
            if (i != 2) {
                ...
                return (int) FlexBuffers.readDouble(this.f695bb, this.end, this.parentWidth);
            }
            return (int) FlexBuffers.readUInt(this.f695bb, this.end, this.parentWidth);
        }
        ...
        public long asLong() {
            int i = this.type;
            if (i == 1) {
                return FlexBuffers.readLong(this.f695bb, this.end, this.parentWidth);
            }
            if (i == 2) {
                return FlexBuffers.readUInt(this.f695bb, this.end, this.parentWidth);
            }
            ...
            return (long) FlexBuffers.readDouble(this.f695bb, this.end, this.parentWidth);
        }
        ...
        public String asString() {
            if (isString()) {
                int indirect = FlexBuffers.indirect(this.f695bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f695bb;
                int i = this.byteWidth;
                return this.f695bb.getString(indirect, (int) FlexBuffers.readUInt(readBuf, indirect - i, i));
            } else if (isKey()) {
                int indirect2 = FlexBuffers.indirect(this.f695bb, this.end, this.byteWidth);
                int i2 = indirect2;
                while (this.f695bb.get(i2) != 0) {
                    i2++;
                }
                return this.f695bb.getString(indirect2, i2 - indirect2);
            } else {
                return "";
            }
        }
    ...
    public static abstract class Sized extends Object {
        ...
        Sized(ReadBuf readBuf, int i, int i2) {
            super(readBuf, i, i2);
            this.size = FlexBuffers.readInt(this.f694bb, i - i2, i2);
        }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f694bb, this.end + (i * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f694bb, this.end + (i * this.byteWidth), this.byteWidth, Unsigned.byteToUnsignedInt(this.f694bb.get((int) (this.end + (size * this.byteWidth) + j))));
        }
