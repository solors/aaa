...
public class ListPreference extends DialogPreference {
    ...
    public static final class SimpleSummaryProvider implements Preference.SummaryProvider<ListPreference> {
        ...
        public CharSequence provideSummary(@NonNull ListPreference listPreference) {
            if (TextUtils.isEmpty(listPreference.getEntry())) {
                return listPreference.getContext().getString(C2850R.C2855string.not_set);
            }
    ...
    public ListPreference(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2850R.styleable.ListPreference, i, i2);
        this.mEntries = TypedArrayUtils.getTextArray(obtainStyledAttributes, C2850R.styleable.ListPreference_entries, C2850R.styleable.ListPreference_android_entries);
        this.mEntryValues = TypedArrayUtils.getTextArray(obtainStyledAttributes, C2850R.styleable.ListPreference_entryValues, C2850R.styleable.ListPreference_android_entryValues);
        int i3 = C2850R.styleable.ListPreference_useSimpleSummaryProvider;
        if (TypedArrayUtils.getBoolean(obtainStyledAttributes, i3, i3, false)) {
            setSummaryProvider(SimpleSummaryProvider.getInstance());
        }
        obtainStyledAttributes.recycle();
        TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C2850R.styleable.Preference, i, i2);
        this.mSummary = TypedArrayUtils.getString(obtainStyledAttributes2, C2850R.styleable.Preference_summary, C2850R.styleable.Preference_android_summary);
