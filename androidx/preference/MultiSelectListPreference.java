...
public class MultiSelectListPreference extends DialogPreference {
    ...
    public MultiSelectListPreference(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2850R.styleable.MultiSelectListPreference, i, i2);
        this.mEntries = TypedArrayUtils.getTextArray(obtainStyledAttributes, C2850R.styleable.MultiSelectListPreference_entries, C2850R.styleable.MultiSelectListPreference_android_entries);
        this.mEntryValues = TypedArrayUtils.getTextArray(obtainStyledAttributes, C2850R.styleable.MultiSelectListPreference_entryValues, C2850R.styleable.MultiSelectListPreference_android_entryValues);
