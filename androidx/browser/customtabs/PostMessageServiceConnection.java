...
public abstract class PostMessageServiceConnection implements PostMessageBackend, ServiceConnection {
    ...
    public PostMessageServiceConnection(@NonNull CustomTabsSessionToken customTabsSessionToken) {
        ...
        if (callbackBinder != null) {
            this.mSessionBinder = ICustomTabsCallback.AbstractBinderC0044a.asInterface(callbackBinder);
            return;
        }
    ...
    public final void onServiceConnected(@NonNull ComponentName componentName, @NonNull IBinder iBinder) {
        this.mService = IPostMessageService.AbstractBinderC0053a.asInterface(iBinder);
