...
import com.unity3d.services.ads.measurements.MeasurementErrors;
...
public class Measurements {
    ...
    public static void registerClick(String str, WebViewCallback webViewCallback) {
        if (AdUnit.getAdUnitActivity() == null) {
            webViewCallback.error(MeasurementErrors.ERROR_AD_UNIT_NULL, new Object[0]);
        } else if (AdUnit.getAdUnitActivity().getLayout() == null) {
            webViewCallback.error(MeasurementErrors.ERROR_LAYOUT_NULL, new Object[0]);
        } else {
            InputEvent lastInputEvent = AdUnit.getAdUnitActivity().getLayout().getLastInputEvent();
            if (lastInputEvent == null) {
                webViewCallback.error(MeasurementErrors.ERROR_LAST_INPUT_EVENT_NULL, new Object[0]);
                return;
            }
