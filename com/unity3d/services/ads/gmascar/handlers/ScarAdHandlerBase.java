...
public abstract class ScarAdHandlerBase implements IScarAdListenerWrapper {
    ...
    public void onAdFailedToLoad(int i, String str) {
        this._gmaEventSender.send(GMAEvent.LOAD_ERROR, this._scarAdMetadata.m23099c(), this._scarAdMetadata.m23098d(), str, Integer.valueOf(i));
    }

    @Override // com.unity3d.scar.adapter.common.IScarAdListenerWrapper
    public void onAdLoaded() {
        this._gmaEventSender.send(GMAEvent.AD_LOADED, this._scarAdMetadata.m23099c(), this._scarAdMetadata.m23098d());
    }
