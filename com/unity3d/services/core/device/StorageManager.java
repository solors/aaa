...
public class StorageManager {
    ...
    public static boolean init(Context context) {
        ...
        addStorageLocation(storageType, filesDir + RemoteSettings.FORWARD_SLASH_STRING + SdkProperties.getLocalStorageFilePrefix() + "public-data.json");
        if (!setupStorage(storageType)) {
            return false;
        }
        StorageType storageType2 = StorageType.PRIVATE;
        addStorageLocation(storageType2, filesDir + RemoteSettings.FORWARD_SLASH_STRING + SdkProperties.getLocalStorageFilePrefix() + "private-data.json");
