...
final class UnityAdsModule$universalRequestDataStore$1 extends Lambda implements Functions<File> {
    ...
    public final File invoke() {
        return ContextExtensions.unityAdsDataStoreFile(this.$context, ServiceProvider.DATA_STORE_UNIVERSAL_REQUEST);
    }
}
