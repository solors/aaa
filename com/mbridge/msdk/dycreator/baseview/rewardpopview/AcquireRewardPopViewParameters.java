...
public class AcquireRewardPopViewParameters {
    ...
    public static class Builder {
        ...
        /* renamed from: a */
        private AcquireRewardPopViewParameters f55815a;
    ...
    public static Builder builder(String str, String str2, int i, String str3) {
        if (TextUtils.isEmpty(str2)) {
            SameLogTool.m51824b("AcquireRewardPopViewParameters", "Unit id must not null.");
            return null;
        }
        if (i == 0) {
            i = 1;
