...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m49624of(messageDigest.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m49624of(mac.doFinal());
    ...
    /* JADX WARN: Removed duplicated region for block: B:45:0x00ac A[EDGE_INSN: B:45:0x00ac->B:38:0x00ac ?: BREAK  , SYNTHETIC] */
    @Override // com.mbridge.msdk.thrid.okio.BufferedSource
    /*
