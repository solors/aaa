...
final class DistinguishedNameParser {
    ...
    */
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f59650dn);
            }
            char c2 = cArr[i4];
            if (c2 >= '0' && c2 <= '9') {
                i3 = c2 - '0';
    ...
    private char getEscaped() {
        ...
        throw new IllegalStateException("Unexpected end of DN: " + this.f59650dn);
    }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f59650dn.toCharArray();
