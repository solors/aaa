...
public class JdkWithJettyBootPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        try {
            ...
            return new JdkWithJettyBootPlatform(cls.getMethod("put", SSLSocket.class, cls2), cls.getMethod(KiwiConstants.f2714as, SSLSocket.class), cls.getMethod("remove", SSLSocket.class), cls3, Class.forName("org.eclipse.jetty.alpn.ALPN$ServerProvider"));
