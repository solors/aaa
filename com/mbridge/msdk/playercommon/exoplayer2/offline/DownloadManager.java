...
public final class DownloadManager {
    ...
    public static final class Task implements Runnable {
        ...
        public final TaskState getDownloadState() {
            return new TaskState(this.f58756id, this.action, getExternalState(), getDownloadPercentage(), getDownloadedBytes(), this.error);
        }
        ...
        public final void run() {
            ...
            this.downloadManager.handler.post(new Runnable() { // from class: com.mbridge.msdk.playercommon.exoplayer2.offline.DownloadManager.Task.2
                ...
                public void run() {
                    ...
                    if (!task.changeStateAndNotify(1, i2, th2) && !Task.this.changeStateAndNotify(6, 3) && !Task.this.changeStateAndNotify(7, 0)) {
    ...
    public void maybeStartTasks() {
        ...
        if (this.initialized && !this.released) {
            ...
            for (int i = 0; i < this.tasks.size(); i++) {
                ...
                if (task.canStart() && ((z2 = (downloadAction = task.action).isRemoveAction) || !z)) {
                    int i2 = 0;
                    boolean z3 = true;
                    while (true) {
                        if (i2 >= i) {
    ...
    public final int handleAction(DownloadAction downloadAction) {
        ...
        return addTaskForAction.f58756id;
    }
}
