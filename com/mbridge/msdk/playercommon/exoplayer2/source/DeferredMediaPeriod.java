...
public final class DeferredMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    /* renamed from: id */
    public final MediaSource.MediaPeriodId f58758id;
    @Nullable
    ...
    public final void createPeriod() {
        MediaPeriod createPeriod = this.mediaSource.createPeriod(this.f58758id, this.allocator);
        ...
        try {
            ...
            if (prepareErrorListener != null) {
                if (!this.notifiedPrepareError) {
                    ...
                    prepareErrorListener.onPrepareError(this.f58758id, e);
                    return;
                }
                return;
            }
