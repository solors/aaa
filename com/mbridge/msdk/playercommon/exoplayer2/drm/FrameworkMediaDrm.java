...
public final class FrameworkMediaDrm implements ExoMediaDrm<FrameworkMediaCrypto> {
    ...
    private FrameworkMediaDrm(UUID uuid) throws UnsupportedSchemeException {
        ...
        UUID uuid2 = C22533C.COMMON_PSSH_UUID;
        Assertions.checkArgument(!uuid2.equals(uuid), "Use C.CLEARKEY_UUID instead");
        if (Util.SDK_INT < 27 && C22533C.CLEARKEY_UUID.equals(uuid)) {
            uuid = uuid2;
        }
        this.uuid = uuid;
        MediaDrm mediaDrm = new MediaDrm(uuid);
        this.mediaDrm = mediaDrm;
        if (C22533C.WIDEVINE_UUID.equals(uuid) && needsForceL3Workaround()) {
    ...
    */
    public final com.mbridge.msdk.playercommon.exoplayer2.drm.ExoMediaDrm.KeyRequest getKeyRequest(byte[] r9, byte[] r10, java.lang.String r11, int r12, java.util.HashMap<java.lang.String, java.lang.String> r13) throws android.media.NotProvisionedException {
        /*
            ...
            r1 = 21
            if (r0 >= r1) goto L10
            java.util.UUID r1 = com.mbridge.msdk.playercommon.exoplayer2.C22533C.WIDEVINE_UUID
            java.util.UUID r2 = r8.uuid
            boolean r1 = r1.equals(r2)
            if (r1 != 0) goto L3e
        L10:
            java.util.UUID r1 = com.mbridge.msdk.playercommon.exoplayer2.C22533C.PLAYREADY_UUID
            java.util.UUID r2 = r8.uuid
            boolean r1 = r1.equals(r2)
            if (r1 == 0) goto L49
        ...
        L4a:
            r10 = 26
            if (r0 >= r10) goto L6a
            java.util.UUID r10 = com.mbridge.msdk.playercommon.exoplayer2.C22533C.CLEARKEY_UUID
        ...
        L6a:
            ...
            byte[] r10 = r9.getData()
            java.util.UUID r11 = com.mbridge.msdk.playercommon.exoplayer2.C22533C.CLEARKEY_UUID
    ...
    public final byte[] provideKeyResponse(byte[] bArr, byte[] bArr2) throws NotProvisionedException, DeniedByServerException {
        if (C22533C.CLEARKEY_UUID.equals(this.uuid)) {
    ...
    public final FrameworkMediaCrypto createMediaCrypto(byte[] bArr) throws MediaCryptoException {
        return new FrameworkMediaCrypto(new MediaCrypto(this.uuid, bArr), Util.SDK_INT < 21 && C22533C.WIDEVINE_UUID.equals(this.uuid) && "L3".equals(getPropertyString("securityLevel")));
    }
}
