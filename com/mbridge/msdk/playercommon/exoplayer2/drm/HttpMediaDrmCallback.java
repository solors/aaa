...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    ...
    /* JADX WARN: Removed duplicated region for block: B:27:0x006b A[Catch: all -> 0x004f, TRY_LEAVE, TryCatch #1 {all -> 0x004f, blocks: (B:10:0x0047, B:17:0x0053, B:19:0x0059, B:27:0x006b, B:32:0x007c, B:21:0x005f), top: B:35:0x0047, inners: #0 }] */
    /* JADX WARN: Removed duplicated region for block: B:29:0x0070  */
    /* JADX WARN: Removed duplicated region for block: B:31:0x0073 A[LOOP:1: B:9:0x002e->B:31:0x0073, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:40:0x007c A[EDGE_INSN: B:40:0x007c->B:32:0x007c ?: BREAK  , SYNTHETIC] */
    /*
    ...
    */
    ...
    public final byte[] executeKeyRequest(UUID uuid, ExoMediaDrm.KeyRequest keyRequest, @Nullable String str) throws Exception {
        ...
        UUID uuid2 = C22533C.PLAYREADY_UUID;
        if (uuid2.equals(uuid)) {
            str2 = "text/xml";
        } else if (C22533C.CLEARKEY_UUID.equals(uuid)) {
            str2 = "application/json";
        } else {
            str2 = Headers.VALUE_APPLICATION_STREAM;
        }
