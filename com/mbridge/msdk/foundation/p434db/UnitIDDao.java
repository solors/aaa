...
public class UnitIDDao extends BaseDao<LoadTime> {
    ...
    /* renamed from: a */
    private static UnitIDDao f56251a;
    ...
    /* renamed from: a */
    public static UnitIDDao m52558a(CommonAbsDBHelper commonAbsDBHelper) {
        if (f56251a == null) {
            synchronized (UnitIDDao.class) {
                if (f56251a == null) {
                    f56251a = new UnitIDDao(commonAbsDBHelper);
                }
            }
        }
        return f56251a;
    ...
    /* renamed from: a */
    public final synchronized void m52557a(String str) {
    ...
    /* renamed from: a */
    public final synchronized void m52556a(String str, String str2, int i) {
        if (getWritableDatabase() == null) {
            return;
        }
    ...
    /* renamed from: a */
    public final synchronized List<LoopEntity> m52559a(int i) {
        ArrayList arrayList;
