...
public final class CommonSDKDBHelper extends CommonAbsDBHelper {

    /* renamed from: a */
    private static CommonSDKDBHelper f56243a;
    ...
    /* renamed from: c */
    private void m52587c(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            if (MBridgeConstans.DEBUG) {
                SameLogTool.m51824b("CommonSDKDBHelper", e.getLocalizedMessage());
            }
        }
    }

    @Override // com.mbridge.msdk.foundation.p434db.CommonAbsDBHelper
    /* renamed from: a */
    protected final String mo52594a() {
        return "mbridge.msdk.db";
    }

    @Override // com.mbridge.msdk.foundation.p434db.CommonAbsDBHelper
    /* renamed from: b */
    protected final int mo52590b() {
        return 86;
    }

    /* renamed from: a */
    public static synchronized CommonSDKDBHelper m52593a(Context context) {
        CommonSDKDBHelper commonSDKDBHelper;
        synchronized (CommonSDKDBHelper.class) {
            if (f56243a == null) {
                f56243a = new CommonSDKDBHelper(context.getApplicationContext());
            }
            commonSDKDBHelper = f56243a;
        }
    ...
    @Override // com.mbridge.msdk.foundation.p434db.CommonAbsDBHelper
    /* renamed from: b */
    protected final void mo52588b(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (MBridgeDatabaseUtils.m52899a(sQLiteDatabase)) {
            m52587c(sQLiteDatabase);
            m52589b(sQLiteDatabase);
        }
    }

    /* renamed from: b */
    private void m52589b(SQLiteDatabase sQLiteDatabase) {
        try {
    ...
    @Override // com.mbridge.msdk.foundation.p434db.CommonAbsDBHelper
    /* renamed from: a */
    protected final void mo52592a(SQLiteDatabase sQLiteDatabase) {
        if (MBridgeDatabaseUtils.m52899a(sQLiteDatabase)) {
            m52589b(sQLiteDatabase);
        }
    }
    ...
    @Override // com.mbridge.msdk.foundation.p434db.CommonAbsDBHelper
    /* renamed from: a */
    protected final void mo52591a(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (MBridgeDatabaseUtils.m52899a(sQLiteDatabase)) {
            m52587c(sQLiteDatabase);
            m52589b(sQLiteDatabase);
        }
