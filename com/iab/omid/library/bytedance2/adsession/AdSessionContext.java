...
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner, WebView webView, @Nullable String str, @Nullable String str2) {
        C18019g.m64308a(partner, "Partner is null");
        C18019g.m64308a(webView, "WebView is null");
        if (str2 != null) {
            C18019g.m64307a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner, String str, List<VerificationScriptResource> list, @Nullable String str2, @Nullable String str3) {
        C18019g.m64308a(partner, "Partner is null");
        C18019g.m64308a((Object) str, "OM SDK JS script content is null");
        C18019g.m64308a(list, "VerificationScriptResources is null");
        if (str3 != null) {
            C18019g.m64307a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
