...
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner, WebView webView, @Nullable String str, @Nullable String str2) {
        C18326g.m63120a(partner, "Partner is null");
        C18326g.m63120a(webView, "WebView is null");
        if (str2 != null) {
            C18326g.m63119a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner, String str, List<VerificationScriptResource> list, @Nullable String str2, @Nullable String str3) {
        C18326g.m63120a(partner, "Partner is null");
        C18326g.m63120a((Object) str, "OM SDK JS script content is null");
        C18326g.m63120a(list, "VerificationScriptResources is null");
        if (str3 != null) {
            C18326g.m63119a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
