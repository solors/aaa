...
public class MLog {
    ...
    /* renamed from: d */
    public static void m25892d(String str, String str2) {
        if (sLogLevel >= 3) {
    ...
    /* renamed from: e */
    public static void m25889e(String str, String str2) {
        if (sLogLevel >= 0) {
    ...
    /* renamed from: i */
    public static void m25887i(String str, String str2) {
        if (sLogLevel >= 2) {
    ...
    /* renamed from: v */
    public static void m25885v(String str, String str2) {
        if (sLogLevel >= 4) {
    ...
    /* renamed from: w */
    public static void m25883w(String str, String str2) {
        if (sLogLevel >= 1) {
    ...
    /* renamed from: d */
    public static void m25890d(String str, String... strArr) {
        if (sLogLevel < 3 || strArr == null) {
            return;
        }
        ...
        log(addAdPrefix(str), stringBuffer.toString(), 3);
    }

    /* renamed from: e */
    public static void m25888e(String str, String str2, Throwable th) {
        if (sLogLevel >= 0) {
    ...
    /* renamed from: i */
    public static void m25886i(String str, String str2, Throwable th) {
        if (sLogLevel >= 2) {
    ...
    /* renamed from: v */
    public static void m25884v(String str, String str2, Throwable th) {
        if (sLogLevel >= 4) {
    ...
    /* renamed from: w */
    public static void m25882w(String str, String str2, Throwable th) {
        if (sLogLevel >= 1) {
    ...
    /* renamed from: d */
    public static void m25891d(String str, String str2, Throwable th) {
        if (sLogLevel >= 3) {
