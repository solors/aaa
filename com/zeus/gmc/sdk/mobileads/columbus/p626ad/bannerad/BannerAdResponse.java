...
import com.zeus.gmc.sdk.mobileads.columbus.p626ad.enity.BannerAdInfo;
...
/* renamed from: com.zeus.gmc.sdk.mobileads.columbus.ad.bannerad.BannerAdResponse */
/* loaded from: classes8.dex */
public class BannerAdResponse implements IResponseEntity {
    private static final double GSON_CONTENT_VERSION = 1.0d;
    private static final String cco22 = "BannerAdResponse";
    ...
    public int c2oc2o;
    private List<BannerAdInfo> cioccoiococ;
        ...
        try {
            ...
            if (optInt == 0) {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    BannerAdInfo coo2iico = BannerAdInfo.coo2iico(jSONArray.getJSONObject(i));
                    if (coo2iico != null && coo2iico(coo2iico)) {
                        ...
                        if (this.c2oc2o != 0) {
                            this.c2oc2o = BannerAdError.ADINFO_IS_INVALID.getErrorCode();
                        }
                    }
                }
                return;
            ...
            MLog.m25888e(cco22, "BannerAdResponse e : ", e);
            this.c2oc2o = BannerAdError.INTERNAL_ERROR.getErrorCode();
        }
    }

    public static final BannerAdResponse coo2iico(String str) {
    ...
    public List<BannerAdInfo> cicic() {
    ...
    private boolean coo2iico(BannerAdInfo bannerAdInfo) {
        return (TextUtils.isEmpty(bannerAdInfo.c2cic2()) || TextUtils.isEmpty(bannerAdInfo.c2cciooo())) ? false : true;
    }
}
