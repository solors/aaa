...
/* renamed from: com.zeus.gmc.sdk.mobileads.columbus.ad.videoads.VideoAdResponse */
...
public class VideoAdResponse implements IResponseEntity {
            ...
            if (optInt == 0) {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    ...
                    if (coo2iico != null && coo2iico(coo2iico)) {
                        ...
                        if (this.c2oc2o != 0) {
                            this.c2oc2o = NativeAdError.ADINFO_IS_INVALID.getErrorCode();
                        }
                    }
                }
                return;
    ...
    public static final VideoAdResponse coo2iico(String str) {
    ...
    private boolean coo2iico(NativeAdInfo nativeAdInfo) {
        return !TextUtils.isEmpty(nativeAdInfo.ciio2c());
    }
}
