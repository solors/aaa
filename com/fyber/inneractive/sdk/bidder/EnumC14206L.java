...
public enum EnumC14206L implements InterfaceC15295e0 {
    ...
    private static final InterfaceC15298f0 internalValueMap = new InterfaceC15298f0() { // from class: com.fyber.inneractive.sdk.bidder.K
        @Override // com.fyber.inneractive.sdk.protobuf.InterfaceC15298f0
        /* renamed from: a */
        public final InterfaceC15295e0 mo76884a(int i) {
            return EnumC14206L.m78029a(i);
        }
    };
    ...
    /* renamed from: a */
    public static EnumC14206L m78029a(int i) {
        if (i != 0) {
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
