...
public class POBVastError {
    ...
    /* renamed from: b */
    private String f70806b;

    public POBVastError(int i, @NonNull String str) {
        String str2;
        this.f70805a = i;
        if (i != 405) {
            if (i != 407) {
        ...
        this.f70806b = "VAST error: " + str2 + ", Message: " + str;
    }
    ...
    public String toString() {
        return "POBVastError{errorCode=" + this.f70805a + ", errorMessage='" + this.f70806b + "'}";
    }
}
