...
import com.maticoo.sdk.videocache.Preconditions;
...
class DatabaseSourceInfoStorage extends SQLiteOpenHelper implements SourceInfoStorage {
    ...
    public DatabaseSourceInfoStorage(Context context) {
        super(context, "zMaticooSdk.db", (SQLiteDatabase.CursorFactory) null, 1);
    ...
    @Override // com.maticoo.sdk.videocache.sourcestorage.SourceInfoStorage
