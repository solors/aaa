...
public class C11928Ht<E> implements Iterator<E> {
    public static byte[] A02;
    public int A00;
    public final /* synthetic */ AbstractC112866x<E> A01;
    ...
    public C11928Ht(AbstractC112866x abstractC112866x) {
        this.A01 = abstractC112866x;
    }
    ...
    public final E next() {
        if (hasNext()) {
            AbstractC112866x<E> abstractC112866x = this.A01;
            int i = this.A00;
            this.A00 = i + 1;
            return abstractC112866x.get(i);
        }
