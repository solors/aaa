...
public abstract class AbstractC109481N {
    ...
    public static List<C109401F> A01(JSONArray jSONArray, JSONObject jSONObject, C13029Zs c13029Zs, InterfaceC109521R interfaceC109521R) {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ...
                C109401F A002 = C109401F.A00(jSONObject2);
                interfaceC109521R.A3j(A002, jSONObject2);
                arrayList.add(A002);
            } catch (JSONException e) {
                c13029Zs.A07().AA0(A00(8, 7, 90), AbstractC113568E.A2B, new C113578F(e));
            }
        }
        return arrayList;
    }
