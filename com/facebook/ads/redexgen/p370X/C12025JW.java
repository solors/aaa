...
public final class C12025JW implements NativeAdViewAttributesApi {
    public static final int A08 = (int) (AbstractC12137LP.A02 * 4.0f);
    public static final int A07 = (int) (AbstractC12137LP.A02 * 1.0f);
    ...
    public final int A04(float f) {
        ...
        return AbstractC110382p.A02((this.A01 & ViewCompat.MEASURED_STATE_MASK) | ((this.A01 ^ (-1)) & ViewCompat.MEASURED_SIZE_MASK), textColor, f);
    }
    ...
    public final void A05(TextView textView) {
        ...
        AbstractC12177M3.A0S(textView, stateListDrawable);
