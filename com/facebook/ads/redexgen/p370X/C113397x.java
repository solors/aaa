...
public final class C113397x {
    ...
    public C113397x(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
    ...
    public C113397x(String[] strArr, Integer num, Integer num2) {
    ...
    public static C113397x A00(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (true) {
            ...
            if (find) {
                ...
                return new C113397x(linkedHashSet, num, num2, str);
            }
        }
    }
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof C113397x) {
            C113397x c113397x = (C113397x) obj;
            if (this.A00 == c113397x.A00 || (this.A00 != null && this.A00.equals(c113397x.A00))) {
                return (this.A01 == c113397x.A01 || (this.A01 != null && this.A01.equals(c113397x.A01))) && this.A03.equals(c113397x.A03);
            }
            return false;
        }
        return false;
