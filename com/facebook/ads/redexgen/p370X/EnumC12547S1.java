...
public enum EnumC12547S1 {
    ...
    EnumC12547S1(boolean z, boolean z2) {
        this.A00 = z;
        this.A01 = z2;
    }
    ...
    public static EnumC12547S1[] valuesCustom() {
        EnumC12547S1[] valuesCustom = values();
        if (A03[7].charAt(2) != 'p') {
            throw new RuntimeException();
        }
        A03[7] = "eYpi2UA0ZlC7PiDY55aF0B4EyL2494ge";
        return (EnumC12547S1[]) valuesCustom.clone();
    }
}
