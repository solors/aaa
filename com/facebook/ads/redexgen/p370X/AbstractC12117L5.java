...
public abstract class AbstractC12117L5 {
    ...
    public static Uri A00(String str) {
        ...
        if (A002 != null && !C11979Im.A2k(A002)) {
            return parse;
        }
        if (!A0D(parse)) {
    ...
    public static void A0C(String str, URI uri, Uri uri2, boolean z) {
        ...
        if (!z && !A0E2) {
            A05 = A05 + String.format(Locale.US, A05(IronSourceConstants.USING_CACHE_FOR_INIT_EVENT, 52, 103), uri.getAuthority(), uri2.getAuthority());
        }
        if (!A0E3) {
