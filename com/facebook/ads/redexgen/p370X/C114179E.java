...
public class C114179E {
     ...
     */
    public static C114179E A04(File file) throws IOException {
        try {
            ...
            if (file.length() >= A00()) {
                ...
                if (readLong == -360011992771067903L) {
                    ...
                    if (randomAccessFile.length() >= A02((int) readLong2)) {
                        ...
                        return new C114179E(randomAccessFile, jArr, randomAccessFile.length());
                    }
    ...
    public C114179E(RandomAccessFile randomAccessFile, long[] jArr, long j) throws IOException {
    ...
    public static C114179E A03(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A05(416, 3, 33));
        try {
            randomAccessFile.writeLong(-360011992771067903L);
            randomAccessFile.writeLong(C114189F.A03);
            randomAccessFile.write(new byte[C114189F.A03 * 8]);
            randomAccessFile.getFD().sync();
            return new C114179E(randomAccessFile, new long[C114189F.A03], randomAccessFile.length());
        } catch (IOException unused) {
