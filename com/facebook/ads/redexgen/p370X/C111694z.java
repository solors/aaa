...
public class C111694z {
    ...
    public C111694z(int i, int i2) {
        this(i, i2, Integer.MIN_VALUE, null);
    }

    public C111694z(int i, int i2, int i3, Interpolator interpolator) {
        this.A04 = -1;
        this.A06 = false;
        this.A00 = 0;
        this.A02 = i;
    ...
    public final void A05(C11774FL c11774fl) {
        if (this.A04 >= 0) {
            int i = this.A04;
            this.A04 = -1;
            c11774fl.A1S(i);
            ...
            if (interpolator == null) {
                if (this.A01 == Integer.MIN_VALUE) {
                    c11774fl.A08.A0A(this.A02, this.A03);
                } else {
                    RunnableC1117555 runnableC1117555 = c11774fl.A08;
                    int i2 = this.A02;
                    int i3 = this.A03;
                    if (A08[1].length() != 25) {
                        runnableC1117555.A0B(i2, i3, this.A01);
                    } else {
                        String[] strArr2 = A08;
                ...
                c11774fl.A08.A0C(this.A02, this.A03, this.A01, this.A05);
            }
            this.A00++;
            if (this.A00 > 10) {
