...
public final class C110302h extends Drawable {
    ...
    public C110302h(ColorStateList colorStateList, float f) {
        this.A01 = f;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float A01 = C110322j.A01(this.A00, this.A01, this.A07);
            float vInset = C110322j.A00(this.A00, this.A01, this.A07);
