...
@Metadata
/* renamed from: com.mobilefuse.sdk.assetsmanager.MobileFuseAssetManagerService$getAssetManifestJson$$inlined$transform$1$1$lambda$1 */
/* loaded from: classes7.dex */
final class C23480x97f724cb extends Lambda implements Function1<Either<? extends HttpError, ? extends HttpResponse>, Unit> {
    final /* synthetic */ FlowCollector $this_transform;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C23480x97f724cb(FlowCollector flowCollector) {
        super(1);
