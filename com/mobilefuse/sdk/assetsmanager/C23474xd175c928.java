...
@Metadata
/* renamed from: com.mobilefuse.sdk.assetsmanager.MobileFuseAssetManagerService$getAssetManifestJson$$inlined$catchElse$1 */
/* loaded from: classes7.dex */
public final class C23474xd175c928 extends Lambda implements Function1<FlowCollector<? super Either<? extends BaseError, ? extends MobileFuseAssetManifestResponse>>, Unit> {
    final /* synthetic */ Flow $this_transformForConcurrency;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C23474xd175c928(Flow flow) {
        super(1);
    ...
    public final void invoke2(@NotNull final FlowCollector<? super Either<? extends BaseError, ? extends MobileFuseAssetManifestResponse>> flow) {
        ...
        this.$this_transformForConcurrency.collect(new FlowCollector() { // from class: com.mobilefuse.sdk.assetsmanager.MobileFuseAssetManagerService$getAssetManifestJson$$inlined$catchElse$1.1
