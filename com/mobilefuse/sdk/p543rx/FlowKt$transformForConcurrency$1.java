...
@Metadata
/* renamed from: com.mobilefuse.sdk.rx.FlowKt$transformForConcurrency$1 */
/* loaded from: classes7.dex */
public final class FlowKt$transformForConcurrency$1<R> extends Lambda implements Function1<FlowCollector<? super R>, Unit> {
    final /* synthetic */ Flow $this_transformForConcurrency;
    final /* synthetic */ Function2 $transform;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt$transformForConcurrency$1(Flow flow, Function2 function2) {
        super(1);
    ...
    public final void invoke(@NotNull final FlowCollector<? super R> flow) {
        ...
        this.$this_transformForConcurrency.collect(new FlowCollector() { // from class: com.mobilefuse.sdk.rx.FlowKt$transformForConcurrency$1.1
            ...
            public final void emit(@NotNull Either<? extends Throwable, ? extends T> value) {
                ...
                FlowKt$transformForConcurrency$1.this.$transform.mo105910invoke(flow, value);
            }
