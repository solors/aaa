...
@Metadata
/* renamed from: com.mobilefuse.sdk.rx.FlowKt$catch$$inlined$transformForConcurrency$1 */
/* loaded from: classes7.dex */
public final class FlowKt$catch$$inlined$transformForConcurrency$1<T> extends Lambda implements Function1<FlowCollector<? super T>, Unit> {
    final /* synthetic */ Flow $this_transformForConcurrency;
    final /* synthetic */ Function2 $transform$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt$catch$$inlined$transformForConcurrency$1(Flow flow, Function2 function2) {
        super(1);
        ...
        this.$this_transformForConcurrency.collect(new FlowCollector() { // from class: com.mobilefuse.sdk.rx.FlowKt$catch$$inlined$transformForConcurrency$1.1
            ...
            public final void emit(@NotNull Either<? extends Throwable, ? extends T> value) {
                ...
                if (value instanceof ErrorResult) {
                    FlowKt$catch$$inlined$transformForConcurrency$1.this.$transform$inlined.mo105910invoke(flowCollector, ((ErrorResult) value).getValue());
