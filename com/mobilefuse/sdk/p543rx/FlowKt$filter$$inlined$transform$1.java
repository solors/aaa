...
@Metadata
/* renamed from: com.mobilefuse.sdk.rx.FlowKt$filter$$inlined$transform$1 */
/* loaded from: classes7.dex */
public final class FlowKt$filter$$inlined$transform$1<T> extends Lambda implements Function1<FlowCollector<? super T>, Unit> {
    final /* synthetic */ Flow $this_transform;
    final /* synthetic */ Function1 $transform$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt$filter$$inlined$transform$1(Flow flow, Function1 function1) {
        super(1);
    ...
    public final void invoke(@NotNull final FlowCollector<? super T> flow) {
        ...
        this.$this_transform.collect(new FlowCollector() { // from class: com.mobilefuse.sdk.rx.FlowKt$filter$$inlined$transform$1.1
            ...
            public final void emit(@NotNull Either<? extends Throwable, ? extends T> value) {
                ...
                if (value instanceof SuccessResult) {
                    ...
                    try {
                        if (((Boolean) FlowKt$filter$$inlined$transform$1.this.$transform$inlined.invoke(value2)).booleanValue()) {
