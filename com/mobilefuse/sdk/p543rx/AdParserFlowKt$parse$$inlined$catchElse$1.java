...
@Metadata
/* renamed from: com.mobilefuse.sdk.rx.AdParserFlowKt$parse$$inlined$catchElse$1 */
/* loaded from: classes7.dex */
public final class AdParserFlowKt$parse$$inlined$catchElse$1 extends Lambda implements Function1<FlowCollector<? super Either<? extends BaseError, ? extends ParsedAdMarkupResponse>>, Unit> {
    final /* synthetic */ Flow $this_transformForConcurrency;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdParserFlowKt$parse$$inlined$catchElse$1(Flow flow) {
        super(1);
    ...
    public final void invoke2(@NotNull final FlowCollector<? super Either<? extends BaseError, ? extends ParsedAdMarkupResponse>> flow) {
        ...
        this.$this_transformForConcurrency.collect(new FlowCollector() { // from class: com.mobilefuse.sdk.rx.AdParserFlowKt$parse$$inlined$catchElse$1.1
