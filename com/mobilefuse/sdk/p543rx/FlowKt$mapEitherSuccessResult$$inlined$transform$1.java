...
@Metadata
/* renamed from: com.mobilefuse.sdk.rx.FlowKt$mapEitherSuccessResult$$inlined$transform$1 */
/* loaded from: classes7.dex */
public final class FlowKt$mapEitherSuccessResult$$inlined$transform$1<R> extends Lambda implements Function1<FlowCollector<? super Either<? extends BaseError, ? extends R>>, Unit> {
    final /* synthetic */ Flow $this_transform;
    final /* synthetic */ Function1 $transform$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt$mapEitherSuccessResult$$inlined$transform$1(Flow flow, Function1 function1) {
        super(1);
