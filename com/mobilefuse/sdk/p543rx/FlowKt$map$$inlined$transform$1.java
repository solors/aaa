...
@Metadata
/* renamed from: com.mobilefuse.sdk.rx.FlowKt$map$$inlined$transform$1 */
/* loaded from: classes7.dex */
public final class FlowKt$map$$inlined$transform$1<R> extends Lambda implements Function1<FlowCollector<? super R>, Unit> {
    final /* synthetic */ Flow $this_transform;
    final /* synthetic */ Function1 $transform$inlined;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt$map$$inlined$transform$1(Flow flow, Function1 function1) {
        super(1);
