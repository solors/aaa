...
public final class HttpFlowKt$runOn$$inlined$transformForConcurrency$1<T> extends Lambda implements Function1<FlowCollector<? super T>, Unit> {
    ...
    public final void invoke(@NotNull final FlowCollector<? super T> receiver) {
        ...
        this.$this_transformForConcurrency.collect(new FlowCollector() { // from class: com.mobilefuse.sdk.network.client.HttpFlowKt$runOn$$inlined$transformForConcurrency$1.1
            ...
            public final void emit(@NotNull Either<? extends Throwable, ? extends T> value) {
                ...
                SchedulersKt.runOnScheduler(HttpFlowKt$runOn$$inlined$transformForConcurrency$1.this.$scheduler$inlined, new HttpFlowKt$runOn$$inlined$transformForConcurrency$1$1$lambda$1(receiver, value));
            }
