...
public final class NativeAdParser$parse$$inlined$runOn$1 extends Lambda implements Function1<FlowCollector<? super String>, Unit> {
    ...
    public final void invoke2(@NotNull final FlowCollector<? super String> flow) {
        ...
        this.$this_transformForConcurrency.collect(new FlowCollector() { // from class: com.mobilefuse.sdk.nativeads.NativeAdParser$parse$$inlined$runOn$1.1
            ...
            /* compiled from: Flow.kt */
            @Metadata
            /* renamed from: com.mobilefuse.sdk.nativeads.NativeAdParser$parse$$inlined$runOn$1$1$1 */
            /* loaded from: classes7.dex */
            public static final class C236261 extends Lambda implements Functions<Unit> {
                final /* synthetic */ FlowCollector $this_transformForConcurrency;
                final /* synthetic */ Either $value;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C236261(FlowCollector flowCollector, Either either) {
                    super(0);
            ...
            public final void emit(@NotNull Either<? extends Throwable, ? extends T> value) {
                ...
                SchedulersKt.runOnScheduler(NativeAdParser$parse$$inlined$runOn$1.this.$scheduler$inlined, new C236261(flow, value));
            }
