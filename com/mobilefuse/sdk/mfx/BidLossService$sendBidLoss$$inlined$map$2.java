...
public final class BidLossService$sendBidLoss$$inlined$map$2 extends Lambda implements Function1<FlowCollector<? super String>, Unit> {
    final /* synthetic */ RtbLossReason $reason$inlined;
    final /* synthetic */ Flow $this_transform;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BidLossService$sendBidLoss$$inlined$map$2(Flow flow, RtbLossReason rtbLossReason) {
        super(1);
        this.$this_transform = flow;
        this.$reason$inlined = rtbLossReason;
    }
    ...
    public final void invoke2(@NotNull final FlowCollector<? super String> flow) {
        ...
        this.$this_transform.collect(new FlowCollector() { // from class: com.mobilefuse.sdk.mfx.BidLossService$sendBidLoss$$inlined$map$2.1
            ...
            public final void emit(@NotNull Either<? extends Throwable, ? extends T> value) {
                ...
                if (value instanceof SuccessResult) {
                    ...
                    try {
                        m16628I = StringsJVM.m16628I((String) ((SuccessResult) value).getValue(), "${AUCTION_LOSS}", String.valueOf(BidLossService$sendBidLoss$$inlined$map$2.this.$reason$inlined.getCode()), false, 4, null);
