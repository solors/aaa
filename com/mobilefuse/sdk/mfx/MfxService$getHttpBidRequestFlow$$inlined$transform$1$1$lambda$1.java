...
final class MfxService$getHttpBidRequestFlow$$inlined$transform$1$1$lambda$1 extends Lambda implements Function1<Either<? extends HttpError, ? extends HttpResponse>, Unit> {
    final /* synthetic */ FlowCollector $this_transform;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MfxService$getHttpBidRequestFlow$$inlined$transform$1$1$lambda$1(FlowCollector flowCollector) {
        super(1);
