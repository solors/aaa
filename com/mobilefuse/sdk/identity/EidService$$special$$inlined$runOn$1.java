...
public final class EidService$$special$$inlined$runOn$1 extends Lambda implements Function1<FlowCollector<? super Tuples<? extends Map<String, ? extends String>, ? extends EidDataModel>>, Unit> {
    ...
    public final void invoke2(@NotNull final FlowCollector<? super Tuples<? extends Map<String, ? extends String>, ? extends EidDataModel>> flow) {
        ...
        this.$this_transformForConcurrency.collect(new FlowCollector() { // from class: com.mobilefuse.sdk.identity.EidService$$special$$inlined$runOn$1.1
            ...
            /* compiled from: Flow.kt */
            @Metadata
            /* renamed from: com.mobilefuse.sdk.identity.EidService$$special$$inlined$runOn$1$1$1 */
            /* loaded from: classes7.dex */
            public static final class C235551 extends Lambda implements Functions<Unit> {
                final /* synthetic */ FlowCollector $this_transformForConcurrency;
                final /* synthetic */ Either $value;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C235551(FlowCollector flowCollector, Either either) {
                    super(0);
            ...
            public final void emit(@NotNull Either<? extends Throwable, ? extends T> value) {
                ...
                SchedulersKt.runOnScheduler(EidService$$special$$inlined$runOn$1.this.$scheduler$inlined, new C235551(flow, value));
            }
