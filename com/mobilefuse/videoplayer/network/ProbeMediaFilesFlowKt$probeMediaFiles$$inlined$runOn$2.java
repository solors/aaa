...
public final class ProbeMediaFilesFlowKt$probeMediaFiles$$inlined$runOn$2 extends Lambda implements Function1<FlowCollector<? super Either<? extends BaseError, ? extends VastMediaFile>>, Unit> {
    ...
    public final void invoke2(@NotNull final FlowCollector<? super Either<? extends BaseError, ? extends VastMediaFile>> flow) {
        ...
        this.$this_transformForConcurrency.collect(new FlowCollector() { // from class: com.mobilefuse.videoplayer.network.ProbeMediaFilesFlowKt$probeMediaFiles$$inlined$runOn$2.1
            ...
            /* compiled from: Flow.kt */
            @Metadata
            /* renamed from: com.mobilefuse.videoplayer.network.ProbeMediaFilesFlowKt$probeMediaFiles$$inlined$runOn$2$1$1 */
            /* loaded from: classes7.dex */
            public static final class C237751 extends Lambda implements Functions<Unit> {
                final /* synthetic */ FlowCollector $this_transformForConcurrency;
                final /* synthetic */ Either $value;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C237751(FlowCollector flowCollector, Either either) {
                    super(0);
            ...
            public final void emit(@NotNull Either<? extends Throwable, ? extends T> value) {
                ...
                SchedulersKt.runOnScheduler(ProbeMediaFilesFlowKt$probeMediaFiles$$inlined$runOn$2.this.$scheduler$inlined, new C237751(flow, value));
            }
