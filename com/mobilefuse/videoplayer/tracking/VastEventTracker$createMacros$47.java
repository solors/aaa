...
final class VastEventTracker$createMacros$47 extends Lambda implements Function1<VastError, String> {
    ...
    public final String invoke(@Nullable VastError vastError) {
        return StringEncodingAndFormatting.encodeUriComponent(StringEncodingAndFormatting.getIso8601Timestamp());
    }
}
