...
final class VastEventTracker$createMacros$16 extends Lambda implements Function1<VastError, String> {
    ...
    public final String invoke(@Nullable VastError vastError) {
        return StringEncodingAndFormatting.encodeUriComponent("MobileFuseVASTPlayer/Android_1.8.0");
    }
}
