...
final class VastEventTracker$createMacros$50 extends Lambda implements Function1<VastError, String> {
    ...
    public final String invoke(@Nullable VastError vastError) {
        return StringEncodingAndFormatting.enumCollectionToString(VideoPlayerSettings.Companion.getSupportedVastVersions());
    }
}
