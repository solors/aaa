...
final class VastEventTracker$createMacros$34 extends Lambda implements Function1<VastError, String> {
    ...
    public final String invoke(@Nullable VastError vastError) {
        String encodeUriComponent = StringEncodingAndFormatting.encodeUriComponent(VideoPlayerSettings.Companion.getSupportedVideoContainers());
