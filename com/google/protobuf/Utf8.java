    ...
    static final class UnsafeProcessor extends Processor {
        ...
        void encodeUtf8Direct(CharSequence charSequence, ByteBuffer byteBuffer) {
            ...
            if (length <= limit - position) {
                ...
                if (i3 == length) {
                    ByteBuffer byteBuffer2 = (ByteBuffer) byteBuffer.position((int) (position - addressOffset));
                    return;
                }
                while (i3 < length) {
                ...
                ByteBuffer byteBuffer3 = (ByteBuffer) byteBuffer.position((int) (position - addressOffset));
                return;
            }
