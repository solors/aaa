...
public final class Utf8 {
    ...
    /* renamed from: a */
    private static int m69990a(CharSequence charSequence, int i) {
            ...
            if (charAt < 2048) {
                ...
                if (55296 <= charAt && charAt <= 57343) {
                    if (Character.codePointAt(charSequence, i) != charAt) {
                        ...
                        throw new IllegalArgumentException(m69988c(i));
                    }
                }
            }
            i++;
    ...
    /* renamed from: b */
    private static boolean m69989b(byte[] bArr, int i, int i2) {
        byte b;
        while (i < i2) {
            int i3 = i + 1;
            byte b2 = bArr[i];
    ...
    /* renamed from: c */
    private static String m69988c(int i) {
