...
public final class Ints extends IntsMethodsForWeb {
    ...
    private static class IntArrayAsList extends AbstractList<Integer> implements RandomAccess, Serializable {
        ...
        /* renamed from: c */
        int[] m67989c() {
            return Arrays.copyOfRange(this.f41475b, this.f41476c, this.f41477d);
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
        public boolean contains(Object obj) {
            if ((obj instanceof Integer) && Ints.m67991c(this.f41475b, ((Integer) obj).intValue(), this.f41476c, this.f41477d) != -1) {
                return true;
            }
            return false;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof IntArrayAsList) {
                ...
                for (int i = 0; i < size; i++) {
                    if (this.f41475b[this.f41476c + i] != intArrayAsList.f41475b[intArrayAsList.f41476c + i]) {
                        return false;
                    }
                }
                return true;
        ...
        public int hashCode() {
            int i = 1;
            for (int i2 = this.f41476c; i2 < this.f41477d; i2++) {
                i = (i * 31) + Ints.hashCode(this.f41475b[i2]);
            }
            return i;
        }
        ...
        public int indexOf(Object obj) {
            int m67991c;
            if ((obj instanceof Integer) && (m67991c = Ints.m67991c(this.f41475b, ((Integer) obj).intValue(), this.f41476c, this.f41477d)) >= 0) {
                return m67991c - this.f41476c;
            }
            return -1;
        }
        ...
        public int lastIndexOf(Object obj) {
            int m67990d;
            if ((obj instanceof Integer) && (m67990d = Ints.m67990d(this.f41475b, ((Integer) obj).intValue(), this.f41476c, this.f41477d)) >= 0) {
                return m67990d - this.f41476c;
            }
            return -1;
        }
        ...
        @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
        public int size() {
            return this.f41477d - this.f41476c;
        }
        ...
        public String toString() {
            ...
            sb2.append('[');
            sb2.append(this.f41475b[this.f41476c]);
            int i = this.f41476c;
            while (true) {
                i++;
                if (i < this.f41477d) {
                    sb2.append(", ");
                    sb2.append(this.f41475b[i]);
                } else {
                    sb2.append(']');
                    return sb2.toString();
                }
        ...
        public Integer get(int i) {
            ...
            return Integer.valueOf(this.f41475b[this.f41476c + i]);
        }
    ...
    private static final class IntConverter extends Converter<String, Integer> implements Serializable {
        ...
        /* renamed from: d */
        static final IntConverter f41478d = new IntConverter();
        ...
        /* renamed from: h */
        public String mo67968d(Integer num) {
            return num.toString();
        }
        ...
        @Override // com.google.common.base.Converter
        /* renamed from: i */
        public Integer mo67967e(String str) {
    ...
    /* renamed from: c */
    public static int m67991c(int[] iArr, int i, int i2, int i3) {
        while (i2 < i3) {
            if (iArr[i2] == i) {
                return i2;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: d */
    public static int m67990d(int[] iArr, int i, int i2, int i3) {
    ...
    public static int indexOf(int[] iArr, int i) {
        return m67991c(iArr, i, 0, iArr.length);
    }
    ...
    public static int lastIndexOf(int[] iArr, int i) {
        return m67990d(iArr, i, 0, iArr.length);
    }
    ...
    public static Converter<String, Integer> stringConverter() {
        return IntConverter.f41478d;
    }

    public static int[] toArray(Collection<? extends Number> collection) {
        if (collection instanceof IntArrayAsList) {
            return ((IntArrayAsList) collection).m67989c();
        }
