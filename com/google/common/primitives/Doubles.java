...
public final class Doubles extends DoublesMethodsForWeb {
    ...
    /* renamed from: a */
    static final Pattern f41443a = m68052c();
    ...
    private static class DoubleArrayAsList extends AbstractList<Double> implements RandomAccess, Serializable {
        ...
        /* renamed from: c */
        double[] m68049c() {
            return Arrays.copyOfRange(this.f41444b, this.f41445c, this.f41446d);
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
        public boolean contains(Object obj) {
            if ((obj instanceof Double) && Doubles.m68051d(this.f41444b, ((Double) obj).doubleValue(), this.f41445c, this.f41446d) != -1) {
                return true;
            }
            return false;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof DoubleArrayAsList) {
                ...
                for (int i = 0; i < size; i++) {
                    if (this.f41444b[this.f41445c + i] != doubleArrayAsList.f41444b[doubleArrayAsList.f41445c + i]) {
                        return false;
                    }
                }
                return true;
        ...
        public int hashCode() {
            int i = 1;
            for (int i2 = this.f41445c; i2 < this.f41446d; i2++) {
                i = (i * 31) + Doubles.hashCode(this.f41444b[i2]);
            }
            return i;
        }
        ...
        public int indexOf(Object obj) {
            int m68051d;
            if ((obj instanceof Double) && (m68051d = Doubles.m68051d(this.f41444b, ((Double) obj).doubleValue(), this.f41445c, this.f41446d)) >= 0) {
                return m68051d - this.f41445c;
            }
            return -1;
        }
        ...
        public int lastIndexOf(Object obj) {
            int m68050e;
            if ((obj instanceof Double) && (m68050e = Doubles.m68050e(this.f41444b, ((Double) obj).doubleValue(), this.f41445c, this.f41446d)) >= 0) {
                return m68050e - this.f41445c;
            }
            return -1;
        }
        ...
        @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
        public int size() {
            return this.f41446d - this.f41445c;
        }
        ...
        public String toString() {
            ...
            sb2.append('[');
            sb2.append(this.f41444b[this.f41445c]);
            int i = this.f41445c;
            while (true) {
                i++;
                if (i < this.f41446d) {
                    sb2.append(", ");
                    sb2.append(this.f41444b[i]);
                } else {
                    sb2.append(']');
                    return sb2.toString();
                }
        ...
        public Double get(int i) {
            ...
            return Double.valueOf(this.f41444b[this.f41445c + i]);
        }
    ...
    private static final class DoubleConverter extends Converter<String, Double> implements Serializable {
        ...
        /* renamed from: d */
        static final DoubleConverter f41447d = new DoubleConverter();
        ...
        /* renamed from: h */
        public String mo67968d(Double d) {
            return d.toString();
        }
        ...
        @Override // com.google.common.base.Converter
        /* renamed from: i */
        public Double mo67967e(String str) {
    ...
    @GwtIncompatible
    /* renamed from: c */
    private static Pattern m68052c() {
    ...
    /* renamed from: d */
    public static int m68051d(double[] dArr, double d, int i, int i2) {
        while (i < i2) {
            if (dArr[i] == d) {
                return i;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: e */
    public static int m68050e(double[] dArr, double d, int i, int i2) {
    ...
    public static int indexOf(double[] dArr, double d) {
        return m68051d(dArr, d, 0, dArr.length);
    }
    ...
    public static int lastIndexOf(double[] dArr, double d) {
        return m68050e(dArr, d, 0, dArr.length);
    }
    ...
    public static Converter<String, Double> stringConverter() {
        return DoubleConverter.f41447d;
    }

    public static double[] toArray(Collection<? extends Number> collection) {
        if (collection instanceof DoubleArrayAsList) {
            return ((DoubleArrayAsList) collection).m68049c();
        }
    ...
    public static Double tryParse(String str) {
        if (f41443a.matcher(str).matches()) {
            try {
