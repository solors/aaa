...
public class zzgz extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzgt) this.zzb.get(i2)).zza());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object zzl(int i) {
        zzn();
        Object value = ((zzgt) this.zzb.remove(i)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final Object get(Object obj) {
        ...
        if (zzk >= 0) {
            return ((zzgt) this.zzb.get(zzk)).getValue();
        }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < zzb; i2++) {
            i += ((zzgt) this.zzb.get(i2)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzgt zzgtVar = (zzgt) this.zzb.remove(i2 - 1);
            zzm().put(zzgtVar.zza(), zzgtVar.getValue());
        }
        this.zzb.add(i, new zzgt(this, comparable, obj));
        return null;
    }
