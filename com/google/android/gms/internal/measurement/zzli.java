...
public interface zzli {
    ...
    <T> void zza(T t, zzll<T> zzllVar, zzix zzixVar) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzll<T> zzllVar, zzix zzixVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzkk<K, V> zzkkVar, zzix zzixVar) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t, zzll<T> zzllVar, zzix zzixVar) throws IOException;

    void zzb(List<zzia> list) throws IOException;

    <T> void zzb(List<T> list, zzll<T> zzllVar, zzix zzixVar) throws IOException;
