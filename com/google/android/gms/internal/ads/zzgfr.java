...
public final class zzgfr {
    ...
    public final zzgfr zza(int i) throws GeneralSecurityException {
        if (i != 12 && i != 16) {
    ...
    public final zzgfr zzb(int i) throws GeneralSecurityException {
        if (i != 16 && i != 24 && i != 32) {
    ...
    public final zzgfr zzc(int i) throws GeneralSecurityException {
        this.zzc = 16;
        return this;
    }
