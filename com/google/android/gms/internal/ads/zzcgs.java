...
public abstract class zzcgs extends zzayb implements zzcgt {
    ...
    protected final boolean zzdD(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        switch (i) {
            ...
            case 2:
                zzayc.zzc(parcel);
                Bundle zzd = zzd((Bundle) zzayc.zza(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
                zzayc.zze(parcel2, zzd);
                return true;
            case 3:
                zzayc.zzc(parcel);
                zzo(parcel.readString(), parcel.readString(), (Bundle) zzayc.zza(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
                return true;
            case 4:
            ...
            case 7:
                zzayc.zzc(parcel);
                zzq((Bundle) zzayc.zza(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
                return true;
            case 8:
                zzayc.zzc(parcel);
                zzm(parcel.readString(), parcel.readString(), (Bundle) zzayc.zza(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
                return true;
            case 9:
            ...
            case 19:
                zzayc.zzc(parcel);
                zzr((Bundle) zzayc.zza(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
                return true;
            default:
                return false;
