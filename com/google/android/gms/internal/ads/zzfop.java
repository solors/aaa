...
public final class zzfop extends com.google.android.gms.ads.internal.zzc {
    ...
    public zzfop(Context context, Looper looper, BaseGmsClient.BaseConnectionCallbacks baseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener baseOnConnectionFailedListener, int i) {
    ...
    public final /* synthetic */ IInterface createServiceInterface(IBinder iBinder) {
        ...
        if (queryLocalInterface instanceof zzfou) {
            return (zzfou) queryLocalInterface;
        }
        return new zzfou(iBinder);
    }
