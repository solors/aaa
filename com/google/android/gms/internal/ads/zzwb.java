...
public final class zzwb {
    ...
    public final zzwb zzg(int i, int i2) {
        int[] iArr = new int[i2];
        ...
        while (true) {
            ...
            if (i3 < iArr4.length + i2) {
                ...
                return new zzwb(iArr3, new Random(this.zza.nextLong()));
            }
        }
    }

    public final zzwb zzh(int i, int i2) {
        ...
        while (true) {
            ...
            if (i3 < iArr2.length) {
                ...
                return new zzwb(iArr, new Random(this.zza.nextLong()));
            }
        }
    }

    private zzwb(int i, Random random) {
        this(new int[0], random);
    }

    private zzwb(int[] iArr, Random random) {
        this.zzb = iArr;
        this.zza = random;
