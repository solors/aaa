...
interface zzgzp {
    ...
    @Deprecated
    void zzC(List list, zzgzv zzgzvVar, zzgxb zzgxbVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgzv zzgzvVar, zzgxb zzgxbVar) throws IOException;
    ...
    zzgwj zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzgzv zzgzvVar, zzgxb zzgxbVar) throws IOException;

    void zzu(Object obj, zzgzv zzgzvVar, zzgxb zzgxbVar) throws IOException;
