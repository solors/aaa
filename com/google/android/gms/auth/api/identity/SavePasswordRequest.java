...
public class SavePasswordRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSignInPassword", m72314id = 1)
    private final SignInPassword zba;
    @Nullable
    @SafeParcelable.Field(getter = "getSessionId", m72314id = 2)
    private final String zbb;
    @SafeParcelable.Field(getter = "getTheme", m72314id = 3)
    ...
    public SavePasswordRequest(@SafeParcelable.Param(m72313id = 1) SignInPassword signInPassword, @Nullable @SafeParcelable.Param(m72313id = 2) String str, @SafeParcelable.Param(m72313id = 3) int i) {
