...
public class AuthorizationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getRequestedScopes", m72314id = 1)
    private final List zba;
    @Nullable
    @SafeParcelable.Field(getter = "getServerClientId", m72314id = 2)
    private final String zbb;
    @SafeParcelable.Field(getter = "isOfflineAccessRequested", m72314id = 3)
    private final boolean zbc;
    @SafeParcelable.Field(getter = "isIdTokenRequested", m72314id = 4)
    private final boolean zbd;
    @Nullable
    @SafeParcelable.Field(getter = "getAccount", m72314id = 5)
    private final Account zbe;
    @Nullable
    @SafeParcelable.Field(getter = "getHostedDomain", m72314id = 6)
    private final String zbf;
    @Nullable
    @SafeParcelable.Field(getter = "getSessionId", m72314id = 7)
    private final String zbg;
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", m72314id = 8)
    ...
    public AuthorizationRequest(@SafeParcelable.Param(m72313id = 1) List list, @Nullable @SafeParcelable.Param(m72313id = 2) String str, @SafeParcelable.Param(m72313id = 3) boolean z, @SafeParcelable.Param(m72313id = 4) boolean z2, @Nullable @SafeParcelable.Param(m72313id = 5) Account account, @Nullable @SafeParcelable.Param(m72313id = 6) String str2, @Nullable @SafeParcelable.Param(m72313id = 7) String str3, @SafeParcelable.Param(m72313id = 8) boolean z3) {
        boolean z4 = false;
        if (list != null && !list.isEmpty()) {
            z4 = true;
        }
