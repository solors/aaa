...
public final class BeginSignInRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getPasswordRequestOptions", m72314id = 1)
    private final PasswordRequestOptions zba;
    @SafeParcelable.Field(getter = "getGoogleIdTokenRequestOptions", m72314id = 2)
    private final GoogleIdTokenRequestOptions zbb;
    @Nullable
    @SafeParcelable.Field(getter = "getSessionId", m72314id = 3)
    private final String zbc;
    @SafeParcelable.Field(getter = "isAutoSelectEnabled", m72314id = 4)
    private final boolean zbd;
    @SafeParcelable.Field(getter = "getTheme", m72314id = 5)
    private final int zbe;
    @SafeParcelable.Field(getter = "getPasskeysRequestOptions", m72314id = 6)
    private final PasskeysRequestOptions zbf;
    @SafeParcelable.Field(getter = "getPasskeyJsonRequestOptions", m72314id = 7)
    ...
    public static final class GoogleIdTokenRequestOptions extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "isSupported", m72314id = 1)
        private final boolean zba;
        @Nullable
        @SafeParcelable.Field(getter = "getServerClientId", m72314id = 2)
        private final String zbb;
        @Nullable
        @SafeParcelable.Field(getter = "getNonce", m72314id = 3)
        private final String zbc;
        @SafeParcelable.Field(getter = "filterByAuthorizedAccounts", m72314id = 4)
        private final boolean zbd;
        @Nullable
        @SafeParcelable.Field(getter = "getLinkedServiceId", m72314id = 5)
        private final String zbe;
        @Nullable
        @SafeParcelable.Field(getter = "getIdTokenDepositionScopes", m72314id = 6)
        private final List zbf;
        @SafeParcelable.Field(getter = "requestVerifiedPhoneNumber", m72314id = 7)
        ...
        public GoogleIdTokenRequestOptions(@SafeParcelable.Param(m72313id = 1) boolean z, @Nullable @SafeParcelable.Param(m72313id = 2) String str, @Nullable @SafeParcelable.Param(m72313id = 3) String str2, @SafeParcelable.Param(m72313id = 4) boolean z2, @Nullable @SafeParcelable.Param(m72313id = 5) String str3, @Nullable @SafeParcelable.Param(m72313id = 6) List list, @SafeParcelable.Param(m72313id = 7) boolean z3) {
            boolean z4 = true;
            if (z2 && z3) {
                z4 = false;
            }
    ...
    public static final class PasskeyJsonRequestOptions extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "isSupported", m72314id = 1)
        private final boolean zba;
        @SafeParcelable.Field(getter = "getRequestJson", m72314id = 2)
        private final String zbb;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @SafeParcelable.Constructor
        public PasskeyJsonRequestOptions(@SafeParcelable.Param(m72313id = 1) boolean z, @SafeParcelable.Param(m72313id = 2) String str) {
            if (z) {
    ...
    public static final class PasskeysRequestOptions extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "isSupported", m72314id = 1)
        private final boolean zba;
        @SafeParcelable.Field(getter = "getChallenge", m72314id = 2)
        private final byte[] zbb;
        @SafeParcelable.Field(getter = "getRpId", m72314id = 3)
        private final String zbc;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @SafeParcelable.Constructor
        public PasskeysRequestOptions(@SafeParcelable.Param(m72313id = 1) boolean z, @SafeParcelable.Param(m72313id = 2) byte[] bArr, @SafeParcelable.Param(m72313id = 3) String str) {
            if (z) {
    ...
    public static final class PasswordRequestOptions extends AbstractSafeParcelable {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @SafeParcelable.Constructor
        public PasswordRequestOptions(@SafeParcelable.Param(m72313id = 1) boolean z) {
            this.zba = z;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public BeginSignInRequest(@SafeParcelable.Param(m72313id = 1) PasswordRequestOptions passwordRequestOptions, @SafeParcelable.Param(m72313id = 2) GoogleIdTokenRequestOptions googleIdTokenRequestOptions, @Nullable @SafeParcelable.Param(m72313id = 3) String str, @SafeParcelable.Param(m72313id = 4) boolean z, @SafeParcelable.Param(m72313id = 5) int i, @Nullable @SafeParcelable.Param(m72313id = 6) PasskeysRequestOptions passkeysRequestOptions, @Nullable @SafeParcelable.Param(m72313id = 7) PasskeyJsonRequestOptions passkeyJsonRequestOptions) {
        this.zba = (PasswordRequestOptions) Preconditions.checkNotNull(passwordRequestOptions);
        this.zbb = (GoogleIdTokenRequestOptions) Preconditions.checkNotNull(googleIdTokenRequestOptions);
        this.zbc = str;
        this.zbd = z;
