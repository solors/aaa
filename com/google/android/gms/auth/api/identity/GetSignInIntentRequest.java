...
public class GetSignInIntentRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getServerClientId", m72314id = 1)
    private final String zba;
    @Nullable
    @SafeParcelable.Field(getter = "getHostedDomainFilter", m72314id = 2)
    private final String zbb;
    @Nullable
    @SafeParcelable.Field(getter = "getSessionId", m72314id = 3)
    private final String zbc;
    @Nullable
    @SafeParcelable.Field(getter = "getNonce", m72314id = 4)
    private final String zbd;
    @SafeParcelable.Field(getter = "requestVerifiedPhoneNumber", m72314id = 5)
    ...
    public GetSignInIntentRequest(@SafeParcelable.Param(m72313id = 1) String str, @Nullable @SafeParcelable.Param(m72313id = 2) String str2, @Nullable @SafeParcelable.Param(m72313id = 3) String str3, @Nullable @SafeParcelable.Param(m72313id = 4) String str4, @SafeParcelable.Param(m72313id = 5) boolean z, @SafeParcelable.Param(m72313id = 6) int i) {
        Preconditions.checkNotNull(str);
        this.zba = str;
        this.zbb = str2;
        this.zbc = str3;
