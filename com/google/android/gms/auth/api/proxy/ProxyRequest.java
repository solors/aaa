...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    public ProxyRequest(@SafeParcelable.Param(m72313id = 1000) int i, @SafeParcelable.Param(m72313id = 1) String str, @SafeParcelable.Param(m72313id = 2) int i2, @SafeParcelable.Param(m72313id = 3) long j, @SafeParcelable.Param(m72313id = 4) byte[] bArr, @SafeParcelable.Param(m72313id = 5) Bundle bundle) {
        this.zza = i;
        this.url = str;
        this.httpMethod = i2;
