...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    */
    ...
    public ActivityRecognitionResult(@NonNull @SafeParcelable.Param(m72313id = 1) List<DetectedActivity> list, @SafeParcelable.Param(m72313id = 2) long j, @SafeParcelable.Param(m72313id = 3) long j2, @SafeParcelable.Param(m72313id = 4) int i, @Nullable @SafeParcelable.Param(m72313id = 5) Bundle bundle) {
        boolean z = true;
