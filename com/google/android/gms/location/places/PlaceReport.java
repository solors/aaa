...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", m72314id = 3)
    private final String tag;
    @SafeParcelable.VersionField(m72311id = 1)
    private final int versionCode;
    @SafeParcelable.Field(getter = "getPlaceId", m72314id = 2)
    private final String zza;
    @SafeParcelable.Field(getter = "getSource", m72314id = 4)
    private final String zzb;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public PlaceReport(@SafeParcelable.Param(m72313id = 1) int i, @SafeParcelable.Param(m72313id = 2) String str, @SafeParcelable.Param(m72313id = 3) String str2, @SafeParcelable.Param(m72313id = 4) String str3) {
        this.versionCode = i;
        this.zza = str;
        this.tag = str2;
        this.zzb = str3;
