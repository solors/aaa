...
public final class GoogleServices {
    ...
    GoogleServices(Context context) {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", "integer", resources.getResourcePackageName(C16262R.C16263string.common_google_play_services_unknown_issue));
        if (identifier != 0) {
