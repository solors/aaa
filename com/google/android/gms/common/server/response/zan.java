...
public final class zan extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getRootClassName", m72314id = 3)
    private final String zac;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public zan(@SafeParcelable.Param(m72313id = 1) int i, @SafeParcelable.Param(m72313id = 2) ArrayList arrayList, @SafeParcelable.Param(m72313id = 3) String str) {
        this.zaa = i;
