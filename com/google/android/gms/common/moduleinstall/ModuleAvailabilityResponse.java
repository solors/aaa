...
public class ModuleAvailabilityResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "areModulesAvailable", m72314id = 1)
    private final boolean zaa;
    @SafeParcelable.Field(getter = "getAvailabilityStatus", m72314id = 2)
    ...
    @KeepForSdk
    public ModuleAvailabilityResponse(@SafeParcelable.Param(m72313id = 1) boolean z, @SafeParcelable.Param(m72313id = 2) int i) {
        this.zaa = z;
        this.zab = i;
    }
