...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final zabx zac(Context context, zabw zabwVar) {
        ...
        intentFilter.addDataScheme(C26542f.C26543a.f69507e);
    ...
    @TargetApi(20)
    final void zae(Context context, int i, @Nullable String str, @Nullable PendingIntent pendingIntent) {
        int i2;
        String str2;
        NotificationChannel notificationChannel;
        CharSequence name;
        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C16256R.C16258drawable.common_full_open_on_phone, resources.getString(C16256R.C16260string.common_open_on_phone), pendingIntent);
                } else {
                    style.setContentIntent(pendingIntent);
                }
            } else {
                style.setSmallIcon(17301642).setTicker(resources.getString(C16256R.C16260string.common_google_play_services_notification_ticker)).setWhen(System.currentTimeMillis()).setContentIntent(pendingIntent).setContentText(zad);
            }
            if (PlatformVersion.isAtLeastO()) {
                ...
                if (str2 == null) {
                    ...
                    String string = context.getResources().getString(C16256R.C16260string.common_google_play_services_notification_channel_name);
