...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    final int zza;
    @SafeParcelable.Field(getter = "getErrorCode", m72314id = 2)
    private final int zzb;
    @Nullable
    @SafeParcelable.Field(getter = "getResolution", m72314id = 3)
    private final PendingIntent zzc;
    @Nullable
    @SafeParcelable.Field(getter = "getErrorMessage", m72314id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m72313id = 1) int i, @SafeParcelable.Param(m72313id = 2) int i2, @Nullable @SafeParcelable.Param(m72313id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m72313id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
