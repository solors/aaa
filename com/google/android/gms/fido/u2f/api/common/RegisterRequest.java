...
public class RegisterRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getProtocolVersionAsString", m72314id = 2, type = "java.lang.String")
    private final ProtocolVersion zzb;
    @SafeParcelable.Field(getter = "getChallengeValue", m72314id = 3)
    ...
    public RegisterRequest(@SafeParcelable.Param(m72313id = 1) int i, @SafeParcelable.Param(m72313id = 2) String str, @SafeParcelable.Param(m72313id = 3) byte[] bArr, @SafeParcelable.Param(m72313id = 4) String str2) {
        this.zza = i;
        try {
