...
public class KeyHandle extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBytes", m72314id = 2)
    private final byte[] zzb;
    @SafeParcelable.Field(getter = "getProtocolVersionAsString", m72314id = 3, type = "java.lang.String")
    private final ProtocolVersion zzc;
    @Nullable
    @SafeParcelable.Field(getter = "getTransports", m72314id = 4)
    private final List zzd;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public KeyHandle(@SafeParcelable.Param(m72313id = 1) int i, @SafeParcelable.Param(m72313id = 2) byte[] bArr, @SafeParcelable.Param(m72313id = 3) String str, @Nullable @SafeParcelable.Param(m72313id = 4) List list) {
        this.zza = i;
        this.zzb = bArr;
        try {
