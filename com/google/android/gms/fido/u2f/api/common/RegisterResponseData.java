...
public class RegisterResponseData extends ResponseData {
    ...
    @SafeParcelable.Field(getter = "getRegisterData", m72314id = 2)
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getClientDataString", m72314id = 4)
    ...
    public RegisterResponseData(@SafeParcelable.Param(m72313id = 2) byte[] bArr, @SafeParcelable.Param(m72313id = 3) String str, @Nullable @SafeParcelable.Param(m72313id = 4) String str2) {
        this.zza = bArr;
        try {
