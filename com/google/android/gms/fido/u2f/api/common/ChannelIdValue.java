...
public class ChannelIdValue extends AbstractSafeParcelable {
    @SafeParcelable.Field(getter = "getTypeAsInt", m72314id = 2, type = "int")
    private final ChannelIdValueType zza;
    @SafeParcelable.Field(getter = "getStringValue", m72314id = 3)
    private final String zzb;
    @SafeParcelable.Field(getter = "getObjectValueAsString", m72314id = 4)
    ...
    public ChannelIdValue(@SafeParcelable.Param(m72313id = 2) int i, @SafeParcelable.Param(m72313id = 3) String str, @SafeParcelable.Param(m72313id = 4) String str2) {
        try {
