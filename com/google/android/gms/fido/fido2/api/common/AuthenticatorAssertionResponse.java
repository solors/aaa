...
public class AuthenticatorAssertionResponse extends AuthenticatorResponse {
    ...
    @NonNull
    @SafeParcelable.Field(getter = "getClientDataJSON", m72314id = 3)
    private final byte[] zzb;
    @NonNull
    @SafeParcelable.Field(getter = "getAuthenticatorData", m72314id = 4)
    private final byte[] zzc;
    @NonNull
    @SafeParcelable.Field(getter = "getSignature", m72314id = 5)
    private final byte[] zzd;
    @Nullable
    @SafeParcelable.Field(getter = "getUserHandle", m72314id = 6)
    private final byte[] zze;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public AuthenticatorAssertionResponse(@NonNull @SafeParcelable.Param(m72313id = 2) byte[] bArr, @NonNull @SafeParcelable.Param(m72313id = 3) byte[] bArr2, @NonNull @SafeParcelable.Param(m72313id = 4) byte[] bArr3, @NonNull @SafeParcelable.Param(m72313id = 5) byte[] bArr4, @Nullable @SafeParcelable.Param(m72313id = 6) byte[] bArr5) {
