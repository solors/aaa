...
public class AuthenticatorErrorResponse extends AuthenticatorResponse {
    ...
    @NonNull
    @SafeParcelable.Field(getter = "getErrorCodeAsInt", m72314id = 2, type = "int")
    private final ErrorCode zza;
    @Nullable
    @SafeParcelable.Field(getter = "getErrorMessage", m72314id = 3)
    private final String zzb;
    @SafeParcelable.Field(defaultValue = "0", getter = "getInternalErrorCode", m72314id = 4, type = "int")
    private final int zzc;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public AuthenticatorErrorResponse(@NonNull @SafeParcelable.Param(m72313id = 2) int i, @Nullable @SafeParcelable.Param(m72313id = 3) String str, @SafeParcelable.Param(m72313id = 4) int i2) {
        try {
