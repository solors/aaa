...
public class PublicKeyCredentialParameters extends AbstractSafeParcelable {
    ...
    @NonNull
    @SafeParcelable.Field(getter = "getAlgorithmIdAsInteger", m72314id = 3, type = "java.lang.Integer")
    private final COSEAlgorithmIdentifier zzb;

    @SafeParcelable.Constructor
    public PublicKeyCredentialParameters(@NonNull @SafeParcelable.Param(m72313id = 2) String str, @SafeParcelable.Param(m72313id = 3) int i) {
