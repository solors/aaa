...
public class PublicKeyCredentialDescriptor extends AbstractSafeParcelable {
    @NonNull
    @SafeParcelable.Field(getter = "getTypeAsString", m72314id = 2, type = "java.lang.String")
    private final PublicKeyCredentialType zzb;
    @NonNull
    @SafeParcelable.Field(getter = "getId", m72314id = 3)
    ...
    public PublicKeyCredentialDescriptor(@NonNull @SafeParcelable.Param(m72313id = 2) String str, @NonNull @SafeParcelable.Param(m72313id = 3) byte[] bArr, @Nullable @SafeParcelable.Param(m72313id = 4) List<Transport> list) {
