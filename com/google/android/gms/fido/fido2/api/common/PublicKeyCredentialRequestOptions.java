...
public class PublicKeyCredentialRequestOptions extends RequestOptions {
    ...
    @NonNull
    @SafeParcelable.Field(getter = "getRpId", m72314id = 4)
    private final String zzc;
    @Nullable
    @SafeParcelable.Field(getter = "getAllowList", m72314id = 5)
    private final List zzd;
    @Nullable
    @SafeParcelable.Field(getter = "getRequestId", m72314id = 6)
    private final Integer zze;
    @Nullable
    @SafeParcelable.Field(getter = "getTokenBinding", m72314id = 7)
    private final TokenBinding zzf;
    @Nullable
    @SafeParcelable.Field(getter = "getUserVerificationAsString", m72314id = 8, type = "java.lang.String")
    private final zzay zzg;
    @Nullable
    @SafeParcelable.Field(getter = "getAuthenticationExtensions", m72314id = 9)
    private final AuthenticationExtensions zzh;
    @Nullable
    @SafeParcelable.Field(getter = "getLongRequestId", m72314id = 10)
    ...
    public PublicKeyCredentialRequestOptions(@NonNull @SafeParcelable.Param(m72313id = 2) byte[] bArr, @Nullable @SafeParcelable.Param(m72313id = 3) Double d, @NonNull @SafeParcelable.Param(m72313id = 4) String str, @Nullable @SafeParcelable.Param(m72313id = 5) List list, @Nullable @SafeParcelable.Param(m72313id = 6) Integer num, @Nullable @SafeParcelable.Param(m72313id = 7) TokenBinding tokenBinding, @Nullable @SafeParcelable.Param(m72313id = 8) String str2, @Nullable @SafeParcelable.Param(m72313id = 9) AuthenticationExtensions authenticationExtensions, @Nullable @SafeParcelable.Param(m72313id = 10) Long l) {
        this.zza = (byte[]) Preconditions.checkNotNull(bArr);
        this.zzb = d;
        this.zzc = (String) Preconditions.checkNotNull(str);
        this.zzd = list;
