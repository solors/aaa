...
public class AuthenticatorAttestationResponse extends AuthenticatorResponse {
    ...
    @NonNull
    @SafeParcelable.Field(getter = "getAttestationObject", m72314id = 4)
    private final byte[] zzc;
    @NonNull
    @SafeParcelable.Field(getter = "getTransports", m72314id = 5)
    private final String[] zzd;

    /* JADX INFO: Access modifiers changed from: package-private */
    @SafeParcelable.Constructor
    public AuthenticatorAttestationResponse(@NonNull @SafeParcelable.Param(m72313id = 2) byte[] bArr, @NonNull @SafeParcelable.Param(m72313id = 3) byte[] bArr2, @NonNull @SafeParcelable.Param(m72313id = 4) byte[] bArr3, @NonNull @SafeParcelable.Param(m72313id = 5) String[] strArr) {
