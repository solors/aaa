...
public class AuthenticatorSelectionCriteria extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getAttachmentAsString", m72314id = 2, type = "java.lang.String")
    private final Attachment zza;
    @Nullable
    @SafeParcelable.Field(getter = "getRequireResidentKey", m72314id = 3)
    private final Boolean zzb;
    @Nullable
    @SafeParcelable.Field(getter = "getRequireUserVerificationAsString", m72314id = 4, type = "java.lang.String")
    private final zzay zzc;
    @Nullable
    @SafeParcelable.Field(getter = "getResidentKeyRequirementAsString", m72314id = 5, type = "java.lang.String")
    ...
    public AuthenticatorSelectionCriteria(@Nullable @SafeParcelable.Param(m72313id = 2) String str, @Nullable @SafeParcelable.Param(m72313id = 3) Boolean bool, @Nullable @SafeParcelable.Param(m72313id = 4) String str2, @Nullable @SafeParcelable.Param(m72313id = 5) String str3) {
