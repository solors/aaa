...
public class AuthenticationExtensions extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getFidoAppIdExtension", m72314id = 2)
    private final FidoAppIdExtension zza;
    @Nullable
    @SafeParcelable.Field(getter = "getCableAuthenticationExtension", m72314id = 3)
    private final zzs zzb;
    @Nullable
    @SafeParcelable.Field(getter = "getUserVerificationMethodExtension", m72314id = 4)
    private final UserVerificationMethodExtension zzc;
    @Nullable
    @SafeParcelable.Field(getter = "getGoogleMultiAssertionExtension", m72314id = 5)
    private final zzz zzd;
    @Nullable
    @SafeParcelable.Field(getter = "getGoogleSessionIdExtension", m72314id = 6)
    private final zzab zze;
    @Nullable
    @SafeParcelable.Field(getter = "getGoogleSilentVerificationExtension", m72314id = 7)
    private final zzad zzf;
    @Nullable
    @SafeParcelable.Field(getter = "getDevicePublicKeyExtension", m72314id = 8)
    private final zzu zzg;
    @Nullable
    @SafeParcelable.Field(getter = "getGoogleTunnelServerIdExtension", m72314id = 9)
    private final zzag zzh;
    @Nullable
    @SafeParcelable.Field(getter = "getGoogleThirdPartyPaymentExtension", m72314id = 10)
    private final GoogleThirdPartyPaymentExtension zzi;
    @Nullable
    @SafeParcelable.Field(getter = "getPrfExtension", m72314id = 11)
    ...
    public AuthenticationExtensions(@Nullable @SafeParcelable.Param(m72313id = 2) FidoAppIdExtension fidoAppIdExtension, @Nullable @SafeParcelable.Param(m72313id = 3) zzs zzsVar, @Nullable @SafeParcelable.Param(m72313id = 4) UserVerificationMethodExtension userVerificationMethodExtension, @Nullable @SafeParcelable.Param(m72313id = 5) zzz zzzVar, @Nullable @SafeParcelable.Param(m72313id = 6) zzab zzabVar, @Nullable @SafeParcelable.Param(m72313id = 7) zzad zzadVar, @Nullable @SafeParcelable.Param(m72313id = 8) zzu zzuVar, @Nullable @SafeParcelable.Param(m72313id = 9) zzag zzagVar, @Nullable @SafeParcelable.Param(m72313id = 10) GoogleThirdPartyPaymentExtension googleThirdPartyPaymentExtension, @Nullable @SafeParcelable.Param(m72313id = 11) zzai zzaiVar) {
        this.zza = fidoAppIdExtension;
