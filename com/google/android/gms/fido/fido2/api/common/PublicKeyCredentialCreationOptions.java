...
public class PublicKeyCredentialCreationOptions extends RequestOptions {
    ...
    @NonNull
    @SafeParcelable.Field(getter = "getRp", m72314id = 2)
    private final PublicKeyCredentialRpEntity zza;
    @NonNull
    @SafeParcelable.Field(getter = "getUser", m72314id = 3)
    private final PublicKeyCredentialUserEntity zzb;
    @NonNull
    @SafeParcelable.Field(getter = "getChallenge", m72314id = 4)
    private final byte[] zzc;
    @NonNull
    @SafeParcelable.Field(getter = "getParameters", m72314id = 5)
    private final List zzd;
    @Nullable
    @SafeParcelable.Field(getter = "getTimeoutSeconds", m72314id = 6)
    private final Double zze;
    @Nullable
    @SafeParcelable.Field(getter = "getExcludeList", m72314id = 7)
    private final List zzf;
    @Nullable
    @SafeParcelable.Field(getter = "getAuthenticatorSelection", m72314id = 8)
    private final AuthenticatorSelectionCriteria zzg;
    @Nullable
    @SafeParcelable.Field(getter = "getRequestId", m72314id = 9)
    private final Integer zzh;
    @Nullable
    @SafeParcelable.Field(getter = "getTokenBinding", m72314id = 10)
    private final TokenBinding zzi;
    @Nullable
    @SafeParcelable.Field(getter = "getAttestationConveyancePreferenceAsString", m72314id = 11, type = "java.lang.String")
    private final AttestationConveyancePreference zzj;
    @Nullable
    @SafeParcelable.Field(getter = "getAuthenticationExtensions", m72314id = 12)
    ...
    public PublicKeyCredentialCreationOptions(@NonNull @SafeParcelable.Param(m72313id = 2) PublicKeyCredentialRpEntity publicKeyCredentialRpEntity, @NonNull @SafeParcelable.Param(m72313id = 3) PublicKeyCredentialUserEntity publicKeyCredentialUserEntity, @NonNull @SafeParcelable.Param(m72313id = 4) byte[] bArr, @NonNull @SafeParcelable.Param(m72313id = 5) List list, @Nullable @SafeParcelable.Param(m72313id = 6) Double d, @Nullable @SafeParcelable.Param(m72313id = 7) List list2, @Nullable @SafeParcelable.Param(m72313id = 8) AuthenticatorSelectionCriteria authenticatorSelectionCriteria, @Nullable @SafeParcelable.Param(m72313id = 9) Integer num, @Nullable @SafeParcelable.Param(m72313id = 10) TokenBinding tokenBinding, @Nullable @SafeParcelable.Param(m72313id = 11) String str, @Nullable @SafeParcelable.Param(m72313id = 12) AuthenticationExtensions authenticationExtensions) {
        this.zza = (PublicKeyCredentialRpEntity) Preconditions.checkNotNull(publicKeyCredentialRpEntity);
        this.zzb = (PublicKeyCredentialUserEntity) Preconditions.checkNotNull(publicKeyCredentialUserEntity);
        this.zzc = (byte[]) Preconditions.checkNotNull(bArr);
        this.zzd = (List) Preconditions.checkNotNull(list);
