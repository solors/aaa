...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public static class RangeSliderState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeFloat(this.f38331b);
        ...
        private RangeSliderState(Parcel parcel) {
            ...
            this.f38331b = parcel.readFloat();
            this.f38332c = parcel.readInt();
        }
    }
    ...
    /* renamed from: t0 */
    private static List<Float> m70914t0(TypedArray typedArray) {
    ...
    public void onRestoreInstanceState(@Nullable Parcelable parcelable) {
        ...
        this.f38329j0 = rangeSliderState.f38331b;
        int i = rangeSliderState.f38332c;
        this.f38330k0 = i;
        setSeparationUnit(i);
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        rangeSliderState.f38331b = this.f38329j0;
        rangeSliderState.f38332c = this.f38330k0;
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C16310R.styleable.RangeSlider, i, BaseSlider.f38260i0, new int[0]);
        int i2 = C16310R.styleable.RangeSlider_values;
        if (obtainStyledAttributes.hasValue(i2)) {
            setValues(m70914t0(obtainStyledAttributes.getResources().obtainTypedArray(obtainStyledAttributes.getResourceId(i2, 0))));
        }
        this.f38329j0 = obtainStyledAttributes.getDimension(C16310R.styleable.RangeSlider_minSeparation, 0.0f);
