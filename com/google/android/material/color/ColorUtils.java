...
final class ColorUtils {
    ...
    /* renamed from: a */
    private static final float[] f37225a = {95.047f, 100.0f, 108.883f};
    ...
    public static float delinearized(float f) {
        ...
        return (((float) Math.pow(f, 0.4166666567325592d)) * 1.055f) - 0.055f;
    }
    ...
    public static int intFromLab(double d, double d2, double d3) {
        ...
        float[] fArr = f37225a;
        return intFromXyzComponents((float) (d8 * fArr[0]), (float) (d4 * fArr[1]), (float) (d9 * fArr[2]));
    }
    ...
    public static final float[] whitePointD65() {
        return Arrays.copyOf(f37225a, 3);
    }
