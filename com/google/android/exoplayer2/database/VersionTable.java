...
public final class VersionTable {
    ...
    /* renamed from: a */
    private static String[] m74893a(int i, String str) {
    ...
    public static int getVersion(SQLiteDatabase sQLiteDatabase, int i, String str) throws DatabaseIOException {
        try {
            ...
            Cursor query = sQLiteDatabase.query("ExoPlayerVersions", new String[]{"version"}, "feature = ? AND instance_uid = ?", m74893a(i, str), null, null, null);
            if (query.getCount() == 0) {
                query.close();
                return -1;
            }
    ...
    public static void removeVersion(SQLiteDatabase sQLiteDatabase, int i, String str) throws DatabaseIOException {
        try {
            ...
            sQLiteDatabase.delete("ExoPlayerVersions", "feature = ? AND instance_uid = ?", m74893a(i, str));
        } catch (SQLException e) {
            throw new DatabaseIOException(e);
        }
    }
