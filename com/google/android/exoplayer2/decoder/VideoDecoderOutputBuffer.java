...
public class VideoDecoderOutputBuffer extends DecoderOutputBuffer {
    ...
    /* renamed from: c */
    private final DecoderOutputBuffer.Owner<VideoDecoderOutputBuffer> f32705c;
    ...
    /* renamed from: c */
    private static boolean m74877c(int i, int i2) {
    ...
    public boolean initForYuvFrame(int i, int i2, int i3, int i4, int i5) {
        ...
        this.colorspace = i5;
        int i6 = (int) ((i2 + 1) / 2);
        if (m74877c(i3, i2) && m74877c(i4, i6)) {
            int i7 = i2 * i3;
            int i8 = i6 * i4;
            int i9 = (i8 * 2) + i7;
            if (m74877c(i8, 2) && i9 >= i7) {
    ...
    public void release() {
        this.f32705c.releaseOutputBuffer(this);
    }
}
