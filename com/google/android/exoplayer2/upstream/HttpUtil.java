...
public final class HttpUtil {
    ...
    /* renamed from: a */
    private static final Pattern f35852a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b */
    private static final Pattern f35853b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");
    ...
    */
    public static long getContentLength(@androidx.annotation.Nullable java.lang.String r9, @androidx.annotation.Nullable java.lang.String r10) {
        ...
        Lf:
            ...
            com.google.android.exoplayer2.util.Log.m72606e(r2, r0)
        L26:
            r3 = -1
        L28:
            boolean r0 = android.text.TextUtils.isEmpty(r10)
            if (r0 != 0) goto La4
            java.util.regex.Pattern r0 = com.google.android.exoplayer2.upstream.HttpUtil.f35852a
        ...
        L64:
            ...
            com.google.android.exoplayer2.util.Log.m72602w(r2, r9)     // Catch: java.lang.NumberFormatException -> L8d
        ...
        L8d:
            ...
            com.google.android.exoplayer2.util.Log.m72606e(r2, r9)
        La4:
            return r3
        */
    ...
    public static long getDocumentSize(@Nullable String str) {
        ...
        Matcher matcher = f35853b.matcher(str);
        if (!matcher.matches()) {
            return -1L;
        }
