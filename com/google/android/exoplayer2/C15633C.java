...
public final class C15633C {
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: com.google.android.exoplayer2.C$CryptoType */
    /* loaded from: classes4.dex */
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: com.google.android.exoplayer2.C$SelectionReason */
    /* loaded from: classes4.dex */
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: com.google.android.exoplayer2.C$SpatializationBehavior */
    /* loaded from: classes4.dex */
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: com.google.android.exoplayer2.C$TrackType */
    /* loaded from: classes4.dex */
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    /* renamed from: com.google.android.exoplayer2.C$VideoChangeFrameRateStrategy */
    /* loaded from: classes4.dex */
    ...
    @InlineMe(imports = {"com.google.android.exoplayer2.util.Util"}, replacement = "Util.generateAudioSessionIdV21(context)")
    @RequiresApi(21)
    @Deprecated
    ...
    @InlineMe(imports = {"com.google.android.exoplayer2.util.Util"}, replacement = "Util.getErrorCodeForMediaDrmErrorCode(mediaDrmErrorCode)")
    @Deprecated
    public static int getErrorCodeForMediaDrmErrorCode(int i) {
        return Util.getErrorCodeForMediaDrmErrorCode(i);
    }

    @InlineMe(imports = {"com.google.android.exoplayer2.util.Util"}, replacement = "Util.getFormatSupportString(formatSupport)")
    @Deprecated
    public static String getFormatSupportString(int i) {
        return Util.getFormatSupportString(i);
    }

    @InlineMe(imports = {"com.google.android.exoplayer2.util.Util"}, replacement = "Util.msToUs(timeMs)")
    @Deprecated
    public static long msToUs(long j) {
        return Util.msToUs(j);
    }

    @InlineMe(imports = {"com.google.android.exoplayer2.util.Util"}, replacement = "Util.usToMs(timeUs)")
    @Deprecated
