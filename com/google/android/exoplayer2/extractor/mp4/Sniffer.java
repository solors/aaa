...
final class Sniffer {
    ...
    /* renamed from: a */
    private static final int[] f33262a = {1769172845, 1769172786, 1769172787, 1769172788, 1769172789, 1769172790, 1769172793, 1635148593, 1752589105, 1751479857, 1635135537, 1836069937, 1836069938, 862401121, 862401122, 862417462, 862417718, 862414134, 862414646, 1295275552, 1295270176, 1714714144, 1801741417, 1295275600, 1903435808, 1297305174, 1684175153, 1769172332, 1885955686};

    private Sniffer() {
    }

    /* renamed from: a */
    private static boolean m74434a(int i, boolean z) {
        if ((i >>> 8) == 3368816) {
            return true;
        }
        if (i == 1751476579 && z) {
    ...
    /* renamed from: b */
    private static boolean m74433b(ExtractorInput extractorInput, boolean z, boolean z2) throws IOException {
        boolean z3;
        boolean z4;
        boolean z5;
        int i;
            ...
            if (readInt == 1836019574) {
                ...
                if (readInt == 1718909296) {
                    ...
                    while (true) {
                        ...
                        } else if (m74434a(parsableByteArray.readInt(), z2)) {
                            z7 = true;
                            break;
                        }
                        i8++;
