...
public final class FlacFrameReader {
    ...
    /* renamed from: a */
    private static boolean m74721a(ParsableByteArray parsableByteArray, FlacStreamMetadata flacStreamMetadata, int i) {
    ...
    /* renamed from: b */
    private static boolean m74720b(ParsableByteArray parsableByteArray, int i) {
    ...
    /* renamed from: c */
    private static boolean m74719c(ParsableByteArray parsableByteArray, FlacStreamMetadata flacStreamMetadata, boolean z, SampleNumberHolder sampleNumberHolder) {
        try {
    ...
    public static boolean checkAndReadFrameHeader(ParsableByteArray parsableByteArray, FlacStreamMetadata flacStreamMetadata, int i, SampleNumberHolder sampleNumberHolder) {
        ...
        if (!m74716f(i4, flacStreamMetadata) || !m74717e(i5, flacStreamMetadata) || z2 || !m74719c(parsableByteArray, flacStreamMetadata, z, sampleNumberHolder) || !m74721a(parsableByteArray, flacStreamMetadata, i2) || !m74718d(parsableByteArray, flacStreamMetadata, i3) || !m74720b(parsableByteArray, position)) {
            return false;
        }
        return true;
    }
    ...
    /* renamed from: d */
    private static boolean m74718d(ParsableByteArray parsableByteArray, FlacStreamMetadata flacStreamMetadata, int i) {
    ...
    /* renamed from: e */
    private static boolean m74717e(int i, FlacStreamMetadata flacStreamMetadata) {
    ...
    /* renamed from: f */
    private static boolean m74716f(int i, FlacStreamMetadata flacStreamMetadata) {
        if (i <= 7) {
    ...
    public static long getFirstSampleNumber(ExtractorInput extractorInput, FlacStreamMetadata flacStreamMetadata) throws IOException {
        ...
        if (m74719c(parsableByteArray, flacStreamMetadata, z, sampleNumberHolder)) {
