...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    /* renamed from: a */
    public static SpliceInsertCommand m74053a(ParsableByteArray parsableByteArray, long j, TimestampAdjuster timestampAdjuster) {
        boolean z;
        List list;
        boolean z2;
        boolean z3;
        ...
        if (!z) {
            ...
            if (z7 && !z9) {
                j4 = TimeSignalCommand.m74040c(parsableByteArray, j);
            } else {
            ...
            if (!z7) {
                ...
                for (int i4 = 0; i4 < readUnsignedByte2; i4++) {
                    ...
                    if (!z9) {
                        j6 = TimeSignalCommand.m74040c(parsableByteArray, j);
                    } else {
