...
public final class NalUnitUtil {
    ...
    /* renamed from: a */
    private static final Object f36120a = new Object();

    /* renamed from: b */
    private static int[] f36121b = new int[10];
    ...
    /* renamed from: a */
    private static int m72586a(byte[] bArr, int i, int i2) {
        while (i < i2 - 2) {
    ...
    /* renamed from: b */
    private static void m72585b(ParsableNalUnitBitArray parsableNalUnitBitArray) {
        for (int i = 0; i < 4; i++) {
            int i2 = 0;
            while (i2 < 6) {
                int i3 = 1;
    ...
    /* renamed from: c */
    private static void m72584c(ParsableNalUnitBitArray parsableNalUnitBitArray, int i) {
        int i2 = 8;
        int i3 = 8;
    ...
    /* renamed from: d */
    private static void m72583d(ParsableNalUnitBitArray parsableNalUnitBitArray) {
        byte b;
    ...
    */
    ...
    public static SpsData parseSpsNalUnitPayload(byte[] bArr, int i, int i2) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                for (int i10 = 0; i10 < i3; i10++) {
                    if (parsableNalUnitBitArray.readBit()) {
                        ...
                        m72584c(parsableNalUnitBitArray, i4);
                    }
                }
            }
        }
        ...
        int i13 = readUnsignedExpGolombCodedInt8 * 16;
        if (parsableNalUnitBitArray.readBit()) {
            ...
            if (i5 == 0) {
                ...
                int i15 = (2 - (readBit2 ? 1 : 0)) * i9;
                i9 = i7;
                i8 = i15;
            }
            i12 -= (readUnsignedExpGolombCodedInt9 + readUnsignedExpGolombCodedInt10) * i9;
            i13 -= (readUnsignedExpGolombCodedInt11 + readUnsignedExpGolombCodedInt12) * i8;
        }
        int i16 = i12;
        int i17 = i13;
        float f2 = 1.0f;
        if (parsableNalUnitBitArray.readBit() && parsableNalUnitBitArray.readBit()) {
            ...
            if (readBits4 == 255) {
                ...
                if (readBits4 < fArr.length) {
                    f = fArr[readBits4];
                    return new SpsData(readBits, readBits2, readBits3, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt6, i16, i17, f, z2, readBit2, readUnsignedExpGolombCodedInt3, readUnsignedExpGolombCodedInt4, i6, z3);
                }
                Log.m72602w("NalUnitUtil", "Unexpected aspect_ratio_idc value: " + readBits4);
            }
        }
        f = f2;
        return new SpsData(readBits, readBits2, readBits3, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt6, i16, i17, f, z2, readBit2, readUnsignedExpGolombCodedInt3, readUnsignedExpGolombCodedInt4, i6, z3);
    ...
    public static int unescapeStream(byte[] bArr, int i) {
        int i2;
        synchronized (f36120a) {
            int i3 = 0;
            int i4 = 0;
            while (i3 < i) {
                try {
                    i3 = m72586a(bArr, i3, i);
                    if (i3 < i) {
                        int[] iArr = f36121b;
                        if (iArr.length <= i4) {
                            f36121b = Arrays.copyOf(iArr, iArr.length * 2);
                        }
                        f36121b[i4] = i3;
                        i3 += 3;
                        i4++;
