...
public final class MimeTypes {
    ...
    /* renamed from: a */
    private static final ArrayList<CustomMimeType> f36118a = new ArrayList<>();

    /* renamed from: b */
    private static final Pattern f36119b = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");
    ...
    @Nullable
    /* renamed from: a */
    private static String m72590a(String str) {
        int size = f36118a.size();
        for (int i = 0; i < size; i++) {
            CustomMimeType customMimeType = f36118a.get(i);
    ...
    public static boolean allSamplesAreSyncSamples(@Nullable String str, @Nullable String str2) {
        ...
        switch (c) {
            ...
            case '\n':
                return true;
            case 3:
                if (str2 == null || (m72589b = m72589b(str2)) == null || (encoding = m72589b.getEncoding()) == 0 || encoding == 16) {
                    return false;
                }
                return true;
            default:
    ...
    @VisibleForTesting
    /* renamed from: b */
    static Mp4aObjectType m72589b(String str) {
        int i;
        Matcher matcher = f36119b.matcher(str);
        if (!matcher.matches()) {
            return null;
        }
    ...
    @Nullable
    /* renamed from: c */
    private static String m72588c(@Nullable String str) {
        int indexOf;
    ...
    /* renamed from: d */
    private static int m72587d(String str) {
        int size = f36118a.size();
        for (int i = 0; i < size; i++) {
            CustomMimeType customMimeType = f36118a.get(i);
    ...
    public static int getEncoding(String str, @Nullable String str2) {
        ...
        switch (c) {
            ...
            case 1:
                return 7;
            case 2:
                if (str2 == null || (m72589b = m72589b(str2)) == null) {
                    return 0;
                }
                return m72589b.getEncoding();
            case 3:
                return 5;
            case 4:
                return 17;
                    ...
                    if (!lowerCase.startsWith("vp9") && !lowerCase.startsWith("vp09")) {
                        if (!lowerCase.startsWith("vp8") && !lowerCase.startsWith("vp08")) {
                            if (lowerCase.startsWith("mp4a")) {
                                if (lowerCase.startsWith("mp4a.") && (m72589b = m72589b(lowerCase)) != null) {
                                    str2 = getMimeTypeFromMp4ObjectType(m72589b.objectTypeIndication);
                                }
                                if (str2 == null) {
    ...
    public static boolean isAudio(@Nullable String str) {
        return "audio".equals(m72588c(str));
    }

    public static boolean isImage(@Nullable String str) {
        return "image".equals(m72588c(str));
    }
    ...
    public static boolean isText(@Nullable String str) {
        if (!"text".equals(m72588c(str)) && !"application/cea-608".equals(str) && !"application/cea-708".equals(str) && !"application/x-mp4-cea-608".equals(str) && !"application/x-subrip".equals(str) && !"application/ttml+xml".equals(str) && !"application/x-quicktime-tx3g".equals(str) && !"application/x-mp4-vtt".equals(str) && !"application/x-rawcc".equals(str) && !"application/vobsub".equals(str) && !"application/pgs".equals(str) && !"application/dvbsubs".equals(str)) {
            return false;
        }
        return true;
    }
    ...
    public static boolean isVideo(@Nullable String str) {
        return "video".equals(m72588c(str));
    }
    ...
    public static void registerCustomMimeType(String str, String str2, int i) {
        ...
        while (true) {
            ...
            ArrayList<CustomMimeType> arrayList = f36118a;
