...
public final class DtsUtil {
    ...
    /* renamed from: a */
    private static final int[] f32537a = {1, 2, 2, 2, 2, 3, 3, 4, 4, 5, 6, 6, 6, 7, 8, 8};

    /* renamed from: b */
    private static final int[] f32538b = {-1, 8000, 16000, 32000, -1, -1, 11025, 22050, 44100, -1, -1, 12000, 24000, 48000, -1, -1};

    /* renamed from: c */
    private static final int[] f32539c = {64, 112, 128, 192, 224, 256, 384, 448, 512, 640, 768, 896, 1024, 1152, 1280, 1536, 1920, 2048, IronSourceConstants.IS_AD_UNIT_CAPPED, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};

    private DtsUtil() {
    }

    /* renamed from: a */
    private static ParsableBitArray m74956a(byte[] bArr) {
    ...
    /* renamed from: b */
    private static boolean m74955b(byte[] bArr) {
        byte b = bArr[0];
        if (b != -2 && b != -1) {
            return false;
        }
    ...
    */
    ...
    public static Format parseDtsFormat(byte[] bArr, @Nullable String str, @Nullable String str2, @Nullable DrmInitData drmInitData) {
        int i;
        int i2;
        ParsableBitArray m74956a = m74956a(bArr);
        m74956a.skipBits(60);
        int i3 = f32537a[m74956a.readBits(6)];
        int i4 = f32538b[m74956a.readBits(4)];
        int readBits = m74956a.readBits(5);
        int[] iArr = f32539c;
        ...
        m74956a.skipBits(10);
        if (m74956a.readBits(2) > 0) {
            i2 = 1;
        } else {
            i2 = 0;
        }
        return new Format.Builder().setId(str).setSampleMimeType("audio/vnd.dts").setAverageBitrate(i).setChannelCount(i3 + i2).setSampleRate(i4).setDrmInitData(drmInitData).setLanguage(str2).build();
    }
