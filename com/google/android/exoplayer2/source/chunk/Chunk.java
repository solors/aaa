...
public abstract class Chunk implements Loader.Loadable {
    ...
    /* renamed from: a */
    protected final StatsDataSource f34590a;
    ...
    public Chunk(DataSource dataSource, DataSpec dataSpec, int i, Format format, int i2, @Nullable Object obj, long j, long j2) {
        this.f34590a = new StatsDataSource(dataSource);
    ...
    public final long bytesLoaded() {
        return this.f34590a.getBytesRead();
    }
    ...
    public final Map<String, List<String>> getResponseHeaders() {
        return this.f34590a.getLastResponseHeaders();
    }

    public final Uri getUri() {
        return this.f34590a.getLastOpenedUri();
    }
}
