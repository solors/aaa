...
public final class TtmlNode {
    ...
    /* renamed from: b */
    private final HashMap<String, Integer> f34948b;

    /* renamed from: c */
    private final HashMap<String, Integer> f34949c;

    /* renamed from: d */
    private List<TtmlNode> f34950d;
    ...
    /* renamed from: a */
    private void m73418a(Map<String, TtmlStyle> map, Cue.Builder builder, int i, int i2, int i3) {
        TtmlStyle resolveStyle = TtmlRenderUtil.resolveStyle(this.style, this.f34947a, map);
    ...
    /* renamed from: b */
    private static void m73417b(SpannableStringBuilder spannableStringBuilder) {
    ...
    public static TtmlNode buildTextNode(String str) {
        return new TtmlNode(null, TtmlRenderUtil.m73411a(str), -9223372036854775807L, -9223372036854775807L, null, null, "", null, null);
    }

    /* renamed from: c */
    private void m73416c(TreeSet<Long> treeSet, boolean z) {
        boolean z2;
        ...
        for (int i = 0; i < this.f34950d.size(); i++) {
            TtmlNode ttmlNode = this.f34950d.get(i);
            if (!z && !equals) {
                z2 = false;
            } else {
                z2 = true;
            }
            ttmlNode.m73416c(treeSet, z2);
        }
    }

    /* renamed from: d */
    private static SpannableStringBuilder m73415d(String str, Map<String, Cue.Builder> map) {
    ...
    /* renamed from: e */
    private void m73414e(long j, String str, List<Pair<String, String>> list) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            getChild(i).m73414e(j, str, list);
        }
    }

    /* renamed from: f */
    private void m73413f(long j, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2, String str, Map<String, Cue.Builder> map3) {
        String str2;
        int i;
        if (!isActive(j)) {
            return;
        ...
        while (true) {
            ...
            if (this.f34948b.containsKey(key)) {
                i = this.f34948b.get(key).intValue();
            }
            int i2 = i;
            int intValue = next.getValue().intValue();
            if (i2 != intValue) {
                m73418a(map, (Cue.Builder) Assertions.checkNotNull(map3.get(key)), i2, intValue, ((TtmlRegion) Assertions.checkNotNull(map2.get(str2))).verticalType);
            }
        }
        while (i < getChildCount()) {
            getChild(i).m73413f(j, map, map2, str2, map3);
            i++;
        }
    }

    /* renamed from: g */
    private void m73412g(long j, boolean z, String str, Map<String, Cue.Builder> map) {
        boolean z2;
        this.f34948b.clear();
        this.f34949c.clear();
        ...
        if (this.isTextNode && z) {
            m73415d(str, map).append((CharSequence) Assertions.checkNotNull(this.text));
        } else if ("br".equals(this.tag) && z) {
            m73415d(str, map).append('\n');
        } else if (isActive(j)) {
            for (Map.Entry<String, Cue.Builder> entry : map.entrySet()) {
                this.f34948b.put(entry.getKey(), Integer.valueOf(((CharSequence) Assertions.checkNotNull(entry.getValue().getText())).length()));
            }
            boolean equals = "p".equals(this.tag);
            for (int i = 0; i < getChildCount(); i++) {
                ...
                child.m73412g(j, z2, str, map);
            }
            if (equals) {
                TtmlRenderUtil.m73410b(m73415d(str, map));
            }
            for (Map.Entry<String, Cue.Builder> entry2 : map.entrySet()) {
                this.f34949c.put(entry2.getKey(), Integer.valueOf(((CharSequence) Assertions.checkNotNull(entry2.getValue().getText())).length()));
            }
        }
    }
    ...
    public void addChild(TtmlNode ttmlNode) {
        ...
        this.f34950d.add(ttmlNode);
    }

    public TtmlNode getChild(int i) {
        List<TtmlNode> list = this.f34950d;
        if (list != null) {
            return list.get(i);
        }
    ...
    public List<Cue> getCues(long j, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2, Map<String, String> map3) {
        ...
        m73414e(j, this.regionId, arrayList);
        TreeMap treeMap = new TreeMap();
        m73412g(j, false, this.regionId, treeMap);
        m73413f(j, map, map2, this.regionId, treeMap);
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            m73417b((SpannableStringBuilder) Assertions.checkNotNull(builder.getText()));
    ...
    public boolean isActive(long j) {
        ...
        if ((j2 == -9223372036854775807L && this.endTimeUs == -9223372036854775807L) || ((j2 <= j && this.endTimeUs == -9223372036854775807L) || ((j2 == -9223372036854775807L && j < this.endTimeUs) || (j2 <= j && j < this.endTimeUs)))) {
            return true;
        }
        return false;
    }
