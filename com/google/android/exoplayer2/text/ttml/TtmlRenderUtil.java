...
public final class TtmlRenderUtil {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a */
    public static String m73411a(String str) {
    ...
    public static void applyStylesToSpan(Spannable spannable, int i, int i2, TtmlStyle ttmlStyle, @Nullable TtmlNode ttmlNode, Map<String, TtmlStyle> map, int i3) {
        ...
        if (rubyType != 2) {
            ...
            TtmlNode m73409c = m73409c(ttmlNode, map);
            if (m73409c != null && (m73408d = m73408d(m73409c, map)) != null) {
                if (m73408d.getChildCount() == 1 && m73408d.getChild(0).text != null) {
                    String str = (String) Util.castNonNull(m73408d.getChild(0).text);
                    TtmlStyle resolveStyle2 = resolveStyle(m73408d.style, m73408d.getStyleIds(), map);
                    if (resolveStyle2 != null) {
                        i4 = resolveStyle2.getRubyPosition();
                    } else {
                        i4 = -1;
                    }
                    if (i4 == -1 && (resolveStyle = resolveStyle(m73409c.style, m73409c.getStyleIds(), map)) != null) {
                        i4 = resolveStyle.getRubyPosition();
                    }
                    spannable.setSpan(new RubySpan(str, i4), i, i2, 33);
                } else {
                    Log.m72604i("TtmlRenderUtil", "Skipping rubyText node without exactly one text child.");
                }
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: b */
    public static void m73410b(SpannableStringBuilder spannableStringBuilder) {
    ...
    @Nullable
    /* renamed from: c */
    private static TtmlNode m73409c(@Nullable TtmlNode ttmlNode, Map<String, TtmlStyle> map) {
        while (ttmlNode != null) {
    ...
    @Nullable
    /* renamed from: d */
    private static TtmlNode m73408d(TtmlNode ttmlNode, Map<String, TtmlStyle> map) {
