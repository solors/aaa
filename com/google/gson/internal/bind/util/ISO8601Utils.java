...
public class ISO8601Utils {
    ...
    /* renamed from: a */
    private static final TimeZone f44100a = TimeZone.getTimeZone("UTC");

    /* renamed from: a */
    private static boolean m66165a(String str, int i, char c) {
    ...
    /* renamed from: b */
    private static int m66164b(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: c */
    private static void m66163c(StringBuilder sb2, int i, int i2) {
    ...
    /* renamed from: d */
    private static int m66162d(String str, int i, int i2) throws NumberFormatException {
        int i3;
        int i4;
    ...
    public static String format(Date date) {
        return format(date, false, f44100a);
    }
    ...
    */
    ...
    public static String format(Date date, boolean z, TimeZone timeZone) {
        ...
        m66163c(sb2, gregorianCalendar.get(1), 4);
        sb2.append('-');
        m66163c(sb2, gregorianCalendar.get(2) + 1, 2);
        sb2.append('-');
        m66163c(sb2, gregorianCalendar.get(5), 2);
        sb2.append('T');
        m66163c(sb2, gregorianCalendar.get(11), 2);
        sb2.append(':');
        m66163c(sb2, gregorianCalendar.get(12), 2);
        sb2.append(':');
        m66163c(sb2, gregorianCalendar.get(13), 2);
        if (z) {
            sb2.append('.');
            m66163c(sb2, gregorianCalendar.get(14), 3);
        }
