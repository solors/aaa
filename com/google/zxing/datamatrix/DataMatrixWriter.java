...
public final class DataMatrixWriter implements Writer {
    /* renamed from: a */
    private static BitMatrix m65987a(ByteMatrix byteMatrix, int i, int i2) {
        BitMatrix bitMatrix;
    ...
    /* renamed from: b */
    private static BitMatrix m65986b(DefaultPlacement defaultPlacement, SymbolInfo symbolInfo, int i, int i2) {
        boolean z;
        boolean z2;
        ...
        return m65987a(byteMatrix, i, i2);
    }
        ...
        if (!str.isEmpty()) {
            if (barcodeFormat == BarcodeFormat.DATA_MATRIX) {
                if (i >= 0 && i2 >= 0) {
                    ...
                    return m65986b(defaultPlacement, lookup, i, i2);
                }
