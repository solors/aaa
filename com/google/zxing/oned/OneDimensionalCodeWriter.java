...
public abstract class OneDimensionalCodeWriter implements Writer {
    ...
    /* renamed from: a */
    public static int m65852a(boolean[] zArr, int i, int[] iArr, boolean z) {
        int i2 = 0;
        for (int i3 : iArr) {
            int i4 = 0;
            while (i4 < i3) {
    ...
    /* renamed from: b */
    private static BitMatrix m65851b(boolean[] zArr, int i, int i2, int i3) {
    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) throws WriterException {
        ...
        if (i >= 0 && i2 >= 0) {
            ...
            return m65851b(encode(str), i, i2, defaultMargin);
        }
