...
public final class Version {
    ...
    /* renamed from: e */
    private static final int[] f44705e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: f */
    private static final Version[] f44706f = m65544b();
    ...
    /* renamed from: c */
    private final ECBlocks[] f44709c;
    ...
    public static final class ECBlocks {
        ...
        public int getTotalECCodewords() {
            return this.f44713a * getNumBlocks();
        }
    }
    ...
    /* renamed from: b */
    private static Version[] m65544b() {
    ...
    /* renamed from: c */
    public static Version m65543c(int i) {
        ...
        while (true) {
            ...
            if (i3 < iArr.length) {
                ...
                int m65546e = FormatInformation.m65546e(i, i5);
                if (m65546e < i2) {
                    i4 = i3 + 7;
                    i2 = m65546e;
                }
    ...
    public BitMatrix m65545a() {
        ...
        int length = this.f44708b.length;
        for (int i2 = 0; i2 < length; i2++) {
            int i3 = this.f44708b[i2] - 2;
            for (int i4 = 0; i4 < length; i4++) {
                if ((i2 != 0 || (i4 != 0 && i4 != length - 1)) && (i2 != length - 1 || i4 != 0)) {
                    bitMatrix.setRegion(this.f44708b[i4] - 2, i3, 5, 5);
                }
            }
        }
    ...
    public String toString() {
        return String.valueOf(this.f44707a);
    }
}
