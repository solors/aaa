...
public class Personalization {
    ...
    /* renamed from: a */
    private final Provider<AnalyticsConnector> f43562a;

    /* renamed from: b */
    private final Map<String, String> f43563b = Collections.synchronizedMap(new HashMap());
    ...
    public void logArmActive(@NonNull String str, @NonNull ConfigContainer configContainer) {
        ...
        AnalyticsConnector analyticsConnector = this.f43562a.get();
        ...
        synchronized (this.f43563b) {
            if (optString.equals(this.f43563b.get(str))) {
                return;
            }
            this.f43563b.put(str, optString);
