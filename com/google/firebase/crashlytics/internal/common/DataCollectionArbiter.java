...
public class DataCollectionArbiter {
    ...
    private void logDataCollectionState(boolean z) {
        ...
        Logger.getLogger().m67216d(String.format("Crashlytics automatic data collection %s by %s.", str, str2));
    }
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            Logger.getLogger().m67213e("Could not read data collection permission from manifest", e);
            return null;
        }
    }
