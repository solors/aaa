...
public class CrashlyticsCore {
        ...
        try {
            this.didCrashOnPreviousExecution = Boolean.TRUE.equals((Boolean) Utils.awaitEvenIfOnMainThread(this.backgroundWorker.submit(new Callable<Boolean>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore.4
                ...
                public Boolean call() throws Exception {
                    return Boolean.valueOf(CrashlyticsCore.this.controller.m67125u());
                }
            })));
    ...
    public Task<Void> doBackgroundInitialization(SettingsProvider settingsProvider) {
        ...
        try {
            ...
            this.controller.m67156V();
            if (!settingsProvider.getSettingsSync().featureFlagData.collectReports) {
                Logger.getLogger().m67216d("Collection of crash reports disabled in Crashlytics settings.");
                return Tasks.forException(new RuntimeException("Collection of crash reports disabled in Crashlytics settings."));
            }
            if (!this.controller.m67176B(settingsProvider)) {
                Logger.getLogger().m67208w("Previous sessions could not be finalized.");
            }
            return this.controller.m67148b0(settingsProvider.getSettingsAsync());
        } catch (Exception e) {
            Logger.getLogger().m67213e("Crashlytics encountered a problem during asynchronous initialization.", e);
    ...
    private void finishInitSynchronously(final SettingsProvider settingsProvider) {
        ...
        Logger.getLogger().m67216d("Crashlytics detected incomplete initialization on previous app launch. Will initialize synchronously.");
        try {
            submit.get(3L, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
            Logger.getLogger().m67213e("Crashlytics was interrupted during initialization.", e);
        } catch (ExecutionException e2) {
            Logger.getLogger().m67213e("Crashlytics encountered a problem during initialization.", e2);
        } catch (TimeoutException e3) {
            Logger.getLogger().m67213e("Crashlytics timed out during initialization.", e3);
        }
    }
    ...
    static boolean isBuildIdValid(String str, boolean z) {
        if (!z) {
            Logger.getLogger().m67210v("Configured not to require a build ID.");
            return true;
    ...
    public Task<Boolean> checkForUnsentReports() {
        return this.controller.m67131o();
    }

    public Task<Void> deleteUnsentReports() {
        return this.controller.m67126t();
    }
    ...
    public void log(String str) {
        this.controller.m67140f0(System.currentTimeMillis() - this.startTime, str);
    }

    public void logException(@NonNull Throwable th) {
        this.controller.m67142e0(Thread.currentThread(), th);
    }

    public void logFatalException(Throwable th) {
        Logger logger = Logger.getLogger();
        logger.m67216d("Recorded on-demand fatal events: " + this.onDemandCounter.getRecordedOnDemandExceptions());
        Logger logger2 = Logger.getLogger();
        logger2.m67216d("Dropped on-demand fatal events: " + this.onDemandCounter.getDroppedOnDemandExceptions());
        this.controller.m67152Z(ON_DEMAND_RECORDED_KEY, Integer.toString(this.onDemandCounter.getRecordedOnDemandExceptions()));
        this.controller.m67152Z(ON_DEMAND_DROPPED_KEY, Integer.toString(this.onDemandCounter.getDroppedOnDemandExceptions()));
        this.controller.m67161Q(Thread.currentThread(), th);
    }
        ...
        this.backgroundWorker.submit(new Callable<Boolean>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore.3
            ...
            public Boolean call() throws Exception {
                try {
                    ...
                    if (!remove) {
                        Logger.getLogger().m67208w("Initialization marker file was not properly removed.");
                    }
                    return Boolean.valueOf(remove);
                } catch (Exception e) {
                    Logger.getLogger().m67213e("Problem encountered deleting Crashlytics initialization marker.", e);
    ...
    void markInitializationStarted() {
        ...
        Logger.getLogger().m67210v("Initialization marker file was created.");
    }
    ...
    public boolean onPreExecute(AppData appData, SettingsProvider settingsProvider) {
        if (isBuildIdValid(appData.buildId, CommonUtils.getBooleanResourceValue(this.context, CRASHLYTICS_REQUIRE_BUILD_ID, true))) {
            ...
            try {
                ...
                this.controller.m67120z(clsuuid, Thread.getDefaultUncaughtExceptionHandler(), settingsProvider);
                if (didPreviousInitializationFail && CommonUtils.canTryConnection(this.context)) {
                    Logger.getLogger().m67216d("Crashlytics did not finish previous background initialization. Initializing synchronously.");
                    finishInitSynchronously(settingsProvider);
                    return false;
                }
                Logger.getLogger().m67216d("Successfully configured exception handler.");
                return true;
            } catch (Exception e) {
                Logger.getLogger().m67213e("Crashlytics was not started due to an exception during initialization", e);
    ...
    public Task<Void> sendUnsentReports() {
        return this.controller.m67155W();
    }
    ...
    public void setCustomKey(String str, String str2) {
        this.controller.m67154X(str, str2);
    }

    public void setCustomKeys(Map<String, String> map) {
        this.controller.m67153Y(map);
    }

    public void setInternalKey(String str, String str2) {
        this.controller.m67152Z(str, str2);
    }

    public void setUserId(String str) {
        this.controller.m67150a0(str);
    }
}
