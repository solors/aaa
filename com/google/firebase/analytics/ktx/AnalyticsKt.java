...
public final class AnalyticsKt {
    ...
    /* renamed from: a */
    private static volatile FirebaseAnalytics f42069a;
    @NotNull

    /* renamed from: b */
    private static final Object f42070b = new Object();
    ...
    public static final FirebaseAnalytics getAnalytics(@NonNull Firebase firebase) {
        ...
        if (f42069a == null) {
            synchronized (f42070b) {
                if (f42069a == null) {
                    f42069a = FirebaseAnalytics.getInstance(FirebaseKt.getApp(Firebase.INSTANCE).getApplicationContext());
                }
            }
        }
        FirebaseAnalytics firebaseAnalytics = f42069a;
