...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    /* renamed from: com.explorestack.protobuf.FieldInfo$1 */
    /* loaded from: classes3.dex */
    static /* synthetic */ class C106651 {
    ...
    public static final class Builder {
        ...
        /* synthetic */ Builder(C106651 c106651) {
            this();
        }
    ...
    public Class<?> getMessageFieldClass() {
        int i = C106651.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i != 1 && i != 2) {
            if (i != 3 && i != 4) {
                return null;
            }
