...
public final class OpenrtbProto {
    ...
    static final GeneratedMessageV3.FieldAccessorTable f24491xb3401854;

    static {
        Descriptors.Descriptor descriptor2 = getDescriptor().getMessageTypes().get(0);
        internal_static_bidmachine_protobuf_openrtb_Openrtb_descriptor = descriptor2;
        f24475x8296282d = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"Ver", "Domainspec", "Domainver", "Request", "Response", "Payload"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        internal_static_bidmachine_protobuf_openrtb_Request_descriptor = descriptor3;
        f24484x197a58d4 = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"Id", "Test", "Tmax", "At", "Cur", "Seat", "Wseat", "Cdata", "Source", "Item", "Package", "Context", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor4 = descriptor3.getNestedTypes().get(0);
        f24482x2fe25b2c = descriptor4;
        f24483x208995aa = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{"Tid", "Ds", "Dsgver", "Digest", "Cert", "Pchain", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor5 = descriptor3.getNestedTypes().get(1);
        f24480x6653af74 = descriptor5;
        f24481x7da621f2 = new GeneratedMessageV3.FieldAccessorTable(descriptor5, new String[]{"Id", "Qty", "Seq", "Flr", "Flrcur", "Exp", "Dt", "Dlvy", "Metric", "Deal", "Private", "Spec", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor6 = descriptor5.getNestedTypes().get(0);
        f24478xdecf8999 = descriptor6;
        f24479xff8c0717 = new GeneratedMessageV3.FieldAccessorTable(descriptor6, new String[]{"Type", "Value", "Vendor", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor7 = descriptor5.getNestedTypes().get(1);
        f24476x3226081d = descriptor7;
        f24477xbecdc19b = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{"Id", "Flr", "Flrcur", "At", "Wseat", "Wadomain", "Ext", "ExtProto"});
        ...
        f24491xb3401854 = new GeneratedMessageV3.FieldAccessorTable(descriptor8, new String[]{"Id", "Bidid", "Nbr", "Cur", "Cdata", "Seatbid", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor9 = descriptor8.getNestedTypes().get(0);
        f24489xcd91b6bd = descriptor9;
        f24490xed70d03b = new GeneratedMessageV3.FieldAccessorTable(descriptor9, new String[]{"Seat", "Package", "Bid", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor10 = descriptor9.getNestedTypes().get(0);
        f24487xabe1f45f = descriptor10;
        f24488x9d824bdd = new GeneratedMessageV3.FieldAccessorTable(descriptor10, new String[]{"Id", "Item", "Price", "Deal", "Cid", "Tactic", "Purl", "Burl", "Lurl", "Exp", "Mid", "Macro", "Media", "Ext", "ExtProto"});
        Descriptors.Descriptor descriptor11 = descriptor10.getNestedTypes().get(0);
        f24485x46766d2 = descriptor11;
        f24486xb5339b50 = new GeneratedMessageV3.FieldAccessorTable(descriptor11, new String[]{"Key", "Value", "Ext", "ExtProto"});
