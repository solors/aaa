...
public class MapEntryLite<K, V> {
    ...
    /* renamed from: com.explorestack.protobuf.MapEntryLite$1 */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C106871 {
    ...
    static <T> T parseField(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, WireFormat.FieldType fieldType, T t) throws IOException {
        int i = C106871.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
