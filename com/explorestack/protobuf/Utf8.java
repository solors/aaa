...
public final class Utf8 {
    ...
    static final class UnsafeProcessor extends Processor {
            ...
            if (length <= i2 && bArr.length - i2 >= i) {
                ...
                while (i4 < length) {
                    ...
                    if (charAt2 < c && j4 < j5) {
                        ...
                        long j10 = j4 + j;
                        UnsafeUtil.putByte(bArr, j4, (byte) ((charAt2 >>> '\f') | DtbConstants.DEFAULT_PLAYER_HEIGHT));
                        long j11 = j10 + j;
                    ...
                    if (charAt2 < c && position < limit) {
                        ...
                        if (charAt2 < 2048 && position <= limit - 2) {
                            ...
                            if ((charAt2 < 55296 || 57343 < charAt2) && position <= limit - 3) {
                                long j4 = position + 1;
                                UnsafeUtil.putByte(position, (byte) ((charAt2 >>> '\f') | DtbConstants.DEFAULT_PLAYER_HEIGHT));
                                long j5 = j4 + 1;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0059, code lost:
            if (com.explorestack.protobuf.UnsafeUtil.getByte(r13, r2) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
            if (com.explorestack.protobuf.UnsafeUtil.getByte(r13, r2) > (-65)) goto L56;
         */
        @Override // com.explorestack.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0063, code lost:
            if (com.explorestack.protobuf.UnsafeUtil.getByte(r2) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x00a8, code lost:
            if (com.explorestack.protobuf.UnsafeUtil.getByte(r2) > (-65)) goto L56;
         */
        @Override // com.explorestack.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
