...
public final class FieldType {
    ...
    /* renamed from: id */
    private final int f24363id;
    private final JavaType javaType;
    private final boolean primitiveScalar;

    /* renamed from: com.explorestack.protobuf.FieldType$1 */
    /* loaded from: classes3.dex */
    static /* synthetic */ class C106681 {
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f24363id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i, int i2, Collection collection, JavaType javaType) {
        ...
        int i4 = C106681.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        boolean z = true;
        if (i4 != 1) {
            if (i4 != 2) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i3 = C106681.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i3 == 2 || i3 == 3) ? false : false;
    }
