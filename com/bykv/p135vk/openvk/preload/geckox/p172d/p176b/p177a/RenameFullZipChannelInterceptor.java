...
public class RenameFullZipChannelInterceptor extends Interceptor<Pair<File, UpdatePackage>, Pair<String, Long>> {
    ...
    public final /* synthetic */ Object mo91295a(Chain<Pair<String, Long>> chain, Pair<File, UpdatePackage> pair) throws Throwable {
        ...
        GeckoLogger.m91263d("gecko-debug-tag", "start active full zip file, channel:", ((UpdatePackage) pair2.second).getChannel());
