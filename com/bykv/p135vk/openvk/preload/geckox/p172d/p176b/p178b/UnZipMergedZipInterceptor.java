...
public class UnZipMergedZipInterceptor extends Interceptor<Pair<Buffer, UpdatePackage>, Pair<File, UpdatePackage>> {
    ...
    public final /* bridge */ /* synthetic */ Object mo91295a(Chain<Pair<File, UpdatePackage>> chain, Pair<Buffer, UpdatePackage> pair) throws Throwable {
        return m91306a(chain, pair);
    }

    /* renamed from: a  reason: avoid collision after fix types in other method */
    private static Object m91306a(Chain<Pair<File, UpdatePackage>> chain, Pair<Buffer, UpdatePackage> pair) throws Throwable {
        GeckoLogger.m91263d("gecko-debug-tag", "start unzip merged zip file, channel:", ((UpdatePackage) pair.second).getChannel());
