...
public class DownloadPatchSingleFileInterceptor extends Interceptor<Pair<Uri, UpdatePackage>, Pair<Buffer, UpdatePackage>> {

    /* renamed from: d */
    private GeckoConfig f14021d;

    /* renamed from: e */
    private File f14022e;
    ...
    public final void mo91298a(Object... objArr) {
        ...
        this.f14021d = (GeckoConfig) objArr[0];
        this.f14022e = (File) objArr[1];
    }
    ...
    public Object mo91295a(Chain<Pair<Buffer, UpdatePackage>> chain, Pair<Uri, UpdatePackage> pair) throws Throwable {
        GeckoLogger.m91263d("gecko-debug-tag", "start download patch single file, channel:", ((UpdatePackage) pair.second).getChannel());
        UpdatePackage updatePackage = (UpdatePackage) pair.second;
        String uri = ((Uri) pair.first).toString();
        long length = updatePackage.getPatch().getLength();
        File file = this.f14022e;
        ...
        try {
            this.f14021d.m91387i().downloadFile(uri, length, new BufferOutputStream(m91356a));
            try {
