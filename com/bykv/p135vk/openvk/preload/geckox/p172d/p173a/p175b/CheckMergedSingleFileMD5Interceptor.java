...
public class CheckMergedSingleFileMD5Interceptor extends Interceptor<Pair<Buffer, UpdatePackage>, Pair<File, UpdatePackage>> {
    ...
    public final /* bridge */ /* synthetic */ Object mo91295a(Chain<Pair<File, UpdatePackage>> chain, Pair<Buffer, UpdatePackage> pair) throws Throwable {
        return m91319a(chain, pair);
    }

    /* renamed from: a  reason: avoid collision after fix types in other method */
    private static Object m91319a(Chain<Pair<File, UpdatePackage>> chain, Pair<Buffer, UpdatePackage> pair) throws Throwable {
        GeckoLogger.m91263d("gecko-debug-tag", "start check merged single file, channel:", ((UpdatePackage) pair.second).getChannel());
