...
@Metadata
/* renamed from: com.yandex.div.core.widget.b */
/* loaded from: classes8.dex */
final class C29780b<T> implements InterfaceC37618e<View, T> {
    ...
    /* renamed from: b */
    private final Function1<T, T> f76008b;

    /* JADX WARN: Multi-variable type inference failed */
    public C29780b(T t, @Nullable Function1<? super T, ? extends T> function1) {
        this.f76007a = t;
    ...
    public void setValue(@NotNull View thisRef, @NotNull KProperty<?> property, T t) {
        ...
        Intrinsics.checkNotNullParameter(thisRef, "thisRef");
        Intrinsics.checkNotNullParameter(property, "property");
        Function1<T, T> function1 = this.f76008b;
        if (function1 != null && (invoke = function1.invoke(t)) != null) {
            t = invoke;
        }
        if (!Intrinsics.m17075f(this.f76007a, t)) {
            this.f76007a = t;
            thisRef.invalidate();
        }
    }
