...
public final class zzbk {
    ...
    static {
        ...
        newBuilder30.setDebugMessage("Play Store version installed does not support alternative billing only.");
        zzD = newBuilder30.build();
        BillingResult.Builder newBuilder31 = BillingResult.newBuilder();
        newBuilder31.setResponseCode(5);
        newBuilder31.setDebugMessage("To use this API you must specify a PurchasesUpdateListener when initializing a BillingClient.");
