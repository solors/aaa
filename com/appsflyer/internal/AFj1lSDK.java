...
public final class AFj1lSDK {
    ...
    public static void AFKeystoreWrapper(int i, int i2, boolean z, int i3, int[] iArr, int[][] iArr2, int[] iArr3) {
        if (!z) {
        ...
        while (i6 < i3) {
            int i7 = i4 ^ iArr[i6];
            int i8 = i5 ^ ((iArr2[2][(i7 >>> 8) & 255] ^ (iArr2[0][i7 >>> 24] + iArr2[1][(i7 >>> 16) & 255])) + iArr2[3][i7 & 255]);
            i6++;
            i5 = i7;
            i4 = i8;
        }
