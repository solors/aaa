...
/* renamed from: com.bytedance.sdk.openadsdk.Ta.bg */
/* loaded from: classes3.dex */
public class C7911bg extends AbstractC7912eo {
    public C7911bg(Context context) {
        this(context, null);
    }
    ...
    protected void mo87429bg(Context context) {
        ...
        c9106iR.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        ...
        layoutParams4.rightMargin = m82537bX;
        layoutParams4.setMarginEnd(m82537bX);
        ...
        LinearLayout.LayoutParams layoutParams7 = new LinearLayout.LayoutParams(-1, ZQc.m82537bX(context, 32.0f));
        layoutParams7.topMargin = m82537bX2;
        this.ldr.setLayoutParams(layoutParams7);
        c9109zx2.addView(this.ldr);
    }

    public C7911bg(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public C7911bg(Context context, AttributeSet attributeSet, int i) {
