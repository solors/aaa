...
import com.bytedance.adsdk.p183IL.p189bg.p190IL.C6791ldr;
import com.bytedance.adsdk.p183IL.p192iR.C6838bg;
import java.util.List;

/* renamed from: com.bytedance.adsdk.IL.bX.bg.eqN */
/* loaded from: classes3.dex */
public class C6761eqN extends AbstractC6764yDt<Integer, Integer> {
    public C6761eqN(List<C6838bg<Integer>> list) {
        super(list);
    }
    ...
    /* renamed from: bg */
    public AbstractC6781bg<Integer, Integer> mo90885bg() {
        return new C6791ldr(this.f14461bg);
    }
