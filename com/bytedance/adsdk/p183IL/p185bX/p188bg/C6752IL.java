...
/* renamed from: com.bytedance.adsdk.IL.bX.bg.IL */
/* loaded from: classes3.dex */
public class C6752IL extends AbstractC6764yDt<Float, Float> {
    public C6752IL(List<C6838bg<Float>> list) {
        super(list);
    }
    ...
    /* renamed from: bg */
    public AbstractC6781bg<Float, Float> mo90885bg() {
        return new C6789eqN(this.f14461bg);
    }
