...
/* renamed from: com.bytedance.adsdk.bg.IL.zx.bg.ldr */
/* loaded from: classes3.dex */
public class C6967ldr {
    /* renamed from: bg */
    private static Object m90405bg(int i, Number number) {
    ...
    /* renamed from: bg */
    private static Object m90404bg(long j, Number number) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
    ...
    /* renamed from: bg */
    private static Object m90406bg(float f, Number number) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
    ...
    /* renamed from: bg */
    private static Object m90407bg(double d, Number number) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
    ...
    /* renamed from: bg */
    public static Object m90403bg(Number number, Number number2) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
                return m90404bg(number.longValue(), number2);
            }
            if (number instanceof Float) {
                return m90406bg(number.floatValue(), number2);
            }
            if (number instanceof Double) {
                return m90407bg(number.doubleValue(), number2);
            }
            throw new UnsupportedOperationException(number.getClass().getName() + "This type of addition operation is not supported");
        }
        return m90405bg(number.intValue(), number2);
    }
}
