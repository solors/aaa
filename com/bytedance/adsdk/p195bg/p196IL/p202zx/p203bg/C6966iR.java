...
/* renamed from: com.bytedance.adsdk.bg.IL.zx.bg.iR */
/* loaded from: classes3.dex */
public class C6966iR {
    /* renamed from: bg */
    private static Object m90410bg(int i, Number number) {
    ...
    /* renamed from: bg */
    private static Object m90409bg(long j, Number number) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
    ...
    /* renamed from: bg */
    private static Object m90411bg(float f, Number number) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
    ...
    /* renamed from: bg */
    private static Object m90412bg(double d, Number number) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
    ...
    /* renamed from: bg */
    public static Object m90408bg(Number number, Number number2) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
                return m90409bg(number.longValue(), number2);
            }
            if (number instanceof Float) {
                return m90411bg(number.floatValue(), number2);
            }
            if (number instanceof Double) {
                return m90412bg(number.doubleValue(), number2);
            }
            throw new UnsupportedOperationException(number.getClass().getName() + "This type of addition operation is not supported");
        }
        return m90410bg(number.intValue(), number2);
    }
}
