...
/* renamed from: com.bytedance.adsdk.bg.IL.zx.bg.zx */
/* loaded from: classes3.dex */
public class C6968zx {
    /* renamed from: bg */
    private static Object m90400bg(int i, Number number) {
    ...
    /* renamed from: bg */
    private static Object m90399bg(long j, Number number) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
    ...
    /* renamed from: bg */
    private static Object m90401bg(float f, Number number) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
    ...
    /* renamed from: bg */
    private static Object m90402bg(double d, Number number) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
    ...
    /* renamed from: bg */
    public static Object m90398bg(Number number, Number number2) {
        if (!(number instanceof Integer) && !(number instanceof Short) && !(number instanceof Byte)) {
            if (number instanceof Long) {
                return m90399bg(number.longValue(), number2);
            }
            if (number instanceof Float) {
                return m90401bg(number.floatValue(), number2);
            }
            if (number instanceof Double) {
                return m90402bg(number.doubleValue(), number2);
            }
            throw new UnsupportedOperationException(number.getClass().getName() + "This type of addition operation is not supported");
        }
        return m90400bg(number.intValue(), number2);
    }
}
