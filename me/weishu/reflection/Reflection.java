...
import p1002ue.BootstrapClass;

/* loaded from: classes8.dex */
public class Reflection {
    /* renamed from: a */
    private static File m15128a(Context context) {
        if (context != null) {
    ...
    /* renamed from: b */
    public static int m15127b(Context context) {
        if (Build.VERSION.SDK_INT < 28 || BootstrapClass.m2857b() || m15126c(context)) {
            return 0;
        }
        return -1;
    }
    ...
    /* renamed from: c */
    private static boolean m15126c(Context context) {
        ...
        File m15128a = m15128a(context);
        if (m15128a == null) {
            return false;
        }
        File file = new File(m15128a, System.currentTimeMillis() + ".dex");
        try {
