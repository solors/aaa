...
/* renamed from: sg.bigo.ads.ad.interstitial.e.f */
/* loaded from: classes10.dex */
public class C43200f extends AbstractC43198d {
    public C43200f(@NonNull C43185a c43185a, @NonNull List<NativeAd> list, @NonNull AbstractC43181b abstractC43181b) {
    ...
    protected final C43184b mo5955a() {
        int m4906a = C43822e.m4906a(this.f113070d, 8);
        float f = m4906a;
        return new C43184b(f, f, 0.0f, 0.0f, new Rect(0, m4906a, 0, 0), this.f113074h, new boolean[]{false, false, false, true}, this.f113073g);
    }
    ...
    protected final List<View> mo5953b(@NonNull C43179a c43179a) {
        ...
        Object tag = c43179a.f112997a.getTag();
        Boolean bool = Boolean.TRUE;
        if (!Objects.equals(tag, bool)) {
            m5962a(c43179a.f112997a);
            c43179a.f112997a.setTag(bool);
        }
        ...
        if (size != 0) {
            if (size == 1) {
                this.f113072f = true;
                View m4954a = C43810a.m4954a(this.f113070d, C42750R.C42754layout.bigo_ad_layout_interstitial_icon_item_cta_des_style2, this.f113067a, false);
                ...
                int i = C42750R.C42754layout.bigo_ad_layout_interstitial_icon_item_cta_style2;
                ...
                this.f113067a.addView(new Space(this.f113070d), new LinearLayout.LayoutParams(C43822e.m4906a(this.f113070d, 31), m4906a));
