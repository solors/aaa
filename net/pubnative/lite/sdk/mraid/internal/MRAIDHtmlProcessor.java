...
public class MRAIDHtmlProcessor {
    public static String processRawHtml(String str) {
        ...
        boolean contains = removeAllScripts(str).contains("<html");
        boolean contains2 = removeAllScripts(str).contains("<head");
        boolean contains3 = removeAllScripts(str).contains("<body");
    ...
    private static String removeAllScripts(String str) {
        ...
        return str.replaceAll("<script[\\s\\S]*?>[\\s\\S]*?<\\/script>", "");
    }
}
