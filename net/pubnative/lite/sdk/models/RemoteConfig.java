...
public enum RemoteConfig {
    ...
    TOPICS_API_ENABLED(HyBidPreferences.Key.TOPICS_API_ENABLED, Boolean.class),
    ATOM_ENABLED(HyBidPreferences.Key.ATOM_ENABLED, Boolean.class),
    ...
    RemoteConfig(String str, Class cls) {
        this.fieldName = str;
        this.type = cls;
    }
}
