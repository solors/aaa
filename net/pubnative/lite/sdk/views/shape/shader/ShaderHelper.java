...
public abstract class ShaderHelper {
    ...
    public void init(Context context, AttributeSet attributeSet, int i) {
        if (attributeSet != null) {
            ...
            this.borderColor = obtainStyledAttributes.getColor(C38563R.styleable.ShaderImageView_siBorderColor, this.borderColor);
            this.borderWidth = obtainStyledAttributes.getDimensionPixelSize(C38563R.styleable.ShaderImageView_siBorderWidth, this.borderWidth);
            this.borderAlpha = obtainStyledAttributes.getFloat(C38563R.styleable.ShaderImageView_siBorderAlpha, this.borderAlpha);
            this.square = obtainStyledAttributes.getBoolean(C38563R.styleable.ShaderImageView_siSquare, this.square);
