...
/* renamed from: io.bidmachine.ads.networks.gam_dynamic.versions.v22_0_0.n */
/* loaded from: classes9.dex */
class C35471n {
    /* JADX INFO: Access modifiers changed from: package-private */
    @NonNull
    /* renamed from: a */
    public static AdManagerAdRequest m20454a(@NonNull Waterfall.Configuration.AdUnit adUnit) {
    ...
    @NonNull
    /* renamed from: a */
    public static BMError m20453a(@NonNull BMError bMError, @NonNull AdError adError) {
    ...
    @WorkerThread
    /* renamed from: a */
    public static InternalAdLoadData m20457a(@Nullable BaseAdView baseAdView) {
        if (baseAdView == null) {
            return null;
        }
        Waterfall.Result.EstimatedPrice m20452a = m20452a(baseAdView, new String[]{"zza", "zzj", "zza", "a", "a", "k", ApsMetricsDataMap.APSMETRICS_FIELD_ADAPTEREVENT});
        ResponseInfo responseInfo = baseAdView.getResponseInfo();
        String responseInfo2 = responseInfo != null ? responseInfo.toString() : null;
        if (m20452a == null && responseInfo2 == null) {
            return null;
        }
        return new InternalAdLoadData(m20452a, responseInfo2);
    }
    ...
    @WorkerThread
    /* renamed from: a */
    public static InternalAdLoadData m20456a(@Nullable InterstitialAd interstitialAd) {
        if (interstitialAd == null) {
            return null;
        }
        return new InternalAdLoadData(m20452a(interstitialAd, new String[]{"zzc", "zza", "a", "a", "k", ApsMetricsDataMap.APSMETRICS_FIELD_ADAPTEREVENT}), interstitialAd.getResponseInfo().toString());
    }
    ...
    @WorkerThread
    /* renamed from: a */
    public static InternalAdLoadData m20455a(@Nullable RewardedAd rewardedAd) {
        if (rewardedAd == null) {
            return null;
        }
        return new InternalAdLoadData(m20452a(rewardedAd, new String[]{"zzb", "zza", "b", "k", ApsMetricsDataMap.APSMETRICS_FIELD_ADAPTEREVENT}), rewardedAd.getResponseInfo().toString());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @NonNull
    /* renamed from: a */
    public static Waterfall.Result.EstimatedPrice m20458a(@NonNull AdValue adValue) {
    ...
    @WorkerThread
    /* renamed from: a */
    static Waterfall.Result.EstimatedPrice m20452a(@NonNull Object obj, @NonNull String[] strArr) {
        try {
