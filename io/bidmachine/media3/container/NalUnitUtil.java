...
public final class NalUnitUtil {
    ...
    public static H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            for (int i21 = 0; i21 < parsableNalUnitBitArray.readUnsignedExpGolombCodedInt(); i21++) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (readBits5 == 255) {
                    ...
                    if (readBits5 < fArr.length) {
                        ...
                        Log.m19945w(TAG, "Unexpected aspect_ratio_idc value: " + readBits5);
                    }
                }
            }
            if (parsableNalUnitBitArray.readBit()) {
    ...
    public static SpsData parseSpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        if (readUnsignedExpGolombCodedInt4 == 0) {
            ...
            if (readUnsignedExpGolombCodedInt4 == 1) {
                ...
                i5 = readUnsignedExpGolombCodedInt;
                for (int i15 = 0; i15 < readUnsignedExpGolombCodedInt5; i15++) {
                    parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
                }
                z3 = readBit;
            } else {
        ...
        parsableNalUnitBitArray.skipBit();
        int i16 = readUnsignedExpGolombCodedInt7 * 16;
        int i17 = readUnsignedExpGolombCodedInt8 * 16;
        if (parsableNalUnitBitArray.readBit()) {
            int readUnsignedExpGolombCodedInt9 = parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
            int readUnsignedExpGolombCodedInt10 = parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
            int readUnsignedExpGolombCodedInt11 = parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
            ...
            if (i5 == 0) {
                ...
                i13 = i12 * (2 - (readBit2 ? 1 : 0));
            }
            i16 -= (readUnsignedExpGolombCodedInt9 + readUnsignedExpGolombCodedInt10) * i11;
            i17 -= (readUnsignedExpGolombCodedInt11 + readUnsignedExpGolombCodedInt12) * i13;
        }
        int i19 = i16;
        float f = 1.0f;
        if (parsableNalUnitBitArray.readBit()) {
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (readBits4 == 255) {
                    ...
                    if (readBits4 < fArr.length) {
                        ...
                        Log.m19945w(TAG, "Unexpected aspect_ratio_idc value: " + readBits4);
                    }
                }
            }
            if (parsableNalUnitBitArray.readBit()) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (parsableNalUnitBitArray.readBit()) {
                    ...
                    int readBits8 = parsableNalUnitBitArray.readBits(8);
                    parsableNalUnitBitArray.skipBits(8);
                    i7 = ColorInfo.isoColorPrimariesToColorSpace(readBits7);
                    i9 = ColorInfo.isoTransferCharacteristicsToColorTransfer(readBits8);
                    i8 = i10;
                    return new SpsData(readBits, readBits2, readBits3, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt6, i19, i17, f, z2, readBit2, readUnsignedExpGolombCodedInt3, readUnsignedExpGolombCodedInt4, i6, z3, i7, i8, i9);
                }
                i8 = i10;
                i7 = -1;
                i9 = -1;
