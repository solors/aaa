...
/* renamed from: io.bidmachine.media3.datasource.cache.d */
...
public final class CachedContent {
    ...
    /* renamed from: id */
    public final int f96787id;
    public final String key;
    private final ArrayList<C35958a> lockedRanges;
    private DefaultContentMetadata metadata;

    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: CachedContent.java */
    /* renamed from: io.bidmachine.media3.datasource.cache.d$a */
    /* loaded from: classes9.dex */
    public static final class C35958a {
        public final long length;
        public final long position;

        public C35958a(long j, long j2) {
            this.position = j;
            this.length = j2;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.f96787id == cachedContent.f96787id && this.key.equals(cachedContent.key) && this.cachedSpans.equals(cachedContent.cachedSpans) && this.metadata.equals(cachedContent.metadata)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((this.f96787id * 31) + this.key.hashCode()) * 31) + this.metadata.hashCode();
    }
    ...
    public boolean lockRange(long j, long j2) {
        ...
        this.lockedRanges.add(new C35958a(j, j2));
        return true;
    }
    ...
    public SimpleCacheSpan setLastTouchTimestamp(SimpleCacheSpan simpleCacheSpan, long j, boolean z) {
        ...
        if (z) {
            File cacheFile = SimpleCacheSpan.getCacheFile((File) Assertions.checkNotNull(file.getParentFile()), this.f96787id, simpleCacheSpan.position, j);
            if (file.renameTo(cacheFile)) {
                file = cacheFile;
            } else {
                Log.m19945w(TAG, "Failed to rename " + file + " to " + cacheFile);
            }
        }
