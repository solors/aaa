...
/* renamed from: io.bidmachine.media3.extractor.mp4.h */
...
final class SefReader {
    ...
    private final List<C36598a> dataReferences = new ArrayList();
    private int readerState = 0;
    private int tailLength;
    private static final Splitter COLON_SPLITTER = Splitter.m70013on(':');
    private static final Splitter ASTERISK_SPLITTER = Splitter.m70013on('*');

    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: SefReader.java */
    /* renamed from: io.bidmachine.media3.extractor.mp4.h$a */
    /* loaded from: classes9.dex */
    public static final class C36598a {
        public final int dataType;
        public final int size;
        public final long startOffset;

        public C36598a(int i, long j, int i2) {
            this.dataType = i;
            this.startOffset = j;
            this.size = i2;
        }
    ...
    private void readSdrs(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        for (int i2 = 0; i2 < i / 12; i2++) {
            ...
            if (readLittleEndianShort != TYPE_SLOW_MOTION_DATA && readLittleEndianShort != TYPE_SUPER_SLOW_MOTION_DATA && readLittleEndianShort != TYPE_SUPER_SLOW_MOTION_BGM && readLittleEndianShort != TYPE_SUPER_SLOW_MOTION_EDIT_DATA && readLittleEndianShort != TYPE_SUPER_SLOW_DEFLICKERING_ON) {
                ...
                this.dataReferences.add(new C36598a(readLittleEndianShort, (length - this.tailLength) - parsableByteArray.readLittleEndianInt(), parsableByteArray.readLittleEndianInt()));
            }
        }
    ...
    private void readSefData(ExtractorInput extractorInput, List<Metadata.Entry> list) throws IOException {
        ...
        for (int i = 0; i < this.dataReferences.size(); i++) {
            C36598a c36598a = this.dataReferences.get(i);
            parsableByteArray.setPosition((int) (c36598a.startOffset - position));
            parsableByteArray.skipBytes(4);
            int readLittleEndianInt = parsableByteArray.readLittleEndianInt();
            int nameToDataType = nameToDataType(parsableByteArray.readString(readLittleEndianInt));
            int i2 = c36598a.size - (readLittleEndianInt + 8);
