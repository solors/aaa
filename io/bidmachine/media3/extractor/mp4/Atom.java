...
/* renamed from: io.bidmachine.media3.extractor.mp4.a */
...
abstract class Atom {
    ...
    /* renamed from: io.bidmachine.media3.extractor.mp4.a$a */
    /* loaded from: classes9.dex */
    static final class C36592a extends Atom {
        public final List<C36592a> containerChildren;
        public final long endPosition;
        public final List<C36593b> leafChildren;

        public C36592a(int i, long j) {
            super(i);
            this.endPosition = j;
        ...
        public void add(C36593b c36593b) {
            this.leafChildren.add(c36593b);
        }
        ...
        @Nullable
        public C36592a getContainerAtomOfType(int i) {
            int size = this.containerChildren.size();
            for (int i2 = 0; i2 < size; i2++) {
                C36592a c36592a = this.containerChildren.get(i2);
                if (c36592a.type == i) {
                    return c36592a;
                }
            }
        ...
        @Nullable
        public C36593b getLeafAtomOfType(int i) {
            int size = this.leafChildren.size();
            for (int i2 = 0; i2 < size; i2++) {
                C36593b c36593b = this.leafChildren.get(i2);
                if (c36593b.type == i) {
                    return c36593b;
                }
            }
        ...
        @Override // io.bidmachine.media3.extractor.mp4.Atom
        ...
        public void add(C36592a c36592a) {
            this.containerChildren.add(c36592a);
        }
    }

    /* compiled from: Atom.java */
    /* renamed from: io.bidmachine.media3.extractor.mp4.a$b */
    /* loaded from: classes9.dex */
    static final class C36593b extends Atom {
        public final ParsableByteArray data;

        public C36593b(int i, ParsableByteArray parsableByteArray) {
            super(i);
