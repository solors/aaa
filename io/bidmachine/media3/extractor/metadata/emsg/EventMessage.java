...
public final class EventMessage implements Metadata.Entry {
    ...
    public static final Parcelable.Creator<EventMessage> CREATOR = new C36544a();

    /* renamed from: io.bidmachine.media3.extractor.metadata.emsg.EventMessage$a */
    /* loaded from: classes9.dex */
    class C36544a implements Parcelable.Creator<EventMessage> {
        C36544a() {
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.durationMs == eventMessage.durationMs && this.f97285id == eventMessage.f97285id && Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) && Util.areEqual(this.value, eventMessage.value) && Arrays.equals(this.messageData, eventMessage.messageData)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f97285id + ", durationMs=" + this.durationMs + ", value=" + this.value;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeLong(this.f97285id);
