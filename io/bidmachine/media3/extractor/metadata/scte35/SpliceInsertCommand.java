...
public final class SpliceInsertCommand extends SpliceCommand {
    public static final Parcelable.Creator<SpliceInsertCommand> CREATOR = new C36568a();
    ...
    public static final class ComponentSplice {
        ...
        /* synthetic */ ComponentSplice(int i, long j, long j2, C36568a c36568a) {
            this(i, j, j2);
        }
    ...
    /* renamed from: io.bidmachine.media3.extractor.metadata.scte35.SpliceInsertCommand$a */
    /* loaded from: classes9.dex */
    class C36568a implements Parcelable.Creator<SpliceInsertCommand> {
        C36568a() {
        }
    ...
    /* synthetic */ SpliceInsertCommand(Parcel parcel, C36568a c36568a) {
        this(parcel);
    }
        ...
        if (!z) {
            ...
            if (!z7) {
                ...
                for (int i4 = 0; i4 < readUnsignedByte2; i4++) {
                    ...
                    arrayList.add(new ComponentSplice(readUnsignedByte3, j6, timestampAdjuster.adjustTsTimestamp(j6), null));
                }
                emptyList = arrayList;
            }
            if (z8) {
