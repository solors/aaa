...
/* renamed from: io.bidmachine.media3.extractor.mkv.a */
...
final class DefaultEbmlReader implements EbmlReader {
    ...
    private final ArrayDeque<C36576b> masterElementsStack = new ArrayDeque<>();
    private final VarintReader varintReader = new VarintReader();

    /* compiled from: DefaultEbmlReader.java */
    /* renamed from: io.bidmachine.media3.extractor.mkv.a$b */
    /* loaded from: classes9.dex */
    private static final class C36576b {
        private final long elementEndPosition;
        private final int elementId;

        private C36576b(int i, long j) {
            this.elementId = i;
    ...
    @Override // io.bidmachine.media3.extractor.mkv.EbmlReader
    ...
    public boolean read(ExtractorInput extractorInput) throws IOException {
        ...
        while (true) {
            C36576b peek = this.masterElementsStack.peek();
            ...
            if (elementType != 0) {
                if (elementType != 1) {
                        ...
                        if (elementType != 3) {
                            if (elementType != 4) {
                                if (elementType == 5) {
                                    ...
                                    this.processor.floatElement(this.elementId, readFloat(extractorInput, (int) j));
                                    this.elementState = 0;
                                    return true;
                                }
                    ...
                    if (j3 <= 8) {
                        this.processor.integerElement(this.elementId, readInteger(extractorInput, (int) j3));
                        this.elementState = 0;
                        return true;
                    }
                ...
                this.masterElementsStack.push(new C36576b(this.elementId, this.elementContentSize + position));
