...
public final class SsaStyle {
    ...
    /* renamed from: io.bidmachine.media3.extractor.text.ssa.SsaStyle$a */
    /* loaded from: classes9.dex */
    static final class C36628a {
        ...
        private C36628a(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11) {
            this.nameIndex = i;
        ...
        @Nullable
        public static C36628a fromFormatLine(String str) {
            char c;
            ...
            if (i != -1) {
                return new C36628a(i, i2, i3, i4, i5, i6, i7, i8, i9, i10, split.length);
            }
            return null;
        }
    }

    /* renamed from: io.bidmachine.media3.extractor.text.ssa.SsaStyle$b */
    /* loaded from: classes9.dex */
    static final class C36629b {
        ...
        private C36629b(int i, @Nullable PointF pointF) {
            this.alignment = i;
        ...
        public static C36629b parseFromDialogue(String str) {
        ...
        private static PointF parsePosition(String str) {
            ...
            if (find) {
                if (find2) {
                    Log.m19947i(TAG, "Override has both \\pos(x,y) and \\move(x1,y1,x2,y2); using \\pos values. override='" + str + "'");
                }
    ...
    @Nullable
    public static SsaStyle fromStyleLine(String str, C36628a c36628a) {
        int i;
        Integer num;
        Integer num2;
        float f;
        ...
        int i3 = c36628a.length;
        if (length != i3) {
            Log.m19945w(TAG, Util.formatInvariant("Skipping malformed 'Style:' line (expected %s values, found %s): '%s'", Integer.valueOf(i3), Integer.valueOf(split.length), str));
            return null;
        }
        try {
            String trim = split[c36628a.nameIndex].trim();
            int i4 = c36628a.alignmentIndex;
            if (i4 != -1) {
                i = parseAlignment(split[i4].trim());
            } else {
                i = -1;
            }
            int i5 = c36628a.primaryColorIndex;
            if (i5 != -1) {
                num = parseColor(split[i5].trim());
            } else {
                num = null;
            }
            int i6 = c36628a.outlineColorIndex;
            if (i6 != -1) {
                num2 = parseColor(split[i6].trim());
            } else {
                num2 = null;
            }
            int i7 = c36628a.fontSizeIndex;
            if (i7 != -1) {
                f = parseFontSize(split[i7].trim());
            } else {
                f = -3.4028235E38f;
            }
            int i8 = c36628a.boldIndex;
            if (i8 != -1 && parseBooleanValue(split[i8].trim())) {
                z = true;
            } else {
                z = false;
            }
            int i9 = c36628a.italicIndex;
            if (i9 != -1 && parseBooleanValue(split[i9].trim())) {
                z2 = true;
            } else {
                z2 = false;
            }
            int i10 = c36628a.underlineIndex;
            if (i10 != -1 && parseBooleanValue(split[i10].trim())) {
                z3 = true;
            } else {
                z3 = false;
            }
            int i11 = c36628a.strikeoutIndex;
            if (i11 != -1 && parseBooleanValue(split[i11].trim())) {
                z4 = true;
            } else {
                z4 = false;
            }
            int i12 = c36628a.borderStyleIndex;
            if (i12 != -1) {
                i2 = parseBorderStyle(split[i12].trim());
            } else {
                i2 = -1;
            }
            return new SsaStyle(trim, i, num, num2, f, z, z2, z3, z4, i2);
        } catch (RuntimeException e) {
            Log.m19944w(TAG, "Skipping malformed 'Style:' line: '" + str + "'", e);
            return null;
        }
    }
    ...
    public static int parseAlignment(String str) {
        ...
        Log.m19945w(TAG, "Ignoring unknown alignment: " + str);
        return -1;
    }
    ...
    private static boolean parseBooleanValue(String str) {
        try {
            ...
            Log.m19944w(TAG, "Failed to parse boolean value: '" + str + "'", e);
            return false;
        }
    }
    ...
    private static int parseBorderStyle(String str) {
        ...
        Log.m19945w(TAG, "Ignoring unknown BorderStyle: " + str);
        return -1;
    }
    ...
    public static Integer parseColor(String str) {
        ...
        try {
            ...
            Log.m19944w(TAG, "Failed to parse color expression: '" + str + "'", e);
            return null;
        }
    }
    ...
    private static float parseFontSize(String str) {
        try {
            ...
            Log.m19944w(TAG, "Failed to parse font size: '" + str + "'", e);
