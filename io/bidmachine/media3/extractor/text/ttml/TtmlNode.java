...
/* renamed from: io.bidmachine.media3.extractor.text.ttml.b */
...
public final class TtmlNode {
    ...
    private void traverseForStyle(long j, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2, String str, Map<String, Cue.Builder> map3) {
        ...
        while (true) {
            ...
            if (i2 != intValue) {
                applyStyleToOutput(map, (Cue.Builder) Assertions.checkNotNull(map3.get(key)), i2, intValue, ((TtmlRegion) Assertions.checkNotNull(map2.get(str2))).verticalType);
            }
        }
