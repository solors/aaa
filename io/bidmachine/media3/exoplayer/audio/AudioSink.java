...
public interface AudioSink {
    ...
    public static final class InitializationException extends Exception {
        ...
        */
        public InitializationException(int r4, int r5, int r6, int r7, io.bidmachine.media3.common.Format r8, boolean r9, @androidx.annotation.Nullable java.lang.Exception r10) {
            /*
                r3 = this;
            ...
            L3a:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.media3.exoplayer.audio.AudioSink.InitializationException.<init>(int, int, int, int, io.bidmachine.media3.common.Format, boolean, java.lang.Exception):void");
        }
    }
