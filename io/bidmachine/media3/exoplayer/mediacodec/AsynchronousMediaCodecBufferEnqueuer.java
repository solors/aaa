...
@RequiresApi(23)
/* renamed from: io.bidmachine.media3.exoplayer.mediacodec.d */
...
public class AsynchronousMediaCodecBufferEnqueuer {
    ...
    private static final ArrayDeque<C36269b> MESSAGE_PARAMS_INSTANCE_POOL = new ArrayDeque<>();
    private static final Object QUEUE_SECURE_LOCK = new Object();

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: AsynchronousMediaCodecBufferEnqueuer.java */
    /* renamed from: io.bidmachine.media3.exoplayer.mediacodec.d$a */
    /* loaded from: classes9.dex */
    public class HandlerC36268a extends Handler {
        HandlerC36268a(Looper looper) {
            super(looper);
        }
    ...
    /* compiled from: AsynchronousMediaCodecBufferEnqueuer.java */
    /* renamed from: io.bidmachine.media3.exoplayer.mediacodec.d$b */
    /* loaded from: classes9.dex */
    public static class C36269b {
    ...
    private static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        cryptoInfo2.iv = (byte[]) Assertions.checkNotNull(copy(cryptoInfo.f96788iv, cryptoInfo2.iv));
    ...
    public void doHandleMessage(Message message) {
        ...
        if (i != 0) {
            if (i != 1) {
                c36269b = null;
                if (i != 2) {
                    C0379a.m105461a(this.pendingRuntimeException, null, new IllegalStateException(String.valueOf(message.what)));
                } else {
                    this.conditionVariable.open();
                }
            } else {
                c36269b = (C36269b) message.obj;
                doQueueSecureInputBuffer(c36269b.index, c36269b.offset, c36269b.cryptoInfo, c36269b.presentationTimeUs, c36269b.flags);
            }
        } else {
            c36269b = (C36269b) message.obj;
            doQueueInputBuffer(c36269b.index, c36269b.offset, c36269b.size, c36269b.presentationTimeUs, c36269b.flags);
        }
        if (c36269b != null) {
            recycleMessageParams(c36269b);
        }
    }
    ...
    private void doQueueInputBuffer(int i, int i2, int i3, long j, int i4) {
        try {
            ...
            C0379a.m105461a(this.pendingRuntimeException, null, e);
        }
    }
    ...
    private static C36269b getMessageParams() {
        ArrayDeque<C36269b> arrayDeque = MESSAGE_PARAMS_INSTANCE_POOL;
    ...
    private static void recycleMessageParams(C36269b c36269b) {
        ArrayDeque<C36269b> arrayDeque = MESSAGE_PARAMS_INSTANCE_POOL;
        synchronized (arrayDeque) {
            arrayDeque.add(c36269b);
        }
    }
    ...
    public void queueInputBuffer(int i, int i2, int i3, long j, int i4) {
        maybeThrowException();
        C36269b messageParams = getMessageParams();
    ...
    public void start() {
        if (!this.started) {
            ...
            this.handler = new HandlerC36268a(this.handlerThread.getLooper());
            this.started = true;
        }
    }
