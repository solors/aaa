...
public final class VideoDecoderGLSurfaceView extends GLSurfaceView implements VideoDecoderOutputBufferRenderer {
    ...
    /* renamed from: b */
    public static final /* synthetic */ int f97229b = 0;
    private final C36491a renderer;

    /* renamed from: io.bidmachine.media3.exoplayer.video.VideoDecoderGLSurfaceView$a */
    /* loaded from: classes9.dex */
    private static final class C36491a implements GLSurfaceView.Renderer {
        ...
        public C36491a(GLSurfaceView gLSurfaceView) {
    ...
    @Override // io.bidmachine.media3.exoplayer.video.VideoDecoderOutputBufferRenderer
    public void setOutputBuffer(VideoDecoderOutputBuffer videoDecoderOutputBuffer) {
    ...
    public VideoDecoderGLSurfaceView(Context context, @Nullable AttributeSet attributeSet) {
        ...
        C36491a c36491a = new C36491a(this);
        this.renderer = c36491a;
