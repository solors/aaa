...
public final class VideoFrameReleaseHelper {
    ...
    @Nullable
    private final Choreographer$FrameCallbackC36495d vsyncSampler;
    ...
    @RequiresApi(30)
    /* renamed from: io.bidmachine.media3.exoplayer.video.VideoFrameReleaseHelper$a */
    /* loaded from: classes9.dex */
    public static final class C36492a {
        private C36492a() {
        }
        ...
        public static void setSurfaceFrameRate(Surface surface, float f) {
            ...
            try {
                ...
                Log.m19948e(VideoFrameReleaseHelper.TAG, "Failed to call Surface.setFrameRate", e);
            }
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: io.bidmachine.media3.exoplayer.video.VideoFrameReleaseHelper$d */
    /* loaded from: classes9.dex */
    public static final class Choreographer$FrameCallbackC36495d implements Choreographer.FrameCallback, Handler.Callback {
        private static final int CREATE_CHOREOGRAPHER = 0;
        private static final Choreographer$FrameCallbackC36495d INSTANCE = new Choreographer$FrameCallbackC36495d();
        ...
        private Choreographer$FrameCallbackC36495d() {
        ...
        private void createChoreographerInstanceInternal() {
            try {
                ...
                Log.m19944w(VideoFrameReleaseHelper.TAG, "Vsync sampling disabled due to platform error", e);
            }
        }

        public static Choreographer$FrameCallbackC36495d getInstance() {
            return INSTANCE;
        }
    ...
    public VideoFrameReleaseHelper(@Nullable Context context) {
        Choreographer$FrameCallbackC36495d choreographer$FrameCallbackC36495d;
        ...
        if (maybeBuildDisplayHelper != null) {
            choreographer$FrameCallbackC36495d = Choreographer$FrameCallbackC36495d.getInstance();
        } else {
            choreographer$FrameCallbackC36495d = null;
        }
        this.vsyncSampler = choreographer$FrameCallbackC36495d;
    ...
    private void clearSurfaceFrameRate() {
        ...
        if (Util.SDK_INT >= 30 && (surface = this.surface) != null && this.changeFrameRateStrategy != Integer.MIN_VALUE && this.surfacePlaybackFrameRate != 0.0f) {
            ...
            C36492a.setSurfaceFrameRate(surface, 0.0f);
        }
    }
    ...
    private static DisplayHelper maybeBuildDisplayHelper(@Nullable Context context) {
        ...
        if (Util.SDK_INT >= 17) {
            displayHelper = C36494c.maybeBuildNewInstance(applicationContext);
        }
        if (displayHelper == null) {
            return C36493b.maybeBuildNewInstance(applicationContext);
        }
    ...
    public void updateDefaultDisplayRefreshRateParams(@Nullable Display display) {
        ...
        Log.m19945w(TAG, "Unable to query display refresh rate");
        this.vsyncDurationNs = -9223372036854775807L;
        this.vsyncOffsetNs = -9223372036854775807L;
    }
    ...
    */
    private void updateSurfaceMediaFrameRate() {
        /*
            ...
            goto L73
        Lc:
            io.bidmachine.media3.exoplayer.video.a r0 = r7.frameRateEstimator
        ...
        L24:
            ...
            if (r2 == 0) goto L61
            io.bidmachine.media3.exoplayer.video.a r1 = r7.frameRateEstimator
        ...
        L61:
            ...
            goto L6c
        L64:
            io.bidmachine.media3.exoplayer.video.a r2 = r7.frameRateEstimator
        ...
        if (Util.SDK_INT >= 30 && (surface = this.surface) != null && this.changeFrameRateStrategy != Integer.MIN_VALUE) {
            if (this.started) {
                ...
                if (f2 != -1.0f) {
                    ...
                    C36492a.setSurfaceFrameRate(surface, f);
                }
            }
            f = 0.0f;
            if (z) {
    ...
    public long adjustReleaseTime(long j) {
        ...
        if (this.lastAdjustedFrameIndex != -1 && this.frameRateEstimator.isSynced()) {
            ...
            if (adjustmentAllowed(j, frameDurationNs)) {
                ...
                choreographer$FrameCallbackC36495d = this.vsyncSampler;
                if (choreographer$FrameCallbackC36495d == null && this.vsyncDurationNs != -9223372036854775807L) {
                    long j3 = choreographer$FrameCallbackC36495d.sampledVsyncTimeNs;
        ...
        this.pendingLastAdjustedReleaseTimeNs = j2;
        choreographer$FrameCallbackC36495d = this.vsyncSampler;
        if (choreographer$FrameCallbackC36495d == null) {
        }
        return j2;
    }
    ...
    public void onStarted() {
        ...
        if (this.displayHelper != null) {
            ((Choreographer$FrameCallbackC36495d) Assertions.checkNotNull(this.vsyncSampler)).addObserver();
            this.displayHelper.register(new DisplayHelper.Listener() { // from class: io.bidmachine.media3.exoplayer.video.b
                {
                    VideoFrameReleaseHelper.this = this;
                }

                @Override // io.bidmachine.media3.exoplayer.video.VideoFrameReleaseHelper.DisplayHelper.Listener
    ...
    public void onStopped() {
        ...
        if (displayHelper != null) {
            ...
            ((Choreographer$FrameCallbackC36495d) Assertions.checkNotNull(this.vsyncSampler)).removeObserver();
        }
    ...
    /* renamed from: io.bidmachine.media3.exoplayer.video.VideoFrameReleaseHelper$b */
    /* loaded from: classes9.dex */
    public static final class C36493b implements DisplayHelper {
        private final WindowManager windowManager;

        private C36493b(WindowManager windowManager) {
        ...
        public static DisplayHelper maybeBuildNewInstance(Context context) {
            ...
            if (windowManager != null) {
                return new C36493b(windowManager);
            }
            return null;
        }

        @Override // io.bidmachine.media3.exoplayer.video.VideoFrameReleaseHelper.DisplayHelper
    ...
    @RequiresApi(17)
    /* renamed from: io.bidmachine.media3.exoplayer.video.VideoFrameReleaseHelper$c */
    /* loaded from: classes9.dex */
    public static final class C36494c implements DisplayHelper, DisplayManager.DisplayListener {
        private final DisplayManager displayManager;
        @Nullable
        private DisplayHelper.Listener listener;

        private C36494c(DisplayManager displayManager) {
        ...
        public static DisplayHelper maybeBuildNewInstance(Context context) {
            ...
            if (displayManager != null) {
                return new C36494c(displayManager);
            }
            return null;
        }
