...
/* renamed from: io.bidmachine.media3.exoplayer.video.spherical.e */
...
public final class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    public void drawFrame(float[] fArr, boolean z) {
        ...
        try {
            ...
            Log.m19948e(TAG, "Failed to draw a frame", e);
        }
        if (this.frameAvailable.compareAndSet(true, false)) {
            ...
            try {
                ...
                Log.m19948e(TAG, "Failed to draw a frame", e2);
            }
    ...
    public SurfaceTexture init() {
        try {
            ...
            Log.m19948e(TAG, "Failed to initialize the renderer", e);
        }
        SurfaceTexture surfaceTexture = new SurfaceTexture(this.textureId);
        this.surfaceTexture = surfaceTexture;
        surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: io.bidmachine.media3.exoplayer.video.spherical.d
            {
