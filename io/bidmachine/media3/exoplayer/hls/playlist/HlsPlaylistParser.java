...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
    ...
    /* renamed from: io.bidmachine.media3.exoplayer.hls.playlist.HlsPlaylistParser$a */
    /* loaded from: classes9.dex */
    public static class C36235a {
        private final Queue<String> extraLines;
        @Nullable
        private String next;
        private final BufferedReader reader;

        public C36235a(Queue<String> queue, BufferedReader bufferedReader) {
    ...
    private static DrmInitData.SchemeData parseDrmSchemeData(String str, String str2, Map<String, String> map) throws ParserException {
        ...
        if (KEYFORMAT_WIDEVINE_PSSH_BINARY.equals(str2)) {
            ...
            return new DrmInitData.SchemeData(C35793C.WIDEVINE_UUID, "video/mp4", Base64.decode(parseStringAttr.substring(parseStringAttr.indexOf(44)), 0));
        } else if (KEYFORMAT_WIDEVINE_PSSH_JSON.equals(str2)) {
            return new DrmInitData.SchemeData(C35793C.WIDEVINE_UUID, "hls", Util.getUtf8Bytes(str));
        } else {
            if (KEYFORMAT_PLAYREADY.equals(str2) && "1".equals(parseOptionalStringAttr)) {
                ...
                UUID uuid = C35793C.PLAYREADY_UUID;
    ...
    private static HlsMediaPlaylist parseMediaPlaylist(HlsMultivariantPlaylist hlsMultivariantPlaylist, @Nullable HlsMediaPlaylist hlsMediaPlaylist, C36235a c36235a, String str) throws IOException {
        ArrayList arrayList;
        ...
        while (c36235a.hasNext()) {
            String next = c36235a.next();
    ...
    private static HlsMultivariantPlaylist parseMultivariantPlaylist(C36235a c36235a, String str) throws IOException {
        char c;
        Format format;
        ArrayList arrayList;
        ArrayList arrayList2;
            ...
            if (c36235a.hasNext()) {
                ...
                if (next.startsWith(TAG_DEFINE)) {
                    ...
                    if (next.equals(TAG_INDEPENDENT_SEGMENTS)) {
                        ...
                        } else if (c36235a.hasNext()) {
                            resolveToUri = UriUtil.resolveToUri(str5, replaceVariableReferences(c36235a.next(), hashMap3));
                        } else {
                    ...
                    switch (c) {
                        case 0:
                            ...
                            if (resolveToUri2 != null) {
                                ...
                                arrayList3 = arrayList23;
                                Log.m19945w(LOG_TAG, "EXT-X-MEDIA tag with missing mandatory URI attribute: skipping");
                                break;
                            }
                        case 1:
                            format = format2;
    ...
    public HlsPlaylist parse(Uri uri, InputStream inputStream) throws IOException {
        ...
        try {
            if (checkPlaylistHeader(bufferedReader)) {
                    ...
                    if (readLine != null) {
                        ...
                        if (!trim.isEmpty()) {
                            if (trim.startsWith(TAG_STREAM_INF)) {
                                arrayDeque.add(trim);
                                return parseMultivariantPlaylist(new C36235a(arrayDeque, bufferedReader), uri.toString());
                ...
                arrayDeque.add(trim);
                return parseMediaPlaylist(this.multivariantPlaylist, this.previousMediaPlaylist, new C36235a(arrayDeque, bufferedReader), uri.toString());
            }
