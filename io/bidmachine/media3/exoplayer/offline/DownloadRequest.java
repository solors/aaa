...
public final class DownloadRequest implements Parcelable {
    public static final Parcelable.Creator<DownloadRequest> CREATOR = new C36296a();
    @Nullable
    public final String customCacheKey;
    public final byte[] data;

    /* renamed from: id */
    public final String f97102id;
    @Nullable
    ...
    public static class Builder {
        ...
        public DownloadRequest build() {
            ...
            return new DownloadRequest(str, uri, str2, list, this.keySetId, this.customCacheKey, this.data, null);
        }
    ...
    /* renamed from: io.bidmachine.media3.exoplayer.offline.DownloadRequest$a */
    /* loaded from: classes9.dex */
    class C36296a implements Parcelable.Creator<DownloadRequest> {
        C36296a() {
        }
    ...
    /* synthetic */ DownloadRequest(String str, Uri uri, String str2, List list, byte[] bArr, String str3, byte[] bArr2, C36296a c36296a) {
    ...
    public DownloadRequest copyWithKeySetId(@Nullable byte[] bArr) {
        return new DownloadRequest(this.f97102id, this.uri, this.mimeType, this.streamKeys, bArr, this.customCacheKey, this.data);
    }

    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        List emptyList;
        Assertions.checkArgument(this.f97102id.equals(downloadRequest.f97102id));
        ...
        return new DownloadRequest(this.f97102id, downloadRequest.uri, downloadRequest.mimeType, emptyList, downloadRequest.keySetId, downloadRequest.customCacheKey, downloadRequest.data);
    }
    ...
    public final int hashCode() {
        int i;
        int hashCode = ((this.f97102id.hashCode() * 31 * 31) + this.uri.hashCode()) * 31;
    ...
    public MediaItem toMediaItem() {
        return new MediaItem.Builder().setMediaId(this.f97102id).setUri(this.uri).setCustomCacheKey(this.customCacheKey).setMimeType(this.mimeType).setStreamKeys(this.streamKeys).build();
    }

    public String toString() {
        return this.mimeType + ":" + this.f97102id;
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f97102id);
    ...
    DownloadRequest(Parcel parcel) {
        this.f97102id = (String) Util.castNonNull(parcel.readString());
