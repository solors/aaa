...
public final class Loader implements LoaderErrorThrower {
    ...
    @Nullable
    private HandlerC36458b<? extends Loadable> currentTask;
    ...
    /* renamed from: io.bidmachine.media3.exoplayer.upstream.Loader$b */
    /* loaded from: classes9.dex */
    public final class HandlerC36458b<T extends Loadable> extends Handler implements Runnable {
        ...
        public HandlerC36458b(Looper looper, T t, Callback<T> callback, int i, long j) {
            super(looper);
            this.loadable = t;
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 0) {
                ...
                try {
                    ...
                    Log.m19948e(TAG, "Unexpected exception handling load completed", e);
        ...
        public void run() {
            ...
            try {
                ...
                if (!this.released) {
                    Log.m19948e(TAG, "Unexpected exception loading stream", e2);
                    obtainMessage(2, new UnexpectedLoaderException(e2)).sendToTarget();
                }
            } catch (OutOfMemoryError e3) {
                if (!this.released) {
                    Log.m19948e(TAG, "OutOfMemory error loading stream", e3);
                    obtainMessage(2, new UnexpectedLoaderException(e3)).sendToTarget();
                }
            } catch (Error e4) {
                if (!this.released) {
                    Log.m19948e(TAG, "Unexpected error loading stream", e4);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: io.bidmachine.media3.exoplayer.upstream.Loader$c */
    /* loaded from: classes9.dex */
    public static final class RunnableC36459c implements Runnable {
        private final ReleaseCallback callback;

        public RunnableC36459c(ReleaseCallback releaseCallback) {
    ...
    public void cancelLoading() {
        ((HandlerC36458b) Assertions.checkStateNotNull(this.currentTask)).cancel(false);
    }
    ...
    public <T extends Loadable> long startLoading(T t, Callback<T> callback, int i) {
        this.fatalError = null;
        long elapsedRealtime = SystemClock.elapsedRealtime();
        new HandlerC36458b((Looper) Assertions.checkStateNotNull(Looper.myLooper()), t, callback, i, elapsedRealtime).start(0L);
    ...
    public void maybeThrowError(int i) throws IOException {
        ...
        if (iOException == null) {
            HandlerC36458b<? extends Loadable> handlerC36458b = this.currentTask;
            if (handlerC36458b != null) {
                if (i == Integer.MIN_VALUE) {
                    i = handlerC36458b.defaultMinRetryCount;
                }
                handlerC36458b.maybeThrowError(i);
                return;
            }
            return;
        }
    ...
    public void release(@Nullable ReleaseCallback releaseCallback) {
        HandlerC36458b<? extends Loadable> handlerC36458b = this.currentTask;
        if (handlerC36458b != null) {
            handlerC36458b.cancel(true);
        }
        if (releaseCallback != null) {
            this.downloadExecutorService.execute(new RunnableC36459c(releaseCallback));
        }
