...
public class SlidingWeightedAverageBandwidthStatistic implements BandwidthStatistic {
    ...
    public static SampleEvictionFunction getMaxCountEvictionFunction(final long j) {
        return new SampleEvictionFunction() { // from class: io.bidmachine.media3.exoplayer.upstream.experimental.c
    ...
    static SampleEvictionFunction getAgeBasedEvictionFunction(final long j, final Clock clock) {
        return new SampleEvictionFunction() { // from class: io.bidmachine.media3.exoplayer.upstream.experimental.b
            @Override // io.bidmachine.media3.exoplayer.upstream.experimental.SlidingWeightedAverageBandwidthStatistic.SampleEvictionFunction
            public final boolean shouldEvictSample(Deque deque) {
