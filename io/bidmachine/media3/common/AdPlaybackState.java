...
public final class AdPlaybackState implements Bundleable {
    ...
    public static final Bundleable.Creator<AdPlaybackState> CREATOR = new Bundleable.Creator() { // from class: io.bidmachine.media3.common.a
        @Override // io.bidmachine.media3.common.Bundleable.Creator
        public final Bundleable fromBundle(Bundle bundle) {
            return AdPlaybackState.m20053a(bundle);
        }
    };
    ...
    public static final class AdGroup implements Bundleable {
        ...
        public static final Bundleable.Creator<AdGroup> CREATOR = new Bundleable.Creator() { // from class: io.bidmachine.media3.common.b
            @Override // io.bidmachine.media3.common.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
                return AdPlaybackState.AdGroup.m20052a(bundle);
            }
        };

        /* renamed from: a */
        public static /* synthetic */ AdGroup m20052a(Bundle bundle) {
    ...
    /* renamed from: a */
    public static /* synthetic */ AdPlaybackState m20053a(Bundle bundle) {
        return fromBundle(bundle);
    }
