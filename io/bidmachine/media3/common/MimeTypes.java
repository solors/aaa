...
public final class MimeTypes {
    ...
    private static final ArrayList<C35806a> customMimeTypes = new ArrayList<>();
    private static final Pattern MP4A_RFC_6381_CODEC_PATTERN = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: io.bidmachine.media3.common.MimeTypes$a */
    /* loaded from: classes9.dex */
    public static final class C35806a {
        public final String codecPrefix;
        public final String mimeType;
        public final int trackType;

        public C35806a(String str, String str2, int i) {
            this.mimeType = str;
    ...
    @VisibleForTesting
    /* renamed from: io.bidmachine.media3.common.MimeTypes$b */
    /* loaded from: classes9.dex */
    public static final class C35807b {
        public final int audioObjectTypeIndication;
        public final int objectTypeIndication;

        public C35807b(int i, int i2) {
    ...
    public static boolean allSamplesAreSyncSamples(@Nullable String str, @Nullable String str2) {
        C35807b objectTypeFromMp4aRFC6381CodecString;
        int encoding;
        if (str == null) {
            return false;
        }
    ...
    private static String getCustomMimeTypeForCodec(String str) {
        ...
        for (int i = 0; i < size; i++) {
            C35806a c35806a = customMimeTypes.get(i);
            if (str.startsWith(c35806a.codecPrefix)) {
                return c35806a.mimeType;
            }
        }
        return null;
    }
    ...
    @Nullable
    @VisibleForTesting
    static C35807b getObjectTypeFromMp4aRFC6381CodecString(String str) {
        int i;
    ...
    private static int getTrackTypeForCustomMimeType(String str) {
        ...
        for (int i = 0; i < size; i++) {
            C35806a c35806a = customMimeTypes.get(i);
            if (str.equals(c35806a.mimeType)) {
                return c35806a.trackType;
            }
        }
        return -1;
    }
    ...
    public static void registerCustomMimeType(String str, String str2, int i) {
        C35806a c35806a = new C35806a(str, str2, i);
        int size = customMimeTypes.size();
        int i2 = 0;
        while (true) {
            if (i2 >= size) {
            ...
            ArrayList<C35806a> arrayList = customMimeTypes;
