...
public final class PlaybackParameters implements Bundleable {
    ...
    @UnstableApi
    public static final Bundleable.Creator<PlaybackParameters> CREATOR = new Bundleable.Creator() { // from class: io.bidmachine.media3.common.w
        @Override // io.bidmachine.media3.common.Bundleable.Creator
        public final Bundleable fromBundle(Bundle bundle) {
            return PlaybackParameters.m20035a(bundle);
        }
    };
    ...
    /* renamed from: a */
    public static /* synthetic */ PlaybackParameters m20035a(Bundle bundle) {
