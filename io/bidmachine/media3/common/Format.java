...
public final class Format implements Bundleable {
    ...
    @UnstableApi
    public static final Bundleable.Creator<Format> CREATOR = new Bundleable.Creator() { // from class: io.bidmachine.media3.common.h
        @Override // io.bidmachine.media3.common.Bundleable.Creator
        public final Bundleable fromBundle(Bundle bundle) {
            return Format.m20047a(bundle);
        }
    };
    ...
    public static final class Builder {
        ...
        public Builder setId(int i) {
            this.f96656id = Integer.toString(i);
            return this;
        }

        private Builder(Format format) {
            this.f96656id = format.f96655id;
    ...
    /* renamed from: a */
    public static /* synthetic */ Format m20047a(Bundle bundle) {
    ...
    public static String toLogString(@Nullable Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            while (true) {
                ...
                if (uuid.equals(C35793C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add("cenc");
                } else if (uuid.equals(C35793C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(C35793C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(C35793C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(C35793C.UUID_NIL)) {
    ...
    public String toString() {
        return "Format(" + this.f96655id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + ", " + this.colorInfo + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    private Format(Builder builder) {
        this.f96655id = builder.f96656id;
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putString(FIELD_ID, this.f96655id);
