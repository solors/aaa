...
public final class CueGroup implements Bundleable {
    ...
    @UnstableApi
    public static final Bundleable.Creator<CueGroup> CREATOR = new Bundleable.Creator() { // from class: io.bidmachine.media3.common.text.b
        @Override // io.bidmachine.media3.common.Bundleable.Creator
        public final Bundleable fromBundle(Bundle bundle) {
            return CueGroup.m19954a(bundle);
        }
    };
    ...
    /* renamed from: a */
    public static /* synthetic */ CueGroup m19954a(Bundle bundle) {
