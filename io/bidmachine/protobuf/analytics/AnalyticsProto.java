...
public final class AnalyticsProto {
    ...
    static final Descriptors.Descriptor f97444x49eea5bb;

    /* renamed from: internal_static_bidmachine_protobuf_analytics_AuctionContext_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f97445x8e5e139;

    /* renamed from: internal_static_bidmachine_protobuf_analytics_BidEvent_descriptor */
    static final Descriptors.Descriptor f97446xcd82f62a;

    /* renamed from: internal_static_bidmachine_protobuf_analytics_BidEvent_fieldAccessorTable */
    static final GeneratedMessageV3.FieldAccessorTable f97447x64d652a8;

    static {
        Descriptors.Descriptor descriptor2 = getDescriptor().getMessageTypes().get(0);
        f97444x49eea5bb = descriptor2;
        f97445x8e5e139 = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"Timestamp", "Id", "Test", "At", "PlacementTag", "Item", "Placement", "Context"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        f97446xcd82f62a = descriptor3;
        f97447x64d652a8 = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"Timestamp", "Bidid", "Seat", "AuctionContext", "Bid", "Ad"});
