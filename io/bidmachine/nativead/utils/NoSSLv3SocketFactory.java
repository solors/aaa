...
public class NoSSLv3SocketFactory extends SSLSocketFactory {
    ...
    /* renamed from: io.bidmachine.nativead.utils.NoSSLv3SocketFactory$b */
    /* loaded from: classes9.dex */
    public static class C36768b extends DelegateSSLSocket {
        ...
        private C36768b(SSLSocket sSLSocket) {
            super(sSLSocket);
        }
    }
    ...
    private Socket makeSocketSafe(Socket socket) {
        if (socket instanceof SSLSocket) {
            return new C36768b((SSLSocket) socket);
        }
        return socket;
    }
