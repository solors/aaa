...
public final class InternalNano {
    ...
    public static void cloneUnknownFieldData(ExtendableMessageNano extendableMessageNano, ExtendableMessageNano extendableMessageNano2) {
        ...
        if (fieldArray != null) {
            extendableMessageNano2.unknownFieldData = fieldArray.m110483clone();
        }
    }
    ...
    */
    public static <K, V> boolean equals(java.util.Map<K, V> r4, java.util.Map<K, V> r5) {
        ...
        L58:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.appmetrica.analytics.protobuf.nano.InternalNano.equals(java.util.Map, java.util.Map):boolean");
    }
}
